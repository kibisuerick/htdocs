                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/456473825.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    ...
                                    <div class="listing__hero--slider__content">
                                        ...
                                        Plainsview Road, Nairobi, Kenya</p>
                                    </div>
                                    <!-- Hero Content .\ -->
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/476067924.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/456473842.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                                <div class=" listing__hero--slider__items position-relative">
                                  <img class="listing__hero--slider__media" src="assets/img/hero/456473825 (1).jpg" alt="img">
                                  <div class="listing__hero--slider__container">
                                      <div class="container">
                                      <!-- Hero Content -->
                                      <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                                <div class=" listing__hero--slider__items position-relative">
                                  <img class="listing__hero--slider__media" src="assets/img/hero/456473869 (1).jpg" alt="img">
                                  <div class="listing__hero--slider__container">
                                      <div class="container">
                                      <!-- Hero Content -->
                                      <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                                <div class=" listing__hero--slider__items position-relative">
                                  <img class="listing__hero--slider__media" src="assets/img/hero/456473915.jpg" alt="img">
                                  <div class="listing__hero--slider__container">
                                      <div class="container">
                                      <!-- Hero Content -->
                                      <div class="listing__hero--slider__content">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/456473853.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/476067924.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/456473842.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                        ...
                        <div class="listing__details--wrapper">
                            <div class="listing__details--content">
                                ...
                                <div class="listing__details--content__step">
                                    <h2 class="listing__details--title mb-25">HAZINA ESTATE SOUTH B</h2>
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">Kes 18,000-24000</span>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <p class="listing__details--content__desc">HAZINA ESTATE SOUTH B is located in Nairobi, just 3.9 miles from Kenyatta International Conference Centre and 5.5 miles from Nairobi National Museum. This property offers access to a balcony, free private parking, and free Wifi. Staff on site can arrange a shuttle service.

The apartment is composed of 2 separate bedrooms, a living room, a fully equipped kitchen, and 1 bathroom. The accommodation is non-smoking.

A mini-market is available at the apartment.

Jihan Freighters Limited is a 16-minute walk from the apartment, while Nyayo Stadium is 3.4 miles from the property. The nearest airport is Wilson, 3.1 miles from HAZINA ESTATE SOUTH B, and the property offers a paid airport shuttle service.</p>
                                    <div class="apartment__info listing__d--info">
                                        <div class="apartment__info--wrapper d-flex">
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    <span class="apartment__info--count">2</span>
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    <span class="apartment__info--count">ample</span>
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">1100 Sqft</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">Kes 35,000/mo</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">1,000 to 1,200 sqft.</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Land Area Size:</span>
                                            <span class="properties__details--info__subtitle">1,300 to 2,200 sqft</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Rooms:</span>
                                            <span class="properties__details--info__subtitle">06</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                    ...
                                    <div class="properties__amenities--wrapper d-flex">
                                        <ul class="properties__amenities--step">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Free private parking</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                                ...
                                                <span class="properties__amenities--text">Staff on site can arrange a shuttle service.</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <div class="properties__floor--plans__content">
                                            ...
                                            <ul class="properties__floor--plans__info">
                                                <li>
                                                    ...
                                                    <span>Total Size: 800 to 1,000 sqft </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon2.png" alt="icon">-->
                                                     <span><b>Rooms & Layout:</b></span>
                                                    <span>✅ Living Room – Spacious area with room for seating, possibly combined with a dining space.</span>
                                                    <span>✅ Kitchen – Standard closed or open-plan kitchen with cabinets and countertops. </span>
                                                    <span>✅ Bedrooms (2) – Master bedroom may have an en-suite, while the second bedroom shares a common bathroom.</span>
                                                    <span>✅ Bathroom(s) (1-2) – One common bathroom, possibly one en-suite in the master bedroom. </span>
                                                    <span>✅ Balcony – Connected to the living room or one of the bedrooms.</span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon3.png" alt="icon">-->
                                                    <span><b>Possible floor plan types.</b> </span>
                                                    <span>1️⃣ Rectangular Layout – Bedrooms on one side, living room and kitchen on the other.</span>
                                                    <span>2️⃣ L-Shaped Layout – Living room and kitchen in one section, bedrooms in another.</span>
                                                </li>
                                               <!--<li>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="floor1">
                                                    <div class="properties__floor--plans__display">
                                                        <img src="assets/img/other/OIP.jpg" alt="img">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3988.763881040528!2d36.8449002!3d-1.3172901!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f1199acaab00f%3A0x2157fc565290d89c!2sHazina%20Estate%2C%20Nairobi!5e0!3m2!1sen!2ske!4v1738596426169!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </details>
                                        </div>
                                    </div>
                                    <div class="location__google--maps__info d-flex">
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Plainsview Road, Nairobi, Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                        ...
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">South B</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Neighborhood:  </span>
                                                <span class="location__google--maps__info--subtitle">HAZINA ESTATE</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--video__thumbnail position-relative"> 
                                        <img src="assets/img/property/download (6).jpg" alt="Video Thumbnail" class="video-thumbnail">
                                        <div class="bideo__play">
                                            <a class="bideo__play--icon glightbox" href="https://www.bing.com/videos/riverview/relatedvideo?&q=luxury+suit+in+Hazina+Estate%2c+South+B%2c+Nairobi&&mid=C20C3A8CDB78062911C6C20C3A8CDB78062911C6&&FORM=VRDGAR" data-gallery="video">
                                ...
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--review d-flex">
                                        <div class="details__review--box">
                                            <h3 class="details__review--box__point">0</h3>
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">Amazing Stay!</h3>
                                                    ...
                                                    <p class="reviews__comment--desc">"This home exceeded our expectations! The rooms were spacious, the decor was elegant, and the environment was peaceful. The location is also very convenient, with easy access to the city. Will definitely book again!"</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Good but Needs Some Improvements</h3>
                                                            <span class="reviews__comment--author__date">26th july 2022</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"The house is beautiful and well-furnished, but we had some issues with the water pressure in the shower. Also, the WiFi was a bit slow. If those are fixed, it would be a perfect stay."</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content last__content">
                                                    ...
                                                    <p class="reviews__comment--desc">"The house looks great in the pictures, but the cleanliness could have been better. The check-in process was also a bit confusing. However, the location is excellent, and with some improvements, it could be a top-tier listing."</p>
                                                </div>
                                            </div>
                                       </div>
                                    </div>
                        ...
                        <div class="listing__widget">
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="assets/img/property/OIP (3).jpg" alt="img" class="featured-image">
                                    ...
                                    <div class="widget__featured--properties__content">
                                        ...
                                        <p class="widget__featured--properties__desc"><svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            Muthama Estate, Mombasa Road, Nairobi, Kenya</p>
                                        <h3 class="widget__featured--properties__title">Single Family Home</h3>
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">Kes 70,000-75,000</span>
                                            <span class="old__price">Kes 50,000</span>
                                        </div>    
                                    </div>
                                </div>
                            </div>
                            <div class="widget__step">
                                ...
                                <div class="widget__featured">                                    
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalLivingRoom">
                                                <img class="widget__featured--media" src="assets/img/hero/476067924.jpg" alt="Living Room">
                                            </a>
                                        </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/476067924.jpg" alt="Living Room">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <!-- Image with link that triggers the modal -->
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalKitchen">
                                                <img class="widget__featured--media" src="assets/img/hero/456473825.jpg" alt="Kitchen">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                    ...
                                    <div class="modal fade" id="imageModalKitchen" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelKitchen" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/456473825.jpg" alt="Kitchen">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalDining">
                                                <img class="widget__featured--media" src="assets/img/hero/456473842.jpg" alt="Dining Area">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Dining Area</a></h3>
                                            <!--<span class="widget__featured--price">$2,745 /mo</span>-->
                                        </div>
                                    </div>                                    
                                    <!-- Modal for Dining Area Image -->
                                    <div class="modal fade" id="imageModalDining" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelDining" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          ...
                                          <div class="modal-body">
                                            <img class="img-fluid" src="assets/img/hero/456473842.jpg" alt="Dining Area">
                                          </div>
                                        </div>
                                      </div>
                                    </div>                                 
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <!-- Image with link that triggers the modal -->
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModal">
                                                <img class="widget__featured--media" src="assets/img/hero/456473915.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                    ...
                                    <div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/456473915.jpg" alt="img">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
