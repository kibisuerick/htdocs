...
<head>
  <meta charset="utf-8">
  <title>Centralized Property Reservation Platform - Services Details</title>
...
<body>
    ...
    <main class="main__content_wrapper">
        ...
        <section class="breadcrumb__section section--padding">
            <div class="container">
                <div class="breadcrumb__content text-center">
                    <h1 class="breadcrumb__title h2"><span>Speed </span> Optimization</h1>
                    <ul class="breadcrumb__menu d-flex justify-content-center">
                        ...
                        <li><span class="breadcrumb__menu--text">Services Details </span></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="services__details--section section--padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="services__details--wrapper">
                            <div class="services__details--thumbnail mb-30">
                                <img src="assets/img/other/young-businessmen-standing-together-holding-laptop-discussing-business_181624-46531.jpg" alt="img">
                            </div>
                            <div class="services__details--content">
                                <div class="services__details--content__step mb-30">
                                    <h2 class="services__details--title">Enhancing Performance for Seamless Property Reservations</h2>
                                    <p class="services__details--desc">In today’s fast-paced digital world, speed is a critical factor in providing a seamless user experience. A slow-loading property reservation platform can lead to frustrated users, increased bounce rates, and lost bookings. Our Speed Optimization services ensure that your platform delivers lightning-fast performance, providing a smooth browsing experience for property seekers and investors.</p>
                                    <h2 class="services__details--title">Why Speed Optimization Matters?</h2>
                                    <p class="services__details--desc"><b>Improved User Experience:</b><br>
                                        Fast-loading pages ensure users can quickly browse listings, compare properties, and make bookings without delays.
                                    </p>
                                    <p class="services__details--desc"><b>Higher Conversion Rates:</b><br>
                                        Studies show that a one-second delay can reduce conversions by up to 7%. Faster load times mean more successful reservations.
                                    </p>
                                    <p class="services__details--desc"><b>Better SEO Rankings:</b><br>
                                        Search engines like Google prioritize fast websites, helping your platform rank higher in search results and attract more organic traffic.
                                    </p>
                                    <p class="services__details--desc"><b>Reduced Server Load:</b><br>
                                        Optimizing speed reduces unnecessary server requests, improving efficiency and reducing hosting costs.
                                    </p>
                                    <!--<p class="services__details--desc"><b>5. Virtual & On-Site Booking Appointments</b><br>
                                        Schedule virtual or in-person property viewings with real estate agents at your convenience.
                                    </p>
                                    <p class="services__details--desc"><b>6. Secure Transactions & Legal Assistance</b><br>
                                        Enjoy a smooth and secure transaction process with verified listings, legal documentation support, and expert guidance throughout your property acquisition journey.
                                    </p>
                                    <p class="services__details--desc"><b>7. Personalized Recommendations</b><br>
                                        Receive tailored property suggestions based on your preferences, search history, and market trends.
                                    </p>-->                                    
                                </div>
                                <div class="services__details--info mb-40 d-flex">
                                    <!-- Video Thumbnail Section -->
                                    <div class="services__details--info mb-40 d-flex">
                                        <div class="services__details--info__thumbnail position-relative">
                                            <img src="assets/img/other/digital-cyberspace-digital-data-network_24070-1185.jpg" alt="img">
                                            <div class="bideo__play">
                                                <div class="bideo__play--icon" onclick="openModal()">
                                                    <svg width="50" height="50" viewBox="0 0 13 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="videoModal" class="modal">
                                        <div class="modal-content">
                                            ...
                                            <iframe id="videoIframe" width="100%" height="500" src="" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        </div>
                                    </div>                                    
                                    <div class="services__details--info__content">
                                        <h3 class="services__details--info__title">Our Speed Optimization Solutions</h3>
                                        <!--<p class="services__details--info__desc">Quality assurance is crucial in real estate to ensure high standards, reliability, and customer satisfaction. Here are four key reasons why it is important: </p>-->
                                        <ul class="services__details--info__ui-content">
                                            ...
                                            </span> Website Caching – We implement advanced caching techniques to store frequently accessed data, reducing load times for repeat visitors.</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span>Image & Media Compression – Optimized images and videos without quality loss to ensure quicker page rendering.</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span>Code Minification & Optimization – We streamline your website’s HTML, CSS, and JavaScript files to enhance speed and performance.</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span>CDN Integration (Content Delivery Network) – Your platform's content is delivered from the nearest server location, ensuring faster access for users worldwide.</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span>Database Optimization – We clean up and optimize your database for faster queries and transactions.</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span> Lazy Loading Implementation – Load only the necessary content as users scroll, reducing initial page load time.</li>
                                        </ul>
                                    </div>                                    
                                </div>
                                ...
                                <p class="services__details--desc">By integrating cutting-edge technology with user-friendly features, our platform simplifies property discovery and reservation, making your real estate journey effortless.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="services__widget">
                            <div class="services__widget--step">
                                <ul class="services__widget--categories">
                                    <!--<li class="services__categories--items">
                                        <a class="services__categories--link d-flex align-items-center justify-content-between" href="#">
                                            <span class="services__categories--text">Consumer Product</span>
                                    ...
                                    <ul class="services__categories">
                                        <li class="services__categories--items">
                                            <a class="services__categories--link d-flex align-items-center justify-content-between"
                                                href="services-details.php"
                                                onclick="redirectToPage(event, 'services-details - Copy - Copy (2).php')">
                                                <span class="services__categories--text">Consumer Product</span>
                                                <span class="services__categories--arrow__icon">
                                        ...
                                        <li class="services__categories--items">
                                            <a class="services__categories--link d-flex align-items-center justify-content-between"
                                                href="services-details - Copy - Copy (2).php"
                                                onclick="redirectToPage(event, 'services-details - Copy - Copy (3).php')">
                                                <span class="services__categories--text">Email Marketing</span>
                                                <span class="services__categories--arrow__icon">
                                                    <svg width="23" height="12" viewBox="0 0 23 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M22.6963 4.93435C22.696 4.93408 22.6958 4.93377 22.6955 4.9335L18.146 0.261622C17.8052 -0.0883642 17.2539 -0.0870618 16.9146 0.264676C16.5754 0.61637 16.5767 1.18522 16.9176 1.53525L19.9721 4.67187H1.5328C1.05192 4.67187 0.662109 5.0741 0.662109 5.57031C0.662109 6.06652 1.05192 6.46875 1.5328 6.46875H19.9721L16.9176 9.60537C16.5768 9.9554 16.5755 10.5242 16.9147 10.8759C17.254 11.2277 17.8053 11.2289 18.1461 10.879L22.6956 6.20712C22.6958 6.20685 22.696 6.20654 22.6964 6.20627C23.0374 5.85507 23.0363 5.28438 22.6963 4.93435Z" fill="currentColor"/>
                                                    </svg>
                                        ...
                                        <li class="services__categories--items">
                                            <a class="services__categories--link d-flex align-items-center justify-content-between"
                                                href="services-details - Copy - Copy (3).php"
                                                onclick="redirectToPage(event, 'services-details - Copy - Copy (4).php')">
                                                <span class="services__categories--text">Marketing Analysis</span>
                                                <span class="services__categories--arrow__icon">
                                                    <svg width="23" height="12" viewBox="0 0 23 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M22.6963 4.93435C22.696 4.93408 22.6958 4.93377 22.6955 4.9335L18.146 0.261622C17.8052 -0.0883642 17.2539 -0.0870618 16.9146 0.264676C16.5754 0.61637 16.5767 1.18522 16.9176 1.53525L19.9721 4.67187H1.5328C1.05192 4.67187 0.662109 5.0741 0.662109 5.57031C0.662109 6.06652 1.05192 6.46875 1.5328 6.46875H19.9721L16.9176 9.60537C16.5768 9.9554 16.5755 10.5242 16.9147 10.8759C17.254 11.2277 17.8053 11.2289 18.1461 10.879L22.6956 6.20712C22.6958 6.20685 22.696 6.20654 22.6964 6.20627C23.0374 5.85507 23.0363 5.28438 22.6963 4.93435Z" fill="currentColor"/>
                                                    </svg>
                                        ...
                                        <li class="services__categories--items">
                                            <a class="services__categories--link d-flex align-items-center justify-content-between"
                                                href="services-details - Copy - Copy (4).php"
                                                onclick="redirectToPage(event, 'services-details - Copy - Copy (4).php')">
                                                <span class="services__categories--text">Media Marketing</span>
                                                <span class="services__categories--arrow__icon">
                                                    <svg width="23" height="12" viewBox="0 0 23 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M22.6963 4.93435C22.696 4.93408 22.6958 4.93377 22.6955 4.9335L18.146 0.261622C17.8052 -0.0883642 17.2539 -0.0870618 16.9146 0.264676C16.5754 0.61637 16.5767 1.18522 16.9176 1.53525L19.9721 4.67187H1.5328C1.05192 4.67187 0.662109 5.0741 0.662109 5.57031C0.662109 6.06652 1.05192 6.46875 1.5328 6.46875H19.9721L16.9176 9.60537C16.5768 9.9554 16.5755 10.5242 16.9147 10.8759C17.254 11.2277 17.8053 11.2289 18.1461 10.879L22.6956 6.20712C22.6958 6.20685 22.696 6.20654 22.6964 6.20627C23.0374 5.85507 23.0363 5.28438 22.6963 4.93435Z" fill="currentColor"/>
                                                    </svg>
                            ...
                            <div class="services__widget--step timing">
                                <h2 class="widget__step--title">Opening Hours</h2>
                                <div class="widget__timing--inner">
                                    <ul class="widget__timing--wrapper">
                                        <li class="widget__timing--list d-flex justify-content-between">
                                            <span class="widget__timing--text">Monday - Friday</span>
                                            <span class="widget__timing--text">9.00a.m - 17.00p.m</span>
                                        </li>
                                        <li class="widget__timing--list d-flex justify-content-between">
                                            <span class="widget__timing--text">Saturday </span>
                                            <span class="widget__timing--text"> 8.00a.m - 16.00p.m</span>
                                        </li>
                                        <li class="widget__timing--list d-flex justify-content-between">
                                            <span class="widget__timing--text">Sunday</span>
                                            <span class="widget__timing--text"> 9.30a.m - 14.00p.m</span>
                                        </li>
                                    </ul>
                                    <!--<a class="widget__timing--btn solid__btn" href="#">Service details <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.3138 4.52225L10.8174 0.196665C10.7546 0.134718 10.678 0.0852214 10.5927 0.0513554C10.5073 0.0174894 10.415 0 10.3217 0C10.2284 0 10.1361 0.0174894 10.0508 0.0513554C9.96542 0.0852214 9.88889 0.134718 9.82609 0.196665C9.69402 0.327555 9.62088 0.497837 9.62088 0.674421C9.62088 0.851006 9.69402 1.02128 9.82609 1.15217L13.123 4.32296H1.10886C0.918497 4.33537 0.740424 4.41199 0.610441 4.53743C0.480458 4.66286 0.408203 4.82781 0.408203 4.99911C0.408203 5.17042 0.480458 5.33536 0.610441 5.4608C0.740424 5.58623 0.918497 5.66286 1.10886 5.67526H13.1211L9.8241 8.84783C9.69203 8.97872 9.6189 9.149 9.6189 9.32559C9.6189 9.50217 9.69203 9.67244 9.8241 9.80333C9.88691 9.86528 9.96343 9.91478 10.0488 9.94864C10.1341 9.98251 10.2264 10 10.3197 10C10.4131 10 10.5053 9.98251 10.5907 9.94864C10.676 9.91478 10.7526 9.86528 10.8154 9.80333L15.3138 5.48665C15.4486 5.35524 15.5235 5.18311 15.5235 5.00445C15.5235 4.82579 15.4486 4.65366 15.3138 4.52225Z" fill="currentColor"/>
                                        </svg>
                                    </a>-->
                                </div>
                            </div>
                            <div class="services__widget--step">
                                <h2 class="widget__step--title">IMAGE GALLERY</h2>
                                <div class="widget__img--gallery">
                                    <div class="widget__img--gallery__thumbnail mb-20">
                                        <img src="assets/img/other/download (2).png" alt="img">
                                    </div>
                                    <div class="widget__img--gallery__content">
                                        <h3 class="widget__img--gallery__title">Meet our Speed Optimization Experts</h3>
                                        <p class="widget__img--gallery__desc">a dedicated team of tech specialists ensuring lightning-fast performance for seamless property browsing and reservations.🚀
                                        </p>
                                    </div>
                                </div>
                            </div>
  ...
  <!-- Customscript js -->
  <script src="assets/js/script - Copy (2).js"></script>
