                ...
                <div class="side__menu--share d-flex align-items-center">
                    ...
                    <ul class=" side__menu--share__wrapper d-flex align-items-center">
                        <li class="side__menu--share__list">
                            <a class="side__menu--share__icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=facebook-icon-placement">
                        ...
                        <li class="side__menu--share__list">
                            <a class="side__menu--share__icon" target="_blank" href="https://x.com/_theclose?utm_source=website&utm_medium=footer&utm_campaign=twitter-icon-placement">
                        ...
                        <li class="side__menu--share__list">
                            <a class="side__menu--share__icon" target="_blank" href="https://www.instagram.com/its_kay_jnr/theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=insta-icon-placement">
    ...
    <main class="main__content_wrapper">
                    ...
                    <div class="col-lg-8">
                        <div class="blog__details--wrapper">
                            <div class="blog__details--thumbnail mb-30">
                                <img class="blog__details--thumbnail--media" src="assets/img/blog/unnamed-2024-07-03T184738.990.webp" alt="img">
                            </div>
                            <div class="blog__details--content">
                                <div class="blog__details--content__top mb-40">
                                    <ul class="blog__meta d-flex">
                                        <li class="blog__meta--list d-flex align-items-center">
                                          ...
                                          <span class="blog__meta--text">Julia Del Rosario</span>
                                        </li>
                                        <li class="blog__meta--list d-flex align-items-center">
                                        ...
                                        <li class="blog__meta--list d-flex align-items-center">
                                          ...
                                          <span class="blog__meta--text">5 mins read </span>
                                        </li>
                                    </ul>
                                    <h3 class="blog__content--title ">The 6 Must-read Best Real Estate Blogs </h3>
                                    <li class="icon-list-item mb-0 relative">
                                        ...
                                        <h3 class="blog__content--title ">1. The Close </h3>
                                        <div class="blog__details--thumbnail mb-30">
                                            <img class="blog__details--thumbnail--media" src="assets/img/blog/theclose-logo.webp" alt="img">
                                        </div>                                                                                
                                            <li class="icon-list-item mb-0 relative">
                                                <img class="blog__details--thumbnail--media" src="assets/img/blog/helpful-resource.webp" alt="img" data-ll-status="loaded">
                                                <span class="list-item-text">
                                                <span class="font-weight-bold"><b> who should read it:</b></span>
                                                Incredibly good-looking, talented, and charming agents with impeccable taste. 😉
                                                </span>
                                            </li>                                            
                                            <li class="icon-list-item mb-0 relative">
                                                <img class="blog__details--thumbnail--media" src="assets/img/blog/favorite-feature.webp" alt="img" data-ll-status="loaded">
                                                <span class="list-item-text">
                                                <span class="font-weight-bold"><b> Why we love it:</b></span>
                                                
			                                    One of the best real estate blogs (ahem), The Close offers everything you’ll need throughout your real estate career. Whether a new agent or a seasoned pro, you’ll find The Close’s lead generation and marketing techniques helpful. The blog has prelicensing guides, tech reviews, marketing templates, agent insights, recommendations for 
                                                <a href="https://theclose.com/best-real-estate-books/" target="_blank" style="color: #fa4a4a; text-decoration: underline;">best real estate books</a>, and fun real estate posts! Hopefully, you can feel our passion for building better agents through our articles.
                                                </span>
                                            </li>
                                        
                                        <p></p>                
                                        <p>Want to get our latest tips, templates, scripts, and articles in your inbox every week? Sign up for our email list below.</p>
                                        <div class="text-center">
                                            <a class="add__listing--btn solid__btn" href="https://theclose.com/newsletter/" target="_blank">Subscribe to Our Newsletter</a>
                                          </div><br>
                                        <h4 class="blog__content--title ">2. Tom Ferry </h4>
                                        <div class="blog__details--thumbnail mb-30">
                                            <img class="blog__details--thumbnail--media" src="assets/img/blog/unnamed-2024-07-03T184742.771-600x131.webp" alt="img">
                                        </div>                                    
                                        <li class="icon-list-item mb-0 relative">
                                            <img class="blog__details--thumbnail--media" src="assets/img/blog/helpful-resource.webp" alt="img" data-ll-status="loaded">
                                            <span class="list-item-text">
                                            <span class="font-weight-bold"><b> who should read it:</b></span>
                                            New and experienced agents stuck in a rut.
                                            </span>
                                        </li>
                                        <li class="icon-list-item mb-0 relative">
                                            <img decoding="async" src="assets/img/blog/favorite-feature.webp" alt="img" data-ll-status="loaded">
                                            <noscript><img decoding="async" class="icon-image absolute" src="assets/img/blog/favorite-feature.webp" /></noscript>
                                            <span class="list-item-text">
                                                <span class="font-weight-bold"><b> Why we love it: </b><a href="https://theclose.com/best-real-estate-coaches/" target="_blank" style="color: #fa4a4a; text-decoration: underline;"> America’s premier real estate coach</a>
                                                brings unmatched enthusiasm to helping real estate agents break out of sales ruts, <a href="https://theclose.com/real-estate-agents-skills/" target="_blank" style="color: #fa4a4a; text-decoration: underline;"> learn new agent skills </a> and lead
                                                generation techniques, and stay inspired. Tom Ferry excels in delivering impactful content through videos, which are featured prominently on his real estate blogspot. If you don’t have time to watch long videos, you can get the same actionable advice in his writing.</span>                                                                                              
                                            </span>
                                            <p></p>                                            
                                            <div class="text-center">
                                                <a class="add__listing--btn solid__btn" href="https://blog.tomferry.com/" target="_blank">Read Tom Ferry's Blog</a>
                                              </div>                                       
                                        </li>              
                                    <h4 class="blog__content--title ">3. Coffee & Contracts</h4>
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/coffee-and-contracts.webp" alt="img">
                                    </div> 
                                    <li class="icon-list-item mb-0 relative">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/helpful-resource.webp" alt="img" data-ll-status="loaded">
                                        <span class="list-item-text">
                                        <span class="font-weight-bold"><b> who should read it:</b></span>
                                        Agents who want to grow their business on Instagram.
                                        </span>
                                    </li>
                                    <li class="icon-list-item mb-0 relative">
                                        <img decoding="async" src="assets/img/blog/favorite-feature.webp" alt="img" data-ll-status="loaded">
                                        <noscript><img decoding="async" class="icon-image absolute" src="assets/img/blog/favorite-feature.webp" /></noscript>
                                        <span class="list-item-text">
                                            <span class="font-weight-bold"><b> Why we love it: </b></span> Want social media tips and strategies from agents crushing it on Instagram? Then, the Coffee & Contracts blog should be your new daily read. Coffee & Contracts uses its extensive network of Instagram superstars like <a href="https://theclose.com/author/eric-simon-the-broke-agent/" target="_blank" style="color: #fa4a4a; text-decoration: underline;"> Eric simon</a>
                                            and 
                                            <a href="https://www.instagram.com/its_kay_jnr/tayadicarlo/?hl=en" target="_blank" style="color: #fa4a4a; text-decoration: underline;">Taya Dicarlo</a>
                                            to dish out advice that works.
                                        </span>
                                        <p></p>
                                        <span class="list-item-text">
                                            You’ll find guides on everything from improving your Reels to generating leads and writing engaging captions and  <a href="https://theclose.com/real-estate-quotes/" target="_blank" style="color: #fa4a4a; text-decoration: underline;"> Motivational Quotes.</a> 
                                            Additionally, the blog delves into advanced techniques for growing your follower base, how top agents build their brands, and using Instagram Stories to connect with your audience.
                                        </span> 
                                        <p></p>
                                        <div class="text-center">
                                            <a class="add__listing--btn solid__btn" href="https://coffeecontracts.com/blog" target="_blank">Read coffee and contracts' blog</a>
                                        </div>                                       
                                    </li>
                                    <p></p>
                                    <h4 class="blog__content--title ">4. Business And Media (BAM) for Agents of Change</h4> 
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/Business-and-Media-BAM-600x258.webp" alt="img">
                                    </div> 
                                    <li class="icon-list-item mb-0 relative">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/helpful-resource.webp" alt="img" data-ll-status="loaded">
                                        <span class="list-item-text">
                                        <span class="font-weight-bold"><b> who should read it:</b></span>
                                        Agents who want to learn how to become better agents with a greater sense of humor.
                                        </span>
                                    </li>
                                    <li class="icon-list-item mb-0 relative">
                                        <img decoding="async" src="assets/img/blog/favorite-feature.webp" alt="img" data-ll-status="loaded">
                                        <noscript><img decoding="async" class="icon-image absolute" src="assets/img/blog/favorite-feature.webp" /></noscript>
                                        <span class="list-item-text">
                                            <span class="font-weight-bold"><b> Why we love it: </b></span> Broke Agent Media is the brainchild of Eric Simon, who you probably know from his wildly popular Instagram account,<a href="https://www.instagram.com/its_kay_jnr/TheBrokeAgent/" target="_blank" style="color: #fa4a4a; text-decoration: underline;"> The Broke Agent.</a>
                                            But instead of spicy memes and skits, Broke Agent Media provides timely and actionable advice for agents trying to make a splash on social media.                                             
                                            <a href="https://www.instagram.com/its_kay_jnr/tayadicarlo/?hl=en">Taya Dicarlo</a>
                                            to dish out advice that works.
                                        </span>
                                        <span class="list-item-text">BAM is a little video-heavy, featuring informative videos that break down complex topics into easy-to-digest concepts. However, the articles are as timely and actionable, offering <a href="https://theclose.com/real-estate-agent-tips/" target="_blank" style="color: #fa4a4a; text-decoration: underline;"> practical agent tips</a> 
                                            and interviews. BAM also includes unique elements, such as humorous takes on real estate challenges and relatable anecdotes, making it entertaining and educational. BAM is an instant bookmark if you want a dose of wit and humor with your real estate training.</span>
                                        <p></p>                                        
                                        <div class="text-center">
                                            <a class="add__listing--btn solid__btn" href="https://nowbam.com/" target="_blank">Read BAM</a>
                                        </div>                                       
                                    </li> 
                                    <p></p> 
                                    <h4 class="blog__content--title ">5. The CE Shop – Agent Essentials</h4> 
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/The-CE-Shop-logo.webp" alt="img">
                                    </div> 
                                    <li class="icon-list-item mb-0 relative">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/helpful-resource.webp" alt="img" data-ll-status="loaded">
                                        <span class="list-item-text">
                                        <span class="font-weight-bold"><b> who should read it:</b></span>
                                        Prospective and new real estate agents.
                                        </span>
                                    </li>
                                    <li class="icon-list-item mb-0 relative">
                                        <img decoding="async" src="assets/img/blog/favorite-feature.webp" alt="img" data-ll-status="loaded">
                                        <noscript><img decoding="async" class="icon-image absolute" src="assets/img/blog/favorite-feature.webp" /></noscript>
                                        <span class="list-item-text">
                                            <span class="font-weight-bold"><b> Why we love it: </b></span> In addition to its prelicensing, exam prep, license renewal, and continuing education courses, did you know that The CE Shop has a blog called Agent Essentials? It offers various content, such as guidance on switching to a real estate career, filing your taxes as an agent, and understanding the different types of first-time homebuyers. Additionally, Agent Essentials provides tech tools and
                                            <a href="https://theclose.com/real-estate-podcasts/" target="_blank" style="color: #fa4a4a; text-decoration: underline;">Podcast recommendations</a>
                                            offering inspiration and actionable advice.
                                        </span>                                                                               
                                        <div class="text-center">
                                            <a class="add__listing--btn solid__btn" href="https://theclose.theceshop.com/agent-essentials" target="_blank">Read The CE Shop's Agent Essentials </a>
                                        </div>                                       
                                    </li>
                                    <p></p>
                                    <h4 class="blog__content--title ">6. Forbes – Real Estate</h4> 
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/unnamed-2024-07-03T184755.514-600x338.webp" alt="img">
                                    </div> 
                                    <li class="icon-list-item mb-0 relative">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/helpful-resource.webp" alt="img" data-ll-status="loaded">
                                        <span class="list-item-text">
                                        <span class="font-weight-bold"><b> who should read it:</b></span>
                                        Agents, investors, homebuyers, and sellers looking for high-level market analysis.
                                        </span>
                                    </li>
                                    <li class="icon-list-item mb-0 relative">
                                        <img decoding="async" src="assets/img/blog/favorite-feature.webp" alt="img" data-ll-status="loaded">
                                        <noscript><img decoding="async" class="icon-image absolute" src="assets/img/blog/favorite-feature.webp" /></noscript>
                                        <span class="list-item-text">
                                            <span class="font-weight-bold"><b> Why we love it: </b>Forbes is one of the best real estate blogs on this list. It offers updates on housing policies, rare home listings, investment strategies, market trends, and analyses. I appreciate Forbes’ expert commentary and the diverse topics covered, from commercial real estate developments to the latest residential market shifts. If you’re looking for an excellent and reliable resource to understand the market dynamics better, Forbes should be your go-to blog.</span>
                                            <!--<a href="https://theclose.com/real-estate-podcasts/">Podcast recommendations</a>
                                            offering inspiration and actionable advice.-->
                                        </span> 
                                        <p></p>                                                                              
                                        <div class="text-center">
                                            <a class="add__listing--btn solid__btn" href="https://www.forbes.com/real-estate/" target="_blank">Read Forbes - Real Estate</a>
                                        </div>                                       
                                    </li>
                                    <p></p>                                                            
                                </div>
                                ...
                                <div class="related__posts mb-50">
                                    ...
                                    <div class="related__posts--content">
                                        <h3 class="blog__content--title ">FAQs: Best Real Estate Blogs </h3>
                                        <h3 class="blog__content--title ">Are there blogs that focus on specific local real estate markets? </h3>
                                        <p class="blog__details--content__desc">Absolutely! You can check out some excellent ones: The Real Deal, The New York Times’ Real Estate section, and HousingWire. These blogs have local market articles and can be great resources for agents, potential buyers, and sellers who want in-depth information on a specific area or neighborhood. If you’re going to find a local blog, simply search for “real estate blog,” followed by your city or town.</p>
                                        <h3 class="blog__content--title ">Are there blogs about real estate technology?..</h3>
                                        <p class="blog__details--content__desc">Yup! There are countless blogs about real estate technology as the industry evolves. One of the top real estate blogs that tackles technology is The Close. We have tech reviews and buyer’s guides for real estate CRMs, virtual staging software, virtual tour equipment, marketing companies, and more. Other blogs you can consider are NAR’s Emerging Technology blog, Forbes’ Real Estate section, and Geek Estate.</p>
                                        <h3 class="blog__content--title ">How can agents determine which blogs are reputable, reliable, and trustworthy? </h3>
                                        <p class="blog__details--content__desc">To assess the credibility of real estate blogs, check the author’s background and experience in the industry. Are their articles well-written and well-researched? Does the blog cite credible sources of information and statistics? Does the blog have a large readership? If the answer is yes to all of these questions, then you’re reading a reliable blog to help you <a href="https://theclose.com/real-estate-agent-goals/" target="_blank" style="color: #fa4a4a; text-decoration: underline;">crush your real estate goals.</a>
                                        </p>
                                        <h3 class="blog__content--title ">Bringing It All Together </h3> 
                                        <p class="blog__details--content__desc">All these reputable blogs offer an unlimited wealth of information that can provide actionable advice for your career. Did I miss your favorite real estate blog? Share your go-to sites in the comments!</p>
                                    </div>
                                </div>
                                <div class="blog__tag--share d-flex justify-content-between">
                                    <div class="blog__tag d-flex align-items-center">
                                        ...
                                        <ul class="blog__tag--wrapper d-flex">
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://theclose.com/media-kit/">Media kit</a></li>
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://theclose.com/advertise-with-us/">Advertise with us</a></li>
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://theclose.com/newsletter/">Newsletter</a></li>
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://theclose.com/subscribe/">Subscribe</a></li>
                                        </ul>
                                    </div>
                                    <div class="blog__share d-flex align-items-center">
                                        ...
                                        <ul class=" blog__share--social d-flex align-items-center">
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=facebook-icon-placement">
                                                    <svg width="10" height="17" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M7.62891 8.625L8.01172 6.10938H5.57812V4.46875C5.57812 3.75781 5.90625 3.10156 7 3.10156H8.12109V0.941406C8.12109 0.941406 7.10938 0.75 6.15234 0.75C4.15625 0.75 2.84375 1.98047 2.84375 4.16797V6.10938H0.601562V8.625H2.84375V14.75H5.57812V8.625H7.62891Z" fill="currentColor"></path>
                                                    </svg>
                                                    <span class="visually-hidden">Facebook</span>
                                            ...
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://x.com/_theclose?utm_source=website&utm_medium=footer&utm_campaign=twitter-icon-placement">
                                            ...
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://www.instagram.com/its_kay_jnr/theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=insta-icon-placement">
                                                    <svg width="16" height="16" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M7.125 3.60547C5.375 3.60547 3.98047 5.02734 3.98047 6.75C3.98047 8.5 5.375 9.89453 7.125 9.89453C8.84766 9.89453 10.2695 8.5 10.2695 6.75C10.2695 5.02734 8.84766 3.60547 7.125 3.60547ZM7.125 8.80078C6.00391 8.80078 5.07422 7.89844 5.07422 6.75C5.07422 5.62891 5.97656 4.72656 7.125 4.72656C8.24609 4.72656 9.14844 5.62891 9.14844 6.75C9.14844 7.89844 8.24609 8.80078 7.125 8.80078ZM11.1172 3.49609C11.1172 3.08594 10.7891 2.75781 10.3789 2.75781C9.96875 2.75781 9.64062 3.08594 9.64062 3.49609C9.64062 3.90625 9.96875 4.23438 10.3789 4.23438C10.7891 4.23438 11.1172 3.90625 11.1172 3.49609ZM13.1953 4.23438C13.1406 3.25 12.9219 2.375 12.2109 1.66406C11.5 0.953125 10.625 0.734375 9.64062 0.679688C8.62891 0.625 5.59375 0.625 4.58203 0.679688C3.59766 0.734375 2.75 0.953125 2.01172 1.66406C1.30078 2.375 1.08203 3.25 1.02734 4.23438C0.972656 5.24609 0.972656 8.28125 1.02734 9.29297C1.08203 10.2773 1.30078 11.125 2.01172 11.8633C2.75 12.5742 3.59766 12.793 4.58203 12.8477C5.59375 12.9023 8.62891 12.9023 9.64062 12.8477C10.625 12.793 11.5 12.5742 12.2109 11.8633C12.9219 11.125 13.1406 10.2773 13.1953 9.29297C13.25 8.28125 13.25 5.24609 13.1953 4.23438ZM11.8828 10.3594C11.6914 10.9062 11.2539 11.3164 10.7344 11.5352C9.91406 11.8633 8 11.7812 7.125 11.7812C6.22266 11.7812 4.30859 11.8633 3.51562 11.5352C2.96875 11.3164 2.55859 10.9062 2.33984 10.3594C2.01172 9.56641 2.09375 7.65234 2.09375 6.75C2.09375 5.875 2.01172 3.96094 2.33984 3.14062C2.55859 2.62109 2.96875 2.21094 3.51562 1.99219C4.30859 1.66406 6.22266 1.74609 7.125 1.74609C8 1.74609 9.91406 1.66406 10.7344 1.99219C11.2539 2.18359 11.6641 2.62109 11.8828 3.14062C12.2109 3.96094 12.1289 5.875 12.1289 6.75C12.1289 7.65234 12.2109 9.56641 11.8828 10.3594Z" fill="currentColor"></path>
                                                    </svg>  
                                                    <span class="visually-hidden">Instagram</span>
                                            ...
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://www.pinterest.com/erickkibisu/search/pins/?rs=ac&len=2&q=real%20estate&eq=real%20es&etslf=71651">
                                                    <svg width="14" height="16" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="listing__widget">
                            <div class="widget__admin--profile blog__admin text-center mb-30">
                                <div class="admin__profile--thumbnail">
                                    <img src="assets/img/other/60835929_10214632292704207_90420404589428736_n-e1685695287546-300x300.webp" alt="img">
                                </div>
                                <div class="admin__profile--content">
                                    <h3 class="admin__profile--name">Julia Del Rosario</h3>
                                    <h5 class="admin__profile--subtitle">Julia is a staff writer, researcher, and expert in real estate education, marketing, and lead generation.</h5>
                                    ...
                                    <p class="admin__profile--desc"><a href="https://theclose.com/author/julia-delrosario/" target="_blank" style="color: #fa4a4a; text-decoration: underline;">see full bio</a></p>
                                    ...
                                    <ul class=" profile__social d-flex align-items-center justify-content-center">
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=facebook-icon-placement">
                                                <svg width="10" height="17" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.62891 8.625L8.01172 6.10938H5.57812V4.46875C5.57812 3.75781 5.90625 3.10156 7 3.10156H8.12109V0.941406C8.12109 0.941406 7.10938 0.75 6.15234 0.75C4.15625 0.75 2.84375 1.98047 2.84375 4.16797V6.10938H0.601562V8.625H2.84375V14.75H5.57812V8.625H7.62891Z" fill="currentColor"></path>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://x.com/_theclose?utm_source=website&utm_medium=footer&utm_campaign=twitter-icon-placement">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"></path>
                                                  </svg>
                                                <span class="visually-hidden">Twitter</span>
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url=https://www.houzeo.com/blog/real-estate-facts&title=You%20might%20find%20this%20interesting!%2020%20Interesting%20Real%20Estate%20Facts%20You%20Should%20Know">
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.pinterest.com/erickkibisu/search/pins/?rs=ac&len=2&q=real%20estate&eq=real%20es&etslf=71651">
                                                <svg width="14" height="16" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M14.6713 6.71093C14.6764 7.71873 14.5406 8.65694 14.2638 9.52555C14.0104 10.394 13.6393 11.146 13.1503 11.7813C12.6612 12.3932 12.0778 12.8883 11.4001 13.2668C10.7222 13.6218 9.97304 13.7897 9.15262 13.7705C8.87149 13.7954 8.59012 13.7734 8.30852 13.7045C8.05023 13.6121 7.80366 13.5196 7.56881 13.427C7.35727 13.3109 7.16906 13.1713 7.00416 13.008C6.83926 12.8448 6.70957 12.6931 6.61511 12.553C6.47736 13.1162 6.36257 13.5856 6.27074 13.961C6.17891 14.3365 6.09838 14.6299 6.02915 14.8412C5.98323 15.0289 5.94879 15.1697 5.92584 15.2636C5.9262 15.3339 5.92632 15.3573 5.9262 15.3339C5.85696 15.5452 5.78767 15.7448 5.71832 15.9326C5.64897 16.1205 5.56796 16.3201 5.47529 16.5315C5.3825 16.7195 5.27793 16.8958 5.16158 17.0605C5.06867 17.225 4.97576 17.3896 4.88285 17.5541C4.60256 17.743 4.38033 17.8262 4.21615 17.8036C4.07553 17.8043 3.95804 17.7463 3.86369 17.6296C3.79278 17.5128 3.74531 17.3959 3.72127 17.2788C3.69736 17.1852 3.68534 17.1266 3.68522 17.1032C3.66094 16.9393 3.64832 16.7635 3.64736 16.576C3.64629 16.3651 3.64527 16.1659 3.64431 15.9784C3.66667 15.7673 3.68902 15.5563 3.71138 15.3452C3.75718 15.1341 3.80309 14.9463 3.84913 14.782C3.84901 14.7586 3.86037 14.6882 3.8832 14.5709C3.92936 14.43 3.99829 14.1602 4.09 13.7612C4.18159 13.3389 4.30756 12.764 4.46791 12.0366C4.62825 11.3092 4.84599 10.3472 5.12112 9.15044C5.05009 9.01017 4.9906 8.8347 4.94264 8.624C4.89469 8.41331 4.85863 8.23771 4.83448 8.0972C4.8102 7.93326 4.79776 7.7927 4.79716 7.67551C4.79657 7.55833 4.79633 7.51145 4.79645 7.53489C4.79441 7.13646 4.83948 6.78466 4.93167 6.4795C5.04718 6.15078 5.18637 5.86881 5.34923 5.6336C5.53541 5.37483 5.74538 5.18626 5.97915 5.06787C6.23624 4.92593 6.49363 4.84258 6.75132 4.81782C6.98581 4.84006 7.18527 4.88592 7.34969 4.95539C7.53755 5.02474 7.69049 5.14115 7.80851 5.30461C7.92654 5.46807 8.00947 5.64343 8.0573 5.83069C8.12845 5.99439 8.16463 6.19342 8.16583 6.4278C8.16691 6.63873 8.13307 6.89672 8.06432 7.20176C7.99544 7.48337 7.91491 7.77675 7.82272 8.08192C7.73053 8.38708 7.62674 8.71574 7.51135 9.0679C7.41928 9.3965 7.33887 9.71332 7.27012 10.0184C7.20137 10.3234 7.19103 10.593 7.2391 10.8271C7.31049 11.0377 7.41704 11.2481 7.55874 11.4583C7.72376 11.645 7.92369 11.7846 8.15854 11.8771C8.3934 11.9697 8.63979 12.027 8.89771 12.0491C9.38978 12.0232 9.8343 11.8686 10.2313 11.5853C10.6283 11.302 10.9661 10.9018 11.2447 10.3848C11.5467 9.86758 11.7665 9.29223 11.9038 8.65871C12.0646 8.00163 12.1429 7.28637 12.139 6.51294C12.1362 5.97389 12.0398 5.45875 11.8498 4.96753C11.6598 4.47631 11.3765 4.06759 10.9998 3.74139C10.6464 3.39163 10.1997 3.11266 9.65954 2.90449C9.14285 2.69619 8.533 2.60556 7.83 2.63259C7.05646 2.61311 6.354 2.74561 5.72263 3.03009C5.11471 3.31446 4.58923 3.68043 4.1462 4.12802C3.70317 4.5756 3.36603 5.10467 3.13477 5.71524C2.9034 6.30237 2.78933 6.91234 2.79257 7.54514C2.79388 7.80295 2.80674 8.02554 2.83114 8.21292C2.87885 8.37674 2.92662 8.55228 2.97446 8.73954C3.04561 8.90324 3.1167 9.05522 3.18773 9.19548C3.28208 9.31219 3.38827 9.45227 3.50629 9.61574C3.55329 9.63893 3.58868 9.68563 3.61248 9.75582C3.63615 9.80257 3.64805 9.83767 3.64817 9.86111C3.67173 9.88442 3.68369 9.93124 3.68405 10.0015C3.68429 10.0484 3.67281 10.0954 3.64961 10.1424C3.62653 10.2128 3.60346 10.2832 3.58038 10.3536C3.58062 10.4005 3.56926 10.4709 3.5463 10.5648C3.52334 10.6586 3.50033 10.7408 3.47725 10.8112C3.45405 10.8582 3.44263 10.9169 3.44299 10.9872C3.4198 11.0342 3.38494 11.0929 3.33842 11.1635C3.31523 11.2105 3.28025 11.2458 3.2335 11.2695C3.18662 11.2697 3.13981 11.2817 3.09305 11.3054C3.04618 11.3056 2.98747 11.2825 2.91691 11.236C2.56464 11.0971 2.24722 10.8995 1.96465 10.6432C1.7054 10.3632 1.49291 10.0596 1.32717 9.73235C1.16143 9.40507 1.03061 9.03073 0.934703 8.60934C0.838796 8.18795 0.789764 7.76633 0.787606 7.34446C0.78377 6.59447 0.932275 5.8437 1.23312 5.09215C1.55741 4.34048 2.02261 3.64668 2.62874 3.01076C3.23487 2.37484 3.99401 1.86705 4.90614 1.48737C5.81815 1.08427 6.88346 0.867877 8.10208 0.838206C9.08656 0.856608 9.97807 1.02783 10.7766 1.35188C11.5985 1.65236 12.2921 2.08241 12.8575 2.64203C13.4228 3.20165 13.8597 3.83223 14.1679 4.53379C14.4995 5.21179 14.6673 5.9375 14.6713 6.71093Z" fill="currentColor"></path>
                                                    </svg>
                                                <span class="visually-hidden">Pinterest</span>
       ...
       <div class="social__media--area bg__style">
            <ul class="social__media--wrapper d-flex">
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.facebook.com/erick.kibisu.12theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=facebook-icon-placement"> <svg width="9" height="18" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list"><a class="social__media--link" target="_blank"  href="https://x.com/_theclose?utm_source=website&utm_medium=footer&utm_campaign=twitter-icon-placement"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"></path>
                  </svg>
                  <span>Twitter</span>
                    </a>
                </li>
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.instagram.com/its_kay_jnr/theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=insta-icon-placement"> <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.youtube.com/channel/UCwcBGxpvkj4VzkCD0exkK3g"> <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://www.linkedin.com/company/theclose/">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="#fa4a4a">
                        <path d="M4.98 3.5C4.98 4.328 4.328 5 3.5 5A1.5 1.5 0 1 1 3.5 2c.83 0 1.48.672 1.48 1.5zM4.98 21H2V8h2.98v13zM22 21h-3v-6c0-1.897-2-1.75-2 0v6h-3V8h3v1.296C18.235 7.27 22 6.932 22 10.735V21z"></path>
                      </svg>
                      <span>LinkedIn</span>
                    </a>
                </li>                  
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.pinterest.com/erickkibisu/theclosedotcom/_Created/"> <svg width="14" height="16" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="footer__widget--inner newsletter">
                                    ...
                                    <ul class=" footer__social d-flex align-items-center">
                                        <li class="footer__social--list">
                                            <a class="footer__social--icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=facebook-icon-placement">
                                                <svg width="10" height="17" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.62891 8.625L8.01172 6.10938H5.57812V4.46875C5.57812 3.75781 5.90625 3.10156 7 3.10156H8.12109V0.941406C8.12109 0.941406 7.10938 0.75 6.15234 0.75C4.15625 0.75 2.84375 1.98047 2.84375 4.16797V6.10938H0.601562V8.625H2.84375V14.75H5.57812V8.625H7.62891Z" fill="currentColor"></path>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="footer__social--list">
                                            <a class="footer__social--icon" target="_blank" href="https://x.com/_theclose?utm_source=website&utm_medium=footer&utm_campaign=twitter-icon-placement">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                        ...
                                        <li class="footer__social--list">
                                            <a class="footer__social--icon" target="_blank" href="https://www.instagram.com/its_kay_jnr/theclosedotcom/?utm_source=website&utm_medium=footer&utm_campaign=insta-icon-placement">
                                                <svg width="16" height="16" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.125 3.60547C5.375 3.60547 3.98047 5.02734 3.98047 6.75C3.98047 8.5 5.375 9.89453 7.125 9.89453C8.84766 9.89453 10.2695 8.5 10.2695 6.75C10.2695 5.02734 8.84766 3.60547 7.125 3.60547ZM7.125 8.80078C6.00391 8.80078 5.07422 7.89844 5.07422 6.75C5.07422 5.62891 5.97656 4.72656 7.125 4.72656C8.24609 4.72656 9.14844 5.62891 9.14844 6.75C9.14844 7.89844 8.24609 8.80078 7.125 8.80078ZM11.1172 3.49609C11.1172 3.08594 10.7891 2.75781 10.3789 2.75781C9.96875 2.75781 9.64062 3.08594 9.64062 3.49609C9.64062 3.90625 9.96875 4.23438 10.3789 4.23438C10.7891 4.23438 11.1172 3.90625 11.1172 3.49609ZM13.1953 4.23438C13.1406 3.25 12.9219 2.375 12.2109 1.66406C11.5 0.953125 10.625 0.734375 9.64062 0.679688C8.62891 0.625 5.59375 0.625 4.58203 0.679688C3.59766 0.734375 2.75 0.953125 2.01172 1.66406C1.30078 2.375 1.08203 3.25 1.02734 4.23438C0.972656 5.24609 0.972656 8.28125 1.02734 9.29297C1.08203 10.2773 1.30078 11.125 2.01172 11.8633C2.75 12.5742 3.59766 12.793 4.58203 12.8477C5.59375 12.9023 8.62891 12.9023 9.64062 12.8477C10.625 12.793 11.5 12.5742 12.2109 11.8633C12.9219 11.125 13.1406 10.2773 13.1953 9.29297C13.25 8.28125 13.25 5.24609 13.1953 4.23438ZM11.8828 10.3594C11.6914 10.9062 11.2539 11.3164 10.7344 11.5352C9.91406 11.8633 8 11.7812 7.125 11.7812C6.22266 11.7812 4.30859 11.8633 3.51562 11.5352C2.96875 11.3164 2.55859 10.9062 2.33984 10.3594C2.01172 9.56641 2.09375 7.65234 2.09375 6.75C2.09375 5.875 2.01172 3.96094 2.33984 3.14062C2.55859 2.62109 2.96875 2.21094 3.51562 1.99219C4.30859 1.66406 6.22266 1.74609 7.125 1.74609C8 1.74609 9.91406 1.66406 10.7344 1.99219C11.2539 2.18359 11.6641 2.62109 11.8828 3.14062C12.2109 3.96094 12.1289 5.875 12.1289 6.75C12.1289 7.65234 12.2109 9.56641 11.8828 10.3594Z" fill="currentColor"></path>
                                                </svg>  
                                                <span class="visually-hidden">Instagram</span>
