...
function openModal() {
  ...
  var videoUrl = "https://www.youtube.com/embed/MqEJqyNPX_Q?autoplay=1"; // Embed YouTube video
...
document.addEventListener("DOMContentLoaded", function () {
  document.getElementById("signupForm").addEventListener("submit", function (event) {
      ...
      if (!checkbox.checked) {
          document.getElementById("message").innerHTML = "<p style='color: red;'>You must agree to the Terms & Conditions.</p>";
      ...
      .then(data => {
          document.getElementById("message").innerHTML = data; // Display server response
