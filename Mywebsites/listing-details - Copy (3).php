                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/569278622.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    ...
                                    <div class="listing__hero--slider__content">
                                        <div class="listing__hero--slider__content--top d-flex align-items-center justify-content-between">
                                            <h3 class="listing__hero--slider__title">Accomodation</h3>
                                            <span class="listing__hero--slider__price">Kes 7,000 - 12,000 per night</span>
                                        </div>
                                        ...
                                        Lantana Road 103, 00100 Nairobi, Kenya</p>
                                    </div>
                                    <!-- Hero Content .\ -->
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/607688053.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/607688290.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/569278622 (1).jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/526442559.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/526442570.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/526442580.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/526442618.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                              <!-- Hero swiper items -->
                              <div class="listing__small--hero__slider--items">
                                  <img src="assets/img/hero/607688158.jpg" alt="img">
                              </div>
                              <!-- Hero swiper items .\ -->
                          </div>
                        </div>
                        ...
                        <div class="listing__details--wrapper">
                            <div class="listing__details--content">
                                <div class="listing__details--content__top mb-25 d-flex align-items-center justify-content-between">
                                    <div class="listing__details--meta">
                                        <ul class="listing__details--meta__wrapper d-flex align-items-center">
                                            ...
                                            <li><span class="listing__details--badge two">For Rent</span></li>
                                            <li>
                                            ...
                                            <li>
                                                <span class="listing__details--meta__icon">
                                                 ...
                                                 <span class="listing__details--meta__text">14 views</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <ul class="listing__details--action d-flex">
                                        <li class="listing__details--action__list">
                                            <a class="listing__details--wishlist__btn" href="listing-list.php">
                                        ...
                                        <li class="listing__details--action__list position-relative">
                                          ...
                                          <ul class="dropdown-menu share__dropdown--menu" style="margin: 0px;">
                                              ...
                                              <li class="social__share--list"><a class="social__share--link" data-bs-toggle="modal" href="https://www.pinterest.com/erickkibisu/"><span>Pinterest</span> <svg width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li class="listing__details--action__list">
                                          <a class="listing__details--action__btn" href="listing-list.php">
                                ...
                                <div class="listing__details--content__step">
                                    <h2 class="listing__details--title mb-25">Casa Misa Westlands one bedroom</h2>
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">Kes 7,000 - 12,000 per night</span>
                                            <span class="listing__details--price__old">Kes 5000</span>
                                        </div>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <p class="listing__details--content__desc">You may get a Genius discount at Casa Misa Westlands one bedroom. To find out if the Genius discount applies to your dates, <a href="https://account.booking.com/auth/oauth2?redirect_uri=https%3A%2F%2Fsecure.booking.com%2Flogin.php%3Fop%3Doauth_return&state=UqcFP64Ze_6TkE8tbIkSQCoD3J78cgBZJKz1tqYnXxaahAXrXWj63VBUZ9DrqWI3fHySJ_w2TBKQhcXC95i4pOD2I_3_HxC02tl-c3iqDDcjtVGaZ5sZafPej2R-J5uIc_fUNSB7U56quIrOTeBnYuvWSiOHfXLmExh0aZyBGrdLKEV6_wk7moO3_TPNiJvkUrX_xm2yLKVBXHymazlU3KcuyiOrhvCvXkfBpsoN8LXeswXqSFNI1-15V1BymDOV5k3eGqW1wmS7YAScKGzsMZ130_iheEWglB8Z_iXcQ1o_Tb_z5qm1dCzD7pZiYBwQs6OQGV_-3wtMXEf9GDqDl9uSVhDZXgbFmEtSyGwVBPQRxUIvR8glGn1fpTcEhAOU7Sa6UfwiQb26OIOvfBZTlqPEmU3HkOxlvC0y7r4fzgt8qOm3dn-KldZ5kHIHydKY5DvMvx3wp50cbKQBScUR0EVsZmZ7PZryFHyA4cti_ABaUowNiPqnf1XiXmgfGtOsdXgjm8AztHmA-h9XXMw3DLNYwnvy061Qj8nheUf0aPeWbVDVrqg80O_Getj83fRPPnoMPSpTy07KZGC9IgdOjXXfmJ5CMNQ4ZIUG1jQbGJ6MxbMPCPWQhJAr-jEBuK8pCwbuheUdn6-r2i3OEpevA8TKO0Iz3W7TWKRH39wChnKIv94SG3dw-jlxvaMcJfeQjI-Uwb96_w7k_37YOQRlsNEs5K_TLJKpt-6diDBjspxC-8f88uPHEH8MWP_8tOrA42ryu0OZBXajWMMmQNHp8Ds20XGriCN2ytbdf5KPmjiwuZP3GRA49D54wAmcdgvD1_D1x_oaNtulPtc2Np_Ke2NLSBIxY88h7NNomEy5foheSnRToRjQ_qKeF_7MkuDFpSjsQ-IdusKezQ&client_id=vO1Kblk7xX9tUn2cpZLS&bkng_action=hotel&response_type=sso&aid=1181029&lang=es&dt=1738741956" style="color: #006ce4; text-decoration: underline;"> sign in.</a>

                                        Genius discounts at this property depend on booking dates, dates of stay and other available offers.
                                        
                                        Located in Nairobi, near Eden Square Office Block, Casa Misa Westlands one bedroom offers accommodation with free WiFi, free private parking and access to the hot tub. The accommodation has a hot tub and air conditioning.
                                        
                                        The aparthotel offers a terrace, pool views, a seating area, a flat-screen TV, a fully equipped kitchen with a fridge and oven, and a private bathroom with a bidet and free toiletries. For added convenience, towels and bed linen can be provided at an extra cost.
                                        
                                        There is also a garden ideal for relaxing.
                                        
                                        National Museum of Nairobi is 3.3 km from the accommodation, and Kenyatta International Conference Centre is 4.8 km away. The airport (Wilson Airport) is 9 km away.
                                        
                                        Couples love its fabulous location — they've given it an 8.6 for two-person trips.</p>
                                    <div class="apartment__info listing__d--info">
                                        <div class="apartment__info--wrapper d-flex">
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    <span class="apartment__info--count">1</span>
                                                    <span class="apartment__info--title">Bedroom</span>
                                                </p>
                                            </div>
                                            <div class="apartment__info--list">
                                                <span class="apartment__info--icon"><img src="assets/img/icon/modern-car.png" alt="img"></span>
                                                <p>
                                                    <span class="apartment__info--count">P</span>
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">600-800 Sqft</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">190,000/mo</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">600 - 800 SqFt</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">05</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Washroom:</span>
                                            <span class="properties__details--info__subtitle">01</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                    ...
                                    <div class="properties__amenities--wrapper d-flex">
                                        <ul class="properties__amenities--step">
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Private bathroom</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                                ...
                                                <span class="properties__amenities--text">Bathtub</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                                ...
                                                <span class="properties__amenities--text">Balcony</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                                ...
                                                <span class="properties__amenities--text">Family Rooms</span>
                                            </li>
                                        </ul>
                                        <ul class="properties__amenities--step">
                                            <li class="properties__amenities--list d-flex align-items-center">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Indoor Shower</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                ...
                                <div class="listing__details--content__step mb-80">
                                    <div class="properties__floor--plans d-flex">
                                        <div class="properties__floor--plans__content">
                                            <h3 class="listing__details--content__title mb-40">Floor Plan Layout </h3>
                                            <ul class="properties__floor--plans__info">
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon1.png" alt="icon">-->
                                                    <span>Living Room – Includes a seating area, flat-screen TV, and access to a terrace or balcony. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon2.png" alt="icon">-->
                                                    <span>Bedroom – A single bedroom with space for a queen or king-sized bed, bedside tables, and a wardrobe. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon3.png" alt="icon">-->
                                                    <span>Kitchen – A fully equipped kitchen with a fridge, oven, and counter space for cooking.</span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon4.png" alt="icon">-->
                                                    <span>Bathroom – A private bathroom with a bidet, toilet, and shower or bathtub. </span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="floor1">
                                                    <div class="properties__floor--plans__display">
                                                        <img src="assets/img/other/04043b6c-866f-49e6-a819-8b6ae15659e3.webp" alt="img">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8440694691585!2d36.79382242411836!3d-1.2662087487217373!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f174295e8fb7f%3A0x9cfdfbfced873a9a!2sCasa%20Misa%20Westlands!5e0!3m2!1sen!2ske!4v1738745018870!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </details>
                                        </div>
                                    </div>
                                    <div class="location__google--maps__info d-flex">
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Lantana Road 103, 00100 Nairobi, Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Country: </span>
                                                <span class="location__google--maps__info--subtitle">Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">County/State: </span>
                                                <span class="location__google--maps__info--subtitle">New Work</span>
                                            </li>
                                        </ul>
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Town:</span>
                                                <span class="location__google--maps__info--subtitle">Westlands</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Neighborhood:  </span>
                                                <span class="location__google--maps__info--subtitle">Lantana Road</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--video__thumbnail position-relative">
                                        <img src="assets/img/property/th (2).jpg" alt="img" class="video-thumbnail">
                                        <div class="bideo__play">
                                            <a class="bideo__play--icon glightbox" href="https://www.bing.com/videos/riverview/relatedvideo?&q=Casa+Misa+Westlands+one+bedroom+Lantana+Road+103%2c+00100+Nairobi%2c+Kenya&&mid=C26D24B02B13D594851BC26D24B02B13D594851B&&FORM=VRDGAR" data-gallery="video">
                                        ...
                                        <div class="details__review--wrapper d-flex">
                                            <div class="details__review--step">
                                                <div class="details__review--list d-flex align-items-center justify-content-between">
                                                    <span class="review__list--title">Property (0.0)</span>
                                    ...
                                    <div class="properties__reviews--comment mb-80">
                                       ...
                                       <div class="properties__reviews--comment__display mb-50 d-flex align-items-center justify-content-between">
                                            <div class="reviews__comment--display__left d-flex align-items-center">
                                                <span class="reviews__comment--display__text">0 Reviews</span>
                                                ...
                                                <span class="reviews__comment--display__text">(0 out of 5)</span>
                                            </div>
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">Review 1</h3>
                                                            <span class="reviews__comment--author__date">25th january 2024</span>
                                                        </div>
                                                    ...
                                                    <p class="reviews__comment--desc">"Casa Misa Westlands is in a fantastic location with easy access to shopping centers and restaurants. The apartment is well-furnished, and the kitchen had all the essentials for a short stay. The hot tub was a great touch! However, the WiFi was a bit slow at times, and the check-in process could be smoother. Overall, a great stay but room for improvement."</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 2</h3>
                                                            <span class="reviews__comment--author__date">15th June 2023</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"The apartment itself is stylish and modern, and I really liked the pool area. It was also quiet at night, which was a plus. However, I had issues with the air conditioning—it wasn’t cooling properly. Also, the towels and bed linen came at an extra cost, which I felt should have been included. Decent stay, but I expected a bit more for the price."</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content last__content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 3</h3>
                                                            <span class="reviews__comment--author__date">14th August 2024</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"I loved the spaciousness of the apartment and the beautiful terrace with pool views. It felt like a little retreat in the middle of the city. The staff were friendly, but the parking situation was a bit confusing, and I wish they provided more details upfront. Also, the bidet in the bathroom was tricky to use. A good experience overall, but some minor inconveniences."</p>
                                                </div>
                                            </div>
                                       </div>
                                    </div>
                        ...
                        <div class="listing__widget">
                            <div class="widget__admin--profile text-center mb-30">
                                <div class="admin__profile--thumbnail">
                                    <img src="assets/img/other/444444851_1169499307583042_1219218947373135559_n.jpg" alt="img">
                                </div>
                                <div class="admin__profile--content">
                                    <h3 class="admin__profile--name">Kibisu Erick</h3>
                                    ...
                                    <p class="admin__profile--desc">Kibisu Erick is a passionate and dedicated real estate broker, helping clients find their ideal homes and rental properties. As a final-year student at The Co-operative University of Kenya, he combines market knowledge with modern technology to provide seamless property reservation solutions. Whether you're looking for a luxury stay or a long-term rental, Erick is committed to making the process smooth and stress-free.</p>
                                    ...
                                    <ul class=" profile__social d-flex align-items-center justify-content-center">
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12">
                                                <svg width="10" height="17" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.62891 8.625L8.01172 6.10938H5.57812V4.46875C5.57812 3.75781 5.90625 3.10156 7 3.10156H8.12109V0.941406C8.12109 0.941406 7.10938 0.75 6.15234 0.75C4.15625 0.75 2.84375 1.98047 2.84375 4.16797V6.10938H0.601562V8.625H2.84375V14.75H5.57812V8.625H7.62891Z" fill="currentColor"></path>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://x.com/ONYANGOERI47602">
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.instagram.com/its_kay_jnr/">
                                                <svg width="16" height="16" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.125 3.60547C5.375 3.60547 3.98047 5.02734 3.98047 6.75C3.98047 8.5 5.375 9.89453 7.125 9.89453C8.84766 9.89453 10.2695 8.5 10.2695 6.75C10.2695 5.02734 8.84766 3.60547 7.125 3.60547ZM7.125 8.80078C6.00391 8.80078 5.07422 7.89844 5.07422 6.75C5.07422 5.62891 5.97656 4.72656 7.125 4.72656C8.24609 4.72656 9.14844 5.62891 9.14844 6.75C9.14844 7.89844 8.24609 8.80078 7.125 8.80078ZM11.1172 3.49609C11.1172 3.08594 10.7891 2.75781 10.3789 2.75781C9.96875 2.75781 9.64062 3.08594 9.64062 3.49609C9.64062 3.90625 9.96875 4.23438 10.3789 4.23438C10.7891 4.23438 11.1172 3.90625 11.1172 3.49609ZM13.1953 4.23438C13.1406 3.25 12.9219 2.375 12.2109 1.66406C11.5 0.953125 10.625 0.734375 9.64062 0.679688C8.62891 0.625 5.59375 0.625 4.58203 0.679688C3.59766 0.734375 2.75 0.953125 2.01172 1.66406C1.30078 2.375 1.08203 3.25 1.02734 4.23438C0.972656 5.24609 0.972656 8.28125 1.02734 9.29297C1.08203 10.2773 1.30078 11.125 2.01172 11.8633C2.75 12.5742 3.59766 12.793 4.58203 12.8477C5.59375 12.9023 8.62891 12.9023 9.64062 12.8477C10.625 12.793 11.5 12.5742 12.2109 11.8633C12.9219 11.125 13.1406 10.2773 13.1953 9.29297C13.25 8.28125 13.25 5.24609 13.1953 4.23438ZM11.8828 10.3594C11.6914 10.9062 11.2539 11.3164 10.7344 11.5352C9.91406 11.8633 8 11.7812 7.125 11.7812C6.22266 11.7812 4.30859 11.8633 3.51562 11.5352C2.96875 11.3164 2.55859 10.9062 2.33984 10.3594C2.01172 9.56641 2.09375 7.65234 2.09375 6.75C2.09375 5.875 2.01172 3.96094 2.33984 3.14062C2.55859 2.62109 2.96875 2.21094 3.51562 1.99219C4.30859 1.66406 6.22266 1.74609 7.125 1.74609C8 1.74609 9.91406 1.66406 10.7344 1.99219C11.2539 2.18359 11.6641 2.62109 11.8828 3.14062C12.2109 3.96094 12.1289 5.875 12.1289 6.75C12.1289 7.65234 12.2109 9.56641 11.8828 10.3594Z" fill="currentColor"></path>
                                                </svg>  
                                                <span class="visually-hidden">Instagram</span>
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.pinterest.com/erickkibisu/">
                                                <svg width="14" height="16" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="widget__form">
                                    <form action="#">
                                        ...
                                        <div class="widget__form--input">
                                            <textarea class="widget__form--textarea__field" placeholder="Write You Message"></textarea>
                                        </div>
                                        <button class="widget__form--btn solid__btn" type="submit">Send Message</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="assets/img/property/house-11.jpg" alt="img">
                                        <div class="featured__badge">
                                            <span class="badge__field">For sale</span>
                                        </div>
                                    </div>
                                    <div class="widget__featured--properties__content">
                                        <div class="widget__featured--properties__content--top d-flex align-items-center justify-content-between">
                                            ...
                                            <ul class="widget__featured--properties__share d-flex">
                                                ...
                                                <li class="widget__featured--properties__share--list">
                                                  <a class="widget__featured--properties__share--btn" href="listing-list.php">
                                                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M7.855 0C5.77166 0 3.77371 0.82758 2.30076 2.30076C0.82758 3.77375 0 5.77171 0 7.855C0 9.9383 0.82758 11.9363 2.30076 13.4092C3.77375 14.8824 5.7717 15.71 7.855 15.71C9.9383 15.71 11.9363 14.8824 13.4092 13.4092C14.8824 11.9363 15.71 9.9383 15.71 7.855C15.7073 5.77252 14.8789 3.77621 13.4062 2.30395C11.9338 0.831315 9.93743 0.00286936 7.85518 0.000182413L7.855 0ZM7.855 14.1388C6.18845 14.1388 4.59008 13.4767 3.41151 12.2983C2.23313 11.1197 1.571 9.52132 1.571 7.85482C1.571 6.18832 2.23313 4.5899 3.41151 3.41133C4.59008 2.23295 6.1885 1.57082 7.855 1.57082C9.5215 1.57082 11.1199 2.23295 12.2985 3.41133C13.4769 4.5899 14.139 6.18832 14.139 7.85482C14.1376 9.521 13.4751 11.1187 12.2969 12.2967C11.1189 13.4749 9.52118 14.1374 7.855 14.1388Z" fill="currentColor"></path>
                                                          <path d="M11.5835 7.06853H8.64034V4.12541C8.64034 3.84469 8.49072 3.58552 8.24772 3.44511C8.00471 3.30475 7.70514 3.30475 7.46213 3.44511C7.21912 3.58547 7.06951 3.84467 7.06951 4.12541V7.06853H4.12639C3.84567 7.06853 3.58649 7.21815 3.44609 7.46115C3.30573 7.70416 3.30573 8.00373 3.44609 8.24674C3.58645 8.48975 3.84564 8.63936 4.12639 8.63936H7.06951V11.5825C7.06951 11.8632 7.21912 12.1224 7.46213 12.2628C7.70513 12.4031 8.00471 12.4031 8.24772 12.2628C8.49072 12.1224 8.64034 11.8632 8.64034 11.5825V8.63936H11.5835C11.8642 8.63936 12.1234 8.48975 12.2638 8.24674C12.4041 8.00374 12.4041 7.70416 12.2638 7.46115C12.1234 7.21815 11.8642 7.06853 11.5835 7.06853Z" fill="currentColor"></path>
                                                      </svg>                                                   
                                        ...
                                        <p class="widget__featured--properties__desc"><svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            Hazina Estate, South B, Nairobi, Kenya</p>
                                        <h3 class="widget__featured--properties__title">Luxury suit</h3>
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">Kes 18,000-24000</span>
                                            <span class="old__price">Kes 17000</span>
                                        </div>    
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget__step">
                                ...
                                <div class="widget__featured">
                                  <!-- Featured Item: Bedroom -->
                                  <div class="widget__featured--items d-flex">
                                    <div class="widget__featured--thumb">
                                      <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalBedroom">
                                        <img class="widget__featured--media" src="assets/img/hero/526442559.jpg" alt="Bedroom">
                                      </a>
                                    </div>
                                  ...
                                  <!-- Modal for Bedroom -->
                                  <div class="modal fade" id="imageModalBedroom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelBedroom" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <img class="img-fluid" src="assets/img/hero/526442559.jpg" alt="Bedroom">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                              
                                  <!-- Featured Item: Kitchen Items -->
                                  <div class="widget__featured--items d-flex">
                                    <div class="widget__featured--thumb">
                                      <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalKitchen">
                                        <img class="widget__featured--media" src="assets/img/hero/526442580.jpg" alt="Kitchen Items">
                                      </a>
                                    </div>
                                    <div class="widget__featured--content">
                                      <h3 class="widget__featured--title">
                                  ...
                                  <!-- Modal for Kitchen Items -->
                                  <div class="modal fade" id="imageModalKitchen" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelKitchen" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                          <img class="img-fluid" src="assets/img/hero/526442580.jpg" alt="Kitchen Items">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                              
                                  <!-- Featured Item: Washroom -->
                                  <div class="widget__featured--items d-flex">
                                    <div class="widget__featured--thumb">
                                      <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalWashroom">
                                        <img class="widget__featured--media" src="assets/img/hero/607688158.jpg" alt="Washroom">
                                      </a>
                                    </div>
                                    <div class="widget__featured--content">
                                      <h3 class="widget__featured--title">
                                  ...
                                  <!-- Modal for Washroom -->
                                  <div class="modal fade" id="imageModalWashroom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelWashroom" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                          <img class="img-fluid" src="assets/img/hero/607688158.jpg" alt="Washroom">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                              ...
                              <!-- Include jQuery and Bootstrap JS (ensure these are included only once in your page) -->
