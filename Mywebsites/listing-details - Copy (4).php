                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/520325397.jpg" alt="img">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/520325387.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/520325394.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/520325316.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/520325397.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/520325387.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/520325394.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/520325316.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                              <!-- Hero swiper items -->
                              <div class="listing__small--hero__slider--items">
                                  <img src="assets/img/hero/520325422.jpg" alt="img">
                              </div>
                              <!-- Hero swiper items .\ -->
                          </div>
                        </div>
                        ...
                        <div class="listing__details--wrapper">
                            <div class="listing__details--content">
                                        ...
                                        <ul class="listing__details--meta__wrapper d-flex align-items-center">
                                            ...
                                            <li>
                                                <span class="listing__details--meta__icon">
                                                 ...
                                                 <span class="listing__details--meta__text">1 year ago</span>
                                            </li>
                                            <li>
                                                <span class="listing__details--meta__icon">
                                                 ...
                                                 <span class="listing__details--meta__text">1 views</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="listing__details--content__step">
                                    <h2 class="listing__details--title mb-25">Ngong Rd Gem:Breathtaking Views!</h2>
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">Kes 35,000 - 65,000</span>
                                            <span class="listing__details--price__old">Kes 30,000</span>
                                        </div>
                                    ...
                                    <p class="listing__details--location__text"><svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        Off Ngong Road-Enkang Apartments, 00100 Nairobi, Kenya</p>
                                </div>
                            </div>
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <p class="listing__details--content__desc">Featuring mountain views, Ngong Rd Gem:Breathtaking Views! provides accommodation with a balcony, around 10 km from Kenyatta International Conference Centre. This property offers access to a terrace, free private parking and free WiFi. Century Cinemax Junction is 2.7 km from the apartment and Shifteye Gallery is 6.7 km away.

                                        This apartment comes with 1 bedroom, a kitchen with an oven and a microwave, a flat-screen TV, a seating area and 1 bathroom equipped with a shower. Towels and bed linen are featured in the apartment. For added privacy, the accommodation features a private entrance.
                                        
                                        Nairobi National Museum is 12 km from the apartment, while Ngong Racecourse is 2.5 km away. The nearest airport is Wilson Airport, 13 km from Ngong Rd Gem:Breathtaking Views!.</p>
                                        ...
                                        <div class="apartment__info--wrapper d-flex">
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">400-600 Sqft</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">Kes 35,000 - 65,000/mo</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                    ...
                                    <div class="properties__amenities--wrapper d-flex">
                                        <ul class="properties__amenities--step">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Terrace</span>
                                            </li>
                                            <!--<li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <ul class="properties__amenities--step">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Free Wifi</span>
                                            </li>
                                        </ul>
                                        <ul class="properties__amenities--step">
                                            <li class="properties__amenities--list d-flex align-items-center">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Free Parking</span>
                                            </li>
                                            <!--<li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <div class="properties__floor--plans__content">
                                            ...
                                            <ul class="properties__floor--plans__info">
                                                <li>
                                                    ...
                                                    <span>Living Area: Positioned near the entrance, it features a sofa or seating area and might have a small dining table. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon2.png" alt="icon">-->
                                                    <span>Bedroom: A separate room with enough space for a bed and minimal furniture. It could be located at the far end of the apartment for privacy. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon3.png" alt="icon">-->
                                                    <span>Kitchen: Typically a galley or L-shaped kitchen, with the oven, microwave, and countertop spaces along one or two walls, possibly open to the living area. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon4.png" alt="icon">-->
                                                    <span>Bathroom: Located off a hallway or next to the bedroom, with a shower, sink, and toilet. </span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="floor1">
                                                    <div class="properties__floor--plans__display">
                                                        <img src="assets/img/other/0ba917ce-d717-4e50-9658-fccb988c9883.webp" alt="img">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63819.09394774519!2d36.58087552167968!3d-1.3606223999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f031ffc00ecfd%3A0xaeaf3c30be14b8bf!2sEngaji%20Apartments!5e0!3m2!1sen!2ske!4v1738752322852!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </details>
                                        </div>
                                    </div>
                                    <div class="location__google--maps__info d-flex">
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Off Ngong Road-Enkang Apartments, 00100 Nairobi, Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                            ...
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">County: </span>
                                                <span class="location__google--maps__info--subtitle">Kajiado</span>
                                            </li>
                                        </ul>
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Town:</span>
                                                <span class="location__google--maps__info--subtitle">Ngong</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Neighborhood:  </span>
                                                <span class="location__google--maps__info--subtitle">Ngong Road</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--video__thumbnail position-relative">
                                        <img src="assets/img/property/th (3).jpg" alt="img" class="video-thumbnail">
                                        <div class="bideo__play">
                                            <a class="bideo__play--icon glightbox" href="https://www.bing.com/videos/riverview/relatedvideo?q=Ngong+Road-Enkang+Apartments&&mid=AF4F11B2754795B28718AF4F11B2754795B28718&&mmscn=stvo&FORM=VRDGAR" data-gallery="video">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            ...
                                                            <span class="reviews__comment--author__date">5th january 2024</span>
                                                        </div>
                                                    ...
                                                    <p class="reviews__comment--desc">"The Ngong Rd Gem is a beautiful apartment with stunning mountain views, which really made the stay special. The location is quite convenient, being close to Century Cinemax and Ngong Racecourse. However, there were some downsides. The apartment was clean, but it felt a little outdated, especially the bathroom. The kitchen was functional but lacked some basic items like a coffee maker. Also, while the free WiFi and parking were nice touches, I did encounter some spotty connectivity at times. Overall, a decent stay, but there's room for improvement in terms of comfort and amenities."</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 2</h3>
                                                            <span class="reviews__comment--author__date">16th May 2023</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"I had a pleasant stay at the Ngong Rd Gem, and the views were absolutely breathtaking! The private entrance and balcony added to the feeling of exclusivity, and the apartment was generally well-equipped. The kitchen with an oven and microwave came in handy, and the flat-screen TV was a nice bonus. The location is also quite central, with easy access to major attractions. On the downside, the shower pressure wasn’t great, and there were some noises from neighboring units, which disrupted my sleep a bit. Otherwise, I’d recommend it for a quiet getaway."</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content last__content">
                                                    ...
                                                    <p class="reviews__comment--desc">"While the apartment offers some nice features like mountain views and free parking, my stay at Ngong Rd Gem was a bit disappointing. The location is a little further out from the city center, and the apartment itself, while having the basics, felt a bit cramped. The bed was uncomfortable, and I had issues with the WiFi dropping frequently. Although the property does offer privacy with its separate entrance, the overall ambiance wasn’t as cozy as I had hoped. It’s not a terrible place, but it didn’t meet my expectations based on the listing description. Wouldn’t stay here again unless improvements are made."</p>
                                                </div>
                                            </div>
                                       </div>
                                    </div>
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="assets/img/property/569278622.jpg" alt="img">
                                        <div class="featured__badge">
                                            <span class="badge__field">For Rent</span>
                                        </div>
                                    </div>
                                    <div class="widget__featured--properties__content">
                                        ...
                                        <p class="widget__featured--properties__desc"><svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            Lantana Road 103, 00100 Nairobi, Kenya</p>
                                        <h3 class="widget__featured--properties__title">Accomodation</h3>
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">Kes 7,000 - 12,000 per night</span>
                                            <span class="old__price">Kes 5,000</span>
                                        </div>    
                                    </div>
                                </div>
                            </div>                            
                                <div class="widget__step">
                                    ...
                                    <div class="widget__featured">
                                      <!-- Featured Item: Balcony View -->
                                      <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                          <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalBalconyview">
                                            <img class="widget__featured--media" src="assets/img/hero/520325397.jpg" alt="Balconyview">
                                          </a>
                                        </div>
                                        <div class="widget__featured--content">
                                          <h3 class="widget__featured--title">
                                            <a href="#">Balconyview</a>
                                          </h3>
                                        </div>
                                      </div>
                                      <!-- Modal for Balconyview -->
                                      <div class="modal fade" id="imageModalBalconyview" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelBalconyview" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <img class="img-fluid" src="assets/img/hero/520325397.jpg" alt="Balconyview">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                          <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalKitchen">
                                            <img class="widget__featured--media" src="assets/img/hero/520325316.jpg" alt="Kitchen Items">
                                          </a>
                                        </div>
                                        <div class="widget__featured--content">
                                          <h3 class="widget__featured--title">
                                      ...
                                      <div class="modal fade" id="imageModalKitchen" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelKitchen" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <img class="img-fluid" src="assets/img/hero/520325316.jpg" alt="Kitchen Items">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                  
                                      <!-- Featured Item: Livingroom -->
                                      <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                          <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalLivingroom">
                                            <img class="widget__featured--media" src="assets/img/hero/520325387.jpg" alt="Livingroom">
                                          </a>
                                        </div>
                                        <div class="widget__featured--content">
                                          <h3 class="widget__featured--title">
                                      ...
                                      <!-- Modal for Livingroom -->
                                      <div class="modal fade" id="imageModalLivingroom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelLivingroom" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <div class="modal-body">
                                              <img class="img-fluid" src="assets/img/hero/520325387.jpg" alt="Livingroom">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
