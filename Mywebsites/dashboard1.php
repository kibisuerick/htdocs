...
<div class="dashboard__page--wrapper">
        ...
        <div class="offcanvas__header">
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="dashboard1.php">
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="dashboard1.php">Menu</a>
                            <ul class="offcanvas__sub_menu">
        ...
        <div class="dashboard__sidebar">
            <div class="main__logo logo-desktop-none">
                <h1 class="main__logo--title"><a class="main__logo--link" href="dashboard1.php">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link active" href="dashboard1.php"><svg class="sidebar__menu--icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link" href="Create-listing.html"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="main__header d-flex justify-content-between align-items-center">
                    <div class="header__left d-flex align-items-center">
                        ...
                        <div class="search__box">
                            <form class="search__box--form laptop__hidden" action="authenticate1.php" method="post">
                                ...
                                <ul class="main__menu--wrapper d-flex">
                                    ...
                                    <li class="main__menu--items">
                                        ...
                                        <ul class="sub__menu">
                                            ...
                                            <li class="sub__menu--items"><a href="settings.html" class="sub__menu--link">Settings</a></li>
                                        </ul>
                                    </li>
                                    <li class="main__menu--items">
