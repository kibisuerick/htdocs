                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="listing__hero--slider__items position-relative">
                                    <img class="listing__hero--slider__media" src="assets/img/hero/544300372.jpg" alt="img">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="listing__hero--slider__content">
                                                <div class="listing__hero--slider__content--top d-flex align-items-center justify-content-between">
                                                    <h3 class="listing__hero--slider__title">Single Family Home</h3>
                                                    <span class="listing__hero--slider__price">Kes 18,000-24,000</span>
                                                </div>
                                                <p class="listing__hero--slider__text">
                                                    ...
                                                    Muthama Access Road Makumbi Indesign Park, 00100 Nairobi, Kenya
                                                </p>
                                            </div>
                                            <!-- Hero Content .\ -->
                                        </div>
                              ...
                              <div class=" listing__hero--slider__items position-relative">
                                ...
                                <div class="listing__hero--slider__container">
                                    ...
                                    <div class="listing__hero--slider__content">
                                        ...
                                        Muthama Access Road Makumbi Indesign Park, 00100 Nairobi, Kenya</p>
                                    </div>
                                    <!-- Hero Content .\ -->
                                    </div>
                                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/544300136 (1).jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/544300250.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/544300342.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/544300275.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                              <!-- Hero swiper items -->
                              <div class="listing__small--hero__slider--items">
                                  <img src="assets/img/hero/544300372 (1).jpg" alt="img">
                              </div>
                              <!-- Hero swiper items .\ -->
                          </div>
                        </div>
                        ...
                        <div class="listing__details--wrapper">
                            <div class="listing__details--content">
                                        ...
                                        <ul class="listing__details--meta__wrapper d-flex align-items-center">
                                            ...
                                            <li>
                                                <span class="listing__details--meta__icon">
                                                 ...
                                                 <span class="listing__details--meta__text">0 reviews</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="listing__details--content__step">
                                    <h2 class="listing__details--title mb-25">Makumbi Pearl</h2>
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">Kes 18,000-25,000/mo</span>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <p class="listing__details--content__desc">Located in Nairobi, Makumbi Pearl offers accommodation 21 km from National Museum of Nairobi, 3.9 km from Nairobi SGR Terminus and 15 km from Jihan Freighters Limited. The accommodation is 20 km from Kenyatta International Conference Centre and features a garden and free private parking.

                                        The apartment has a terrace, 1 bedroom, living room and a well-equipped kitchen. There is a flat-screen TV.
                                        
                                        Nyayo Stadium is 17 km from the accommodation, and Railway Museum is 18 km away. The airport (Nairobi Jomo Kenyatta Airport) is 9 km away.</p>
                                        ...
                                        <div class="apartment__info--wrapper d-flex">
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">600–700 sqft</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">Kes 18000-25000/mo</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">750 – 850 sqft.</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">4 - 5</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Bathroom:</span>
                                    ...
                                    <div class="properties__amenities--wrapper d-flex">
                                        ...
                                        <ul class="properties__amenities--step">
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Smoke-free rooms</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <div class="properties__floor--plans__content">
                                            ...
                                            <ul class="properties__floor--plans__info">
                                                <li>
                                                    ...
                                                    <span>🔹 Entryway: Leads directly into the living room. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon2.png" alt="icon">-->
                                                    <span>🔹 Kitchen: Could be an enclosed or open-plan kitchen </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon3.png" alt="icon">-->
                                                    <span>🔹 Bedroom: Standard size with a built-in wardrobe. </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon4.png" alt="icon">-->
                                                    <span>🔹 Bathroom: Likely accessible from a hallway or near the bedroom.</span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="floor1">
                                                    <div class="properties__floor--plans__display">
                                                        <img src="assets/img/other/3c0566d5-79bf-4d1b-a4a7-c9c080fdf6fc.webp" alt="img">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3988.6583119508723!2d36.921353774118764!3d-1.3816630986052751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sMakumbi%20Pearl%20Muthama%20Access%20Road%20Makumbi%20Indesign%20Park%2C%2000100%20Nairobi%2C%20Kenya!5e0!3m2!1sen!2ske!4v1738673974458!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </details>
                                        </div>
                                    </div>
                                    <div class="location__google--maps__info d-flex">
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Muthama Access Road Makumbi Indesign Park, 00100 Nairobi, Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                        ...
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Syokimau</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Neighborhood:  </span>
                                                <span class="location__google--maps__info--subtitle">Makumbi park apartments</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--video__thumbnail position-relative"> 
                                        <img src="assets/img/property/download.jpg" alt="Video Thumbnail" class="video-thumbnail">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            ...
                                                            <span class="reviews__comment--author__date">14th February 2023</span>
                                                        </div>
                                                    ...
                                                    <p class="reviews__comment--desc">"I had a wonderful experience staying at Makumbi Pearl. The apartment is spacious and well-furnished, and the terrace was my favorite spot to relax in the evening. The location is great, close to the SGR Terminus, making it convenient for travel. Would highly recommend it to anyone visiting Nairobi!"</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 2:</h3>
                                                            <span class="reviews__comment--author__date">17th December 2024</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"This apartment was a great find! It was clean, comfortable, and had all the necessary amenities. The private parking and garden were a nice bonus. The only downside was that it's a bit far from the city center, but if you’re looking for a quiet stay, this is perfect."</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content last__content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 3:</h3>
                                                            <span class="reviews__comment--author__date">18th june 2024</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"The apartment is decent for the price, and the terrace is a nice touch. However, I wish there were more entertainment options inside, as the area gets quiet at night. It’s ideal for short stays but could use some upgrades in furniture and kitchen appliances."</p>
                                                </div>
                                            </div>
                                       </div>
                                    </div>
                        ...
                        <div class="listing__widget">
                            ...
                            <div class="widget__step">
                                ...
                                <div class="widget__featured">                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalLivingRoom">
                                                <img class="widget__featured--media" src="assets/img/hero/544300136%20(1).jpg" alt="Living Room">
                                            </a>
                                        </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/544300136%20(1).jpg" alt="Living Room">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalBedroom">
                                                <img class="widget__featured--media" src="assets/img/hero/544300250.jpg" alt="Bedroom">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                    ...
                                    <div class="modal fade" id="imageModalBedroom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelBedroom" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/544300250.jpg" alt="Bedroom">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalBathroom">
                                                <img class="widget__featured--media" src="assets/img/hero/544300342.jpg" alt="Bathroom">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Bathroom</a></h3>
                                        </div>
                                    </div>
                                    <!-- Modal for Bathroom -->
                                    <div class="modal fade" id="imageModalBathroom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelBathroom" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/544300342.jpg" alt="Bathroom">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalKitchen">
                                                <img class="widget__featured--media" src="assets/img/hero/544300317 (1).jpg" alt="Kitchen">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Kitchen</a></h3>
                                        </div>
                                    </div>
                                    <!-- Modal for Kitchen -->
                                    <div class="modal fade" id="imageModalKitchen" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelKitchen" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/544300317 (1).jpg" alt="Kitchen">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
