                    ...
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="settings.php" class="offcanvas__sub_menu_item">Settings</a></li>-->
                            </ul>
                        </li>
                ...
                <div class="side__menu--footer mobile__menu--footer">
                    <div class="side__menu--info">
                        <div class="side__menu--info__list">
                            ...
                            <p><a class="side__menu--info__text" href="tel:+254759506718">: +254759506718</a></p>
                        </div>
                        <div class="side__menu--info__list">
                    ...
                    <div class="side__menu--share d-flex align-items-center">
                        ...
                        <ul class=" side__menu--share__wrapper d-flex align-items-center">
                            ...
                            <li class="side__menu--share__list">
                                <a class="side__menu--share__icon" target="_blank" href=" https://www.instagram.com/its_kay_jnr/dewmont_real_estate?igsh=MWVsNGNjajdieXlhYg==">
            ...
            <main class="main__content_wrapper">
                            ...
                            <table class="properties__table--wrapper">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="reviews__date">13 Jan, 2025 </span>
                                        </td>
                                        <td>
                                            <span class="status__btn pending">Pending</span>
                                        </td>
                                        <td>
                                            <span class="properties__views">110</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="reviews__date">09 Jan, 2025 </span>
                                        </td>
                                        <td>
                                            <span class="status__btn processing">Processing</span>
                                        </td>
                                        <td>
                                            <span class="properties__views">121</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="reviews__date">17 Oct, 2024 </span>
                                        </td>
                                        <td>
                                            <span class="status__btn active">Active</span>
                                        </td>
                                        <td>
                                            <span class="properties__views">210</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="properties__views">10</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="properties__views">100</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="properties__views">50</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="reviews__date">30 Dec, 2024 </span>
                                        </td>
                                        <td>
                                            <span class="status__btn pending">Pending</span>
                                        </td>
                                        <td>
                                            <span class="properties__views">127</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <footer class="footer footer__section">
                    <div class="dashboard__footer--inner text-center">
                        <p class="copyright__content mb-0">Copyright © 2025Powered By <span>Kibisu erick</span>. Designed with  by <a class="copyright__content--link" target="_blank" href="https://themeforest.net/search/Kibisuerick">Kibisu erick</a>  All Rights Reserved.</p>
                    </div>
                </footer>
                <!-- End footer section -->
            </main>
