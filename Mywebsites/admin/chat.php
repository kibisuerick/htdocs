...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/admin/chat.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:39 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="dashboard.php">
                        <img class="light__logo" src="assets/img/logo/nav-log3.png" height="36">
                        <img class="dark__logo" src="assets/img/logo/nav-log.png" alt="Logo-img" width="158" height="36">
                    </a>
         ...
         <div class="dashboard__sidebar">
            <div class="main__logo logo-desktop-none">
                <h1 class="main__logo--title"><a class="main__logo--link" href="dashboard.php">
                    <img class="main__logo--img desktop light__logo" src="assets/img/logo/nav-log3.png">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    ...
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link active" href="chat.php"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <main class="main__content_wrapper">
                ...
                <footer class="footer footer__section">
                    <div class="dashboard__footer--inner text-center">
                        <p class="copyright__content mb-0">Copyright © 2025 Powered By <span>Kibisu</span>. Designed by <span>Kibisuerick</span>  All Rights Reserved.</p>
                    </div>
                </footer>
                <!-- End footer section -->
            </main>
...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/admin/chat.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:46 GMT -->
</html>