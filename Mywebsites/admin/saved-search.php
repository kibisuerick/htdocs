                ...
                <div class="side__menu--footer mobile__menu--footer">
                    <div class="side__menu--info">
                        <div class="side__menu--info__list">
                            ...
                            <p><a class="side__menu--info__text" href="tel:+254 759506718">: (+254) 759-506-718</a></p>
                        </div>
                        <div class="side__menu--info__list">
        ...
        <div class="dashboard__sidebar">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    ...
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link active" href="saved-search.php"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <main class="main__content_wrapper">
                ...
                <div class="dashboard__container dashboard__reviews--container">
                    <div class="reviews__heading mb-30">
                        <h2 class="reviews__heading--title">Saved Search</h2>
                        ...
                        <div class="reviews__table table-responsive">
                            <table class="reviews__table--wrapper">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <span class="saved__search--name">Property List Ongata rongai</span>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Sat Sept 2022</span>
                                        </td>
                                        <td>
                                    ...
                                    <!--<tr>
                                        <td>
                                            <span class="saved__search--name">London 3 beds</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="saved__search--name">Marie Prohaska</span>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Thu Jun 2021</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="saved__search--name">Paris $100-$100</span>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Thu Jun 2021</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="saved__search--name">Small Houses</span>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Mon Dec 2024</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        <td>
                                            <span class="saved__search--name">Apartments Near Market</span>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Fri April 2021</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <!--<tr>
                                        <td>
                                            <span class="saved__search--name">Villa in California with pool</span>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Thu Jun 2021</span>
                                        </td>
                                    ...
                                    <tr>-->
                                        <td>
                                            <span class="saved__search--name">Home for Rent</span>
                                        </td>
                                        <td>
                ...
                <footer class="footer footer__section">
                    <div class="dashboard__footer--inner text-center">
                        <p class="copyright__content mb-0">Copyright © 2025 Powered By <span>Kibisu</span>. Designed with/by <span>Kibisuerick</span>  All Rights Reserved.</p>
                    </div>
                </footer>
                <!-- End footer section -->
            </main>
