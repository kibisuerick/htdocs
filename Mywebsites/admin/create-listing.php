...
<head>
    <meta charset="utf-8">
    <title>Centralised property reservation platform for listings</title>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="dashboard.php">
                        <img class="light__logo" src="assets/img/logo/nav-log2-white.png" alt="Logo-img" width="158" height="36">
                        <img class="dark__logo" src="assets/img/logo/nav-log2-white.png" alt="Logo-img" width="158" height="36">
                    </a>
        ...
        <div class="dashboard__sidebar">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    ...
                    <!--<li class="sidebar__menu--items"><a class="sidebar__menu--link" href="my-package.html"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="main__menu d-none d-xl-block">
                            <nav class="main__menu--navigation">
                                <ul class="main__menu--wrapper d-flex">
                                    ...
                                    <li class="main__menu--items">
                                        <a class="main__menu--link" href="../listing-list.html"> Listing
                                            <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 12 7.41">
                                                <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                                            </svg>
                                        </a>
                                ...
                                <div class="dropdown__user--profile">
                                    <ul class="user__profile--menu">
                                        ...
                                        <li class="user__profile--menu__items"><a class="user__profile--menu__link position-relative" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="gem" class="lucide lucide-gem inline-block size-4 ltr:mr-2 rtl:ml-2">
                                                    ...
                                                    <path d="M2 9h20"></path>
                                                </svg> Upgrade <span class="profile__upgrade--badge">Pro</span> </a></li>

                                        <li class="user__profile--menu__items"><a class="user__profile--menu__link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text">
                            ...
                            <div class="card shadow-lg p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="amenities-section">
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="airConditioning">
                                                <label class="form-check-label" for="airConditioning">Air Conditioning</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="swimmingPool">
                                                <label class="form-check-label" for="swimmingPool">Swimming Pool</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="outdoorShower">
                                                <label class="form-check-label" for="outdoorShower">Outdoor Shower</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="lawn">
                                    ...
                                    <div class="col-md-6">
                                        <div class="amenities-section">
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="barbeque">
                                                <label class="form-check-label" for="barbeque">Barbeque</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="washer">
                                                <label class="form-check-label" for="washer">Washer</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="microwave">
                                                <label class="form-check-label" for="microwave">Microwave</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" name="amenities[]" type="checkbox" id="dryer">
