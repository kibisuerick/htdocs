...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/admin/my-favorites.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:46 GMT -->
<head>
  <meta charset="utf-8">
  <title>Centralized property reservation platform</title>
         ...
         <div class="dashboard__sidebar">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    ...
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link active" href="my-favorites.php"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <nav class="main__menu--navigation">
                                <ul class="main__menu--wrapper d-flex">
                                    <li class="main__menu--items">
                                        <a class="main__menu--link" href="../Home.php.php"><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="main__menu--items">
                                        <a class="main__menu--link" href="../listing-list.php.php"> Listing 
                                            <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </a>  
            ...
            <main class="main__content_wrapper">
                ...
                <div class="dashboard__container dashboard__reviews--container">
                    <div class="reviews__heading mb-30">
                        <h2 class="reviews__heading--title">My Favorites</h2>
                                        ...
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    <h3 class="reviews__author--title">Luxury suit</h3>
                                                    <p class="reviews__author--subtitle">Rimpa Ongata Rongai, Kajiado county</p>
                                                    <span class="properties__author--price">Kes 43,000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    <h3 class="reviews__author--title">White villa</h3>
                                                    <p class="reviews__author--subtitle">karen waterfront area , Langata, Nairobi county</p>
                                                    <span class="properties__author--price">Kes 40,000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    <h3 class="reviews__author--title">Luxury villa in Westlands</h3>
                                                    <p class="reviews__author--subtitle">Westlands area, Nairobi</p>
                                                    <span class="properties__author--price">Kes 100,000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    ...
                                                    <p class="reviews__author--subtitle">Ngong road, Kajiado</p>
                                                    <span class="properties__author--price">Kes 63000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    ...
                                                    <p class="reviews__author--subtitle">Kileleshwa, Nairobi</p>
                                                    <span class="properties__author--price">110000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    ...
                                                    <p class="reviews__author--subtitle">Maasai lodge, Ongata rongai, Kajiado county</p>
                                                    <span class="properties__author--price">Kes 20,000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="properties__author d-flex align-items-center">
                                                ...
                                                <div class="reviews__author--text">
                                                    ...
                                                    <p class="reviews__author--subtitle">Kiserian, Kajiado county</p>
                                                    <span class="properties__author--price">Kes 75,000/mo</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
