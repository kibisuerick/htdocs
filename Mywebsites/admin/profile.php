...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/admin/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:46 GMT -->
<head>
  <meta charset="utf-8">
                ...
                <div class="side__menu--footer mobile__menu--footer">
                    <div class="side__menu--info">
                        ...
                        <div class="side__menu--info__list">
                            ...
                            <p><a class="side__menu--info__text" href="mailto:kibisuerick20agmail.com">kibisuerick20agmail.com</a></p>
                        </div>
                    </div>
        ...
        <div class="dashboard__sidebar">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    ...
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link active" href="profile.php"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <main class="main__content_wrapper">
                ...
                <div class="dashboard__container dashboard__profile--container">
                    ...
                    <div class="dashboard__profile--wrapper">
                        ...
                        <div class="profile__main--content d-flex justify-content-between align-items-center">
                            <div class="profile__author d-flex align-items-center">
                                <div class="profile__author--thumbnail position-relative">
                                    ...
                                    <a class="profile__author--instagram__icon" href="https://www.instagram.com/its_kay_jnr/" target="_blank"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="profile__author--content">
                                    <h3 class="profile__author--title">Kibisu Erick</h3>
                            ...
                            <div class="profile__info d-flex">
                                <ul class="profile__info--wrapper">
                                    <li class="profile__info--list">
                                        ...
                                        <a class="profile__info__text" href="mailto:kibisuerick20@gmail.com">kibisuerick20@gmail.com</a>
                                    </li>
                                    <li class="profile__info--list">
                                        <h3 class="profile__info--title">PHONE</h3>
                                        <a class="profile__info__text" href="tel:0759506718">: 0759506718</a>
                                    </li>
                                </ul>
                                <ul class="profile__info--wrapper">
                                    <li class="profile__info--list">
                                        <h3 class="profile__info--title">BIRTHDAY</h3>
                                        <span class="profile__info__text">14th August</span>
                                    </li>
                                    <li class="profile__info--list">
                                        <h3 class="profile__info--title">LOCATION</h3>
                                        <span class="profile__info__text">Ongata rongai, Kajiado county</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="profile__about--content text-center">
                            ...
                            <p class="profile__about--content__desc">As a UI/UX Designer my core responsibilities are to help Create products with a good user experience. I'm responsible for understanding what users want from their device and then designing it so they can find all of its features easily without any hassle. I also make sure everything works properly when combined in one package</p>
                            <div class="social__share">
                                <h3 class="social__share--title">Follow me on</h3>
                                <ul class="social__share--wrapper d-flex justify-content-center">
                                    <li class="social__share--list">
                                        <a class="social__share--icon" href="https://www.facebook.com/erick.kibisu.12erick.kibisu.12/"><svg width="7" height="14" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="social__share--list">
                                        <a class="social__share--icon" href="https://x.com/ONYANGOERI47602/">
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill="currentColor" d="M17.732 3H21L14.823 10.318L22 21H15.91L11.21 14.83L5.74 21H2.464L9.07 13.16L2 3H8.18L12.43 8.636L17.732 3ZM16.618 19H18.636L7.3 4.688H5.14L16.618 19Z"/>
                                            </svg>  
                                            <span class="visually-hidden">Twitter X</span>                                          
                                        </a>
                                    </li>                                    
                                    <li class="social__share--list">
                                        <a class="social__share--icon" href="https://www.instagram.com/its_kay_jnr/its_kay_jnr/">
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12 2.2c3.2 0 3.6 0 4.9.1 1.3.1 2.2.3 3 .6.8.3 1.5.7 2.2 1.3.6.6 1 1.4 1.3 2.2.3.8.5 1.7.6 3 .1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.3-.3 2.2-.6 3-.3.8-.7 1.5-1.3 2.2-.6.6-1.4 1-2.2 1.3-.8.3-1.7.5-3 .6-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.3-.1-2.2-.3-3-.6-.8-.3-1.5-.7-2.2-1.3-.6-.6-1-1.4-1.3-2.2-.3-.8-.5-1.7-.6-3C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.3.3-2.2.6-3 .3-.8.7-1.5 1.3-2.2.6-.6 1.4-1 2.2-1.3.8-.3 1.7-.5 3-.6C8.4 2.2 8.8 2.2 12 2.2m0-2.2C8.7 0 8.2 0 7 0 5.7 0 4.6.2 3.7.5 2.7.8 1.8 1.3 1 2 .3 2.7-.2 3.6-.5 4.6c-.3 1-.5 2-.6 3.3-.1 1.3-.1 1.7-.1 4.9s0 3.6.1 4.9c.1 1.3.3 2.2.6 3.3.3 1 .8 1.9 1.5 2.6.7.7 1.6 1.2 2.6 1.5 1 .3 2 .5 3.3.6 1.3.1 1.7.1 4.9.1s3.6 0 4.9-.1c1.3-.1 2.2-.3 3.3-.6 1-.3 1.9-.8 2.6-1.5.7-.7 1.2-1.6 1.5-2.6.3-1 .5-2 .6-3.3.1-1.3.1-1.7.1-4.9s0-3.6-.1-4.9c-.1-1.3-.3-2.2-.6-3.3-.3-1-.8-1.9-1.5-2.6-.7-.7-1.6-1.2-2.6-1.5C19.8.2 18.7 0 17.4 0 16.2 0 15.8 0 12 0z" fill="currentColor"/>
                                                <path d="M12 5.8c-3.4 0-6.2 2.8-6.2 6.2s2.8 6.2 6.2 6.2 6.2-2.8 6.2-6.2-2.8-6.2-6.2-6.2zm0 10.2c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4-1.8 4-4 4zM18.5 5.3c0 .8-.7 1.5-1.5 1.5s-1.5-.7-1.5-1.5.7-1.5 1.5-1.5 1.5.7 1.5 1.5z" fill="currentColor"/>
                                            </svg>
                                            <span class="visually-hidden">Instagram</span>                                             
                                        </a>
                                    </li>                                    
                                    <li class="social__share--list">
                                        <a class="social__share--icon" href="https://www.pinterest.com/erickkibisu/erickkibisu/">
                ...
                <footer class="footer footer__section">
                    <div class="dashboard__footer--inner text-center">
                        <p class="copyright__content mb-0">Copyright © 2025Powered By <span>Kibisu</span>. Designed by <a class="copyright__content--link" target="_blank" href="">kibisu</a>  All Rights Reserved.</p>
                    </div>
                </footer>
                <!-- End footer section -->
            </main>
