        ...
        <div class="dashboard__sidebar">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link" href="dashboard.php"><svg class="sidebar__menu--icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <main class="main__content_wrapper">
                            ...
                            <table class="reviews__table--wrapper">
                                ...
                                <tbody>
                                            ...
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Kevin Mwangi</h3>
                                                        <p class="reviews__author--subtitle">Property: Furnished 2-Bedroom Apartment, Bellevue, Mombasa Road</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"The platform is convenient, but landlords should respond faster."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                ...
                                                <span class="reviews__ratting--text">(4.2+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Thu Jun 2023</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Ahmed Hassan</h3>
                                                        <p class="reviews__author--subtitle">Property: Beachfront Villa, Ongata Rongai</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"Loved my stay! Booking was easy, and the host was very welcoming."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="reviews__ratting--text">(4.8+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Wed Aug 2024</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Brian Otieno</h3>
                                                        <p class="reviews__author--subtitle">Property: Furnished Studio Apartment, Kiserian</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"Smooth booking experience, but the photos looked better than the actual place."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <span class="reviews__date">Mon Sep 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Elvis otuoma</h3>
                                                        <p class="reviews__author--subtitle">Property: Luxury Penthouse, Westlands</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"The best booking platform! Simple, reliable, and great customer service."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="reviews__ratting--text">(4.9+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Sat Oct 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Elizabeth Kiprop</h3>
                                                        <p class="reviews__author--subtitle">Property: Cozy Cottage, Westlands</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"Great selection of properties, but I had issues with payment confirmation."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="reviews__ratting--text">(4.0+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Sun Jan 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Faisal Abdi</h3>
                                                        <p class="reviews__author--subtitle">Property: Family-Friendly House, Lang’ata</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"I booked a holiday home for my family, and everything was perfect!"</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="reviews__ratting--text">(4.7+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Fri Dec 2024</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Dennis Ouma</h3>
                                                        <p class="reviews__author--subtitle">Property: Budget-Friendly Apartment, Ngong Road</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"The filters helped me find a perfect place within my budget."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="reviews__ratting--text">(4.3+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Tue Jul 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Mercy Wambui</h3>
                                                        <p class="reviews__author--subtitle">Property: Serene Getaway Home, Ngong</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"I liked how detailed the listings were. I found exactly what I needed."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <span class="reviews__date">Thu May 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Herman Musyoki</h3>
                                                        <p class="reviews__author--subtitle">Property: Studio Apartment, Near Kenyatta Market</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"The process was smooth, but I wish cancellation policies were clearer."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <span class="reviews__date">Sun Mar 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Paul Ndungu</h3>
                                                        <p class="reviews__author--subtitle">Property: Business Executive Suite, Upper Hill</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"Very useful for business travelers. I was able to book instantly!"</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="reviews__ratting--text">(4.4+)</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__date">Wed Apr 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Steve Muthama</h3>
                                                        <p class="reviews__author--subtitle">Property: Modern 1-Bedroom Apartment, South B</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="reviews__table--body__text">"Great experience! The instant confirmation feature is a game changer."</span>
                                        </td>
                                        <td>
                                            <div class="reviews__ratting">
                                                <span class="reviews__ratting--icon"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <td>
                                            <span class="reviews__date">Sat Nov 2023</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="reviews__author--wrapper">
                                                ...
                                                <div class="reviews__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title">Musa Apoko</h3>
                                                        <p class="reviews__author--subtitle">Property: Urban Loft, Nairobi CBD</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="reviews__date">Sun Nov 2024</span>
                                        </td>
                                        <td>
                                            <div class="reviews__action--wrapper position-relative">
                                                <button class="reviews__action--btn" aria-label="action button" type="button" aria-expanded="true" data-bs-toggle="dropdown"><svg width="3" height="17" viewBox="0 0 3 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <footer class="footer footer__section">
                    <div class="dashboard__footer--inner text-center">
                        <p class="copyright__content mb-0">Copyright © 2025Powered By <span>NewVilla</span>. Designed with  by <a class="copyright__content--link" target="_blank" href="https://themeforest.net/search/Kibisuerick">Kibisuerick</a>  All Rights Reserved.</p>
                    </div>
                </footer>
                <!-- End footer section -->
            </main>
