...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/admin/my-package.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:46 GMT -->
<head>
  <meta charset="utf-8">
         ...
         <div class="dashboard__sidebar">
            ...
            <div class="dashboard__sidebar--inner">
                <ul class="sidebar__menu" id="accordionExample">
                    ...
                    <li class="sidebar__menu--items"><a class="sidebar__menu--link active" href="my-package.php"><svg class="sidebar__menu--icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
