...
<body>
        ...
        <section class="breadcrumb__section section--padding">
            <div class="container">
                <div class="breadcrumb__content text-center">
                    <h1 class="breadcrumb__title h2"><span>Market</span> Analysis</h1>
                    ...
                    <div class="col-lg-8">
                        <div class="services__details--wrapper">
                            <div class="services__details--thumbnail mb-30">
                                <img src="assets/img/other/financial-analysts-near-multi-monitor-workstation-using-tablet-device-analyze-capital-profit-risks-hedge-fund-co.jpg" alt="img">
                            </div>
                            <div class="services__details--content">
                                <div class="services__details--content__step mb-30">
                                    <h2 class="services__details--title">Market Analysis</h2>
                                    <p class="services__details--desc">At <b>Kibisu Real Estates</b>, we provide in-depth market analysis to help our clients make informed property investment decisions. Our market insights are based on real-time data, trends, and expert evaluations, ensuring accuracy and reliability.</p>
                                    <h2 class="services__details--title">Key Aspects of Our Market Analysis</h2>
                                    <p class="services__details--desc"><b>✅ Current Property Trends</b><br>
                                        We track real estate trends, including price movements, demand shifts, and emerging hotspots, giving you a competitive edge in property selection.
                                    </p>
                                    <p class="services__details--desc"><b>✅ Comparative Market Analysis (CMA)</b><br>
                                        By analyzing similar properties within a specific area, we determine fair market value to help you make cost-effective purchase, sale, or rental decisions.
                                    </p>
                                    <p class="services__details--desc"><b>✅ Supply and Demand Dynamics</b><br>
                                        Understanding the balance between available properties and buyer/renter interest ensures strategic pricing and investment choices.
                                    </p>
                                    <p class="services__details--desc"><b>✅ Economic and Demographic Insights</b><br>
                                        We consider economic indicators, employment rates, population growth, and infrastructure development to predict property value appreciation over time.
                                    </p>
                                    <p class="services__details--desc"><b>✅ Rental Yield & ROI Projections</b><br>
                                        For investors, we calculate potential rental income, occupancy rates, and long-term return on investment (ROI) based on local and national trends.
                                    </p>
                                    <p class="services__details--desc"><b>✅ Location & Neighborhood Analysis</b><br>
                                        Our reports include insights on accessibility, security, amenities, and future developments that influence property desirability.
                                    </p>
                                    ...
                                    <p class="services__details--desc">By leveraging our comprehensive market analysis, you gain a deeper understanding of the real estate landscape, enabling confident and profitable decisions in property reservation and investment.</p>
                                </div>
                                <div class="services__details--info mb-40 d-flex">
                                    <!-- Video Thumbnail Section -->
                                    <div class="services__details--info mb-40 d-flex">
                                        <div class="services__details--info__thumbnail position-relative">
                                            <img src="assets/img/other/man-woman-doing-teamwork-develop-hedge-fund-trade-with-market-exchange-real-time-sales-multiple-monitors-financi.jpg" alt="img">
                                    ...
                                    <div class="services__details--info__content">
                                        <h3 class="services__details--info__title">Why Market Analysis is Important ?</h3>
                                        <p class="services__details--info__desc">Market analysis is a crucial step in making informed real estate decisions. Whether you are buying, selling, or investing in property, understanding market trends and data helps minimize risks and maximize returns. Here’s why market analysis matters:</p>
                                        <ul class="services__details--info__ui-content">
                                            ...
                                            </span> Informed Decision-Making</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span> Accurate Property Valuation</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span>Understanding Market Trends</li>
                                            <li><span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9538 2.40018C11.0418 3.23218 10.1538 4.20018 9.28981 5.30418C8.53781 6.25618 7.86181 7.23218 7.26181 8.23218C6.71781 9.12818 6.32181 9.89618 6.07381 10.5362C6.06581 10.5602 6.04981 10.5802 6.02581 10.5962C6.00181 10.6202 5.97381 10.6322 5.94181 10.6322C5.93381 10.6402 5.92581 10.6442 5.91781 10.6442C5.86181 10.6442 5.82181 10.6282 5.79781 10.5962L1.51381 6.24018C1.50581 6.23218 1.60981 6.12818 1.82581 5.92818C2.04181 5.72018 2.25381 5.53218 2.46181 5.36418C2.69381 5.17218 2.81781 5.08418 2.83381 5.10018L5.18581 6.94818C5.87381 6.14018 6.64581 5.34018 7.50181 4.54818C8.78981 3.36418 10.1178 2.35618 11.4858 1.52418C11.5098 1.52418 11.6018 1.63618 11.7618 1.86018L12.0018 2.20818C12.0098 2.24018 12.0098 2.27618 12.0018 2.31618C11.9938 2.34818 11.9778 2.37618 11.9538 2.40018Z" fill="currentColor"/>
                                                </svg>
                                            </span>Maximizing Rental Income</li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="services__widget--step">
                                ...
                                <div class="widget__img--gallery">
                                    <div class="widget__img--gallery__thumbnail mb-20">
                                        <img src="assets/img/other/hedge-fund-company-agents-workspace-reviewing-stock-market-prices-highs-lows-brokerage-company-employees-sitting.jpg" alt="img">
                                    </div>
                                    <div class="widget__img--gallery__content">
                                        <h3 class="widget__img--gallery__title">Meet Our Market Analysis Team</h3>
                                        <p class="widget__img--gallery__desc">At Kibisu Real Estates, our Market Analysis Team consists of seasoned real estate experts, data analysts, and financial advisors dedicated to providing accurate, data-driven insights. Their expertise ensures that our clients make well-informed property decisions backed by thorough research and market intelligence.
                                        </p>
                                    </div>
                                </div>
                            </div>
  ...
  <!-- Customscript js -->
  <script src="assets/js/script - Copy (4).js"></script>
