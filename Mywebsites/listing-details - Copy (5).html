                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/605312212 (1).jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    ...
                                    <div class="listing__hero--slider__content">
                                        <div class="listing__hero--slider__content--top d-flex align-items-center justify-content-between">
                                            <h3 class="listing__hero--slider__title">maskan studio apartments</h3>
                                            <span class="listing__hero--slider__price">Kes 12,000 - 18000/mo</span>
                                        </div>
                                        ...
                                        Riverside Road, 00511 Ongata Rongai , Kenya</p>
                                    </div>
                                    <!-- Hero Content .\ -->
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/597853635 (1).jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/605954196.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/597853623.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                                        <div class="listing__hero--slider__content--top d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="listing__hero--slider__price">maskan studio apartments</span>
                                        </div>
                                        <p class="listing__hero--slider__text"><svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.48287 0C2.45013 0 0 2.4501 0 5.48288C0 5.85982 0.0343013 6.21958 0.102785 6.57945C0.514031 9.69783 4.42055 11.9767 5.51712 16.4144C6.5966 12.0452 11 8.824 11 5.48288H10.9657C10.9657 2.45013 8.51548 0 5.48282 0H5.48287ZM5.48287 2.17592C7.21338 2.17592 8.61839 3.58097 8.61839 5.31144C8.61839 7.04191 7.21335 8.44696 5.48287 8.44696C3.7524 8.44696 2.34736 7.04191 2.34736 5.31144C2.34736 3.58097 3.75228 2.17592 5.48287 2.17592Z" fill="#FA4B4A"/>
                                        </svg>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/605953559.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/597853586.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/597853554.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/597853617.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <!--<div class="swiper-slide">
                        ...
                        <div class="listing__details--wrapper">
                            <div class="listing__details--content">
                                        ...
                                        <ul class="listing__details--meta__wrapper d-flex align-items-center">
                                            ...
                                            <li>
                                                <span class="listing__details--meta__icon">
                                                 ...
                                                 <span class="listing__details--meta__text">1 view</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="listing__details--content__step">
                                    <h2 class="listing__details--title mb-25">maskan studio apartments</h2>
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">Kes 12,000 - 18,000 per night</span>
                                            <span class="listing__details--price__old">None</span>
                                        </div>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <p class="listing__details--content__desc">Maskan studio apartments is situated in Ongata Rongai, 21 km from Nairobi National Museum, 3.6 km from Nairobi Giraffe Centre, and 5.7 km from Matbronze Wildlife Art. This apartment offers free private parking, full-day security and free WiFi. The property is non-smoking and is set 20 km from Kenyatta International Conference Centre.

                                        This apartment has 1 bedroom, a kitchen with a microwave and a stovetop, a flat-screen TV, a seating area and 1 bathroom fitted with a shower. The apartment offers bed linen, towels and housekeeping service.
                                        
                                        Oloolua Nature Trail is 8 km from the apartment, while Nairobi Mamba Village is 8.9 km from the property. Wilson Airport is 14 km away.</p>
                                        ...
                                        <div class="apartment__info--wrapper d-flex">
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">300-600 Sqft</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">Kes 12,000 - 18,000</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">400 - 500 SqFt</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">3-4</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                ...
                                <div class="listing__details--content__step properties__amenities mb-80">
                                    <h3 class="listing__details--content__title mb-40">Parking</h3>
                                    <div class="properties__amenities--wrapper d-flex">
                                        <ul class="properties__amenities--step">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Room service</span>
                                            </li>
                                        </ul>
                                        <ul class="properties__amenities--step">
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Shower</span>
                                            </li>
                                            <!--<li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <div class="properties__floor--plans__content">
                                            ...
                                            <ul class="properties__floor--plans__info">
                                                <li>
                                                    ...
                                                    <span><b>Layout Summary:</b> </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon2.png" alt="icon">-->
                                                    <span>Main Area (Open Concept): Bedroom + Kitchen + Seating area</span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon3.png" alt="icon">-->
                                                    <span>Bathroom: Separate enclosed space</span>
                                                </li>
                                                <!--<li>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="floor1">
                                                    <div class="properties__floor--plans__display">
                                                        <img src="assets/img/other/992b2949-9472-4d32-962f-0eb51e8878c4.webp" alt="img">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63818.141968955046!2d36.67531229132311!3d-1.396142291607618!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f05cf50f94e8d%3A0x51c29656e6fd8ca9!2sOngata%20Rongai!5e0!3m2!1sen!2ske!4v1738760880953!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </details>
                                        </div>
                                    </div>
                                    <div class="location__google--maps__info d-flex">
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Riverside Road, 00511 Ongata Rongai , Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                        ...
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Ongata-rongai</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Neighborhood:  </span>
                                                <span class="location__google--maps__info--subtitle">Riverside Road</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--video__thumbnail position-relative">
                                        <img src="assets/img/property/th (4).jpg" alt="img" class="video-thumbnail">
                                        <div class="bideo__play">
                                            <a class="bideo__play--icon glightbox" href="https://www.bing.com/videos/riverview/relatedvideo?&q=maskan+studio+apartments+Riverside+Road%2c+00511+Ongata+Rongai+%2c+Kenya&&mid=32CCA15B51F2E20EBF5132CCA15B51F2E20EBF51&&FORM=VRDGAR" data-gallery="video">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            ...
                                                            <span class="reviews__comment--author__date">26th january 2024</span>
                                                        </div>
                                                    ...
                                                    <p class="reviews__comment--desc">“The host is so welcoming and the BnB was so clean and beautiful I loved the experience and I am sure to come back"</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content">
                                                    ...
                                                    <p class="reviews__comment--desc">"I loved the modern design of the apartment, and the flat-screen TV was a nice touch. The location is convenient for visiting the Giraffe Centre and Oloolua Nature Trail. However, I noticed some maintenance issues—one of the kitchen appliances wasn’t working properly, and the bathroom door was a bit faulty. If management improves these small details, it would be a fantastic place to stay!"</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content last__content">
                                                    ...
                                                    <p class="reviews__comment--desc">"The apartment itself was cozy and had all the necessary amenities, including a microwave and a stovetop, which made cooking easy. Housekeeping was efficient, and the bed was comfortable. However, the noise from nearby traffic and neighbors made it hard to sleep at times. Also, the parking space is limited, so it’s not ideal if you’re coming with a big car. It’s an okay place if you don’t mind a bit of noise."</p>
                                                </div>
                                            </div>
                                       </div>
                                    </div>
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="assets/img/property/482862057.jpg" alt="img">
                                        <div class="featured__badge">
                                            <span class="badge__field">Rental</span>
                                        </div>
                                    </div>
                                    <div class="widget__featured--properties__content">
                                        ...
                                        <h3 class="widget__featured--properties__title">Executive 1 BedRoom AirBnB</h3>
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">Kes 12,000-16,000</span>
                                            <span class="old__price">Kes 10,000</span>
                                        </div>    
                                    </div>
                                </div>
                            </div>
                                  ...
                                  <div class="widget__featured--items d-flex">
                                    <div class="widget__featured--thumb">
                                      <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalBedroom">
                                        <img class="widget__featured--media" src="assets/img/hero/605953559.jpg" alt="Bedroom">
                                      </a>
                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <img class="img-fluid" src="assets/img/hero/605953559.jpg" alt="Bedroom">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="widget__featured--items d-flex">
                                    <div class="widget__featured--thumb">
                                      <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalKitchen">
                                        <img class="widget__featured--media" src="assets/img/hero/597853554.jpg" alt="Kitchen Items">
                                      </a>
                                    </div>
                                    <div class="widget__featured--content">
                                      <h3 class="widget__featured--title">
                                  ...
                                  <div class="modal fade" id="imageModalKitchen" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelKitchen" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <img class="img-fluid" src="assets/img/hero/597853554.jpg" alt="Kitchen Items">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                              
                                  <!-- Featured Item: Window covering -->
                                  <div class="widget__featured--items d-flex">
                                    <div class="widget__featured--thumb">
                                      <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalWindowcovering">
                                        <img class="widget__featured--media" src="assets/img/hero/597853586.jpg" alt="Washroom">
                                      </a>
                                    </div>
                                    <div class="widget__featured--content">
                                      <h3 class="widget__featured--title">
                                        <a href="#">Windowcovering</a>
                                      </h3>
                                    </div>
                                  </div>
                                  <!-- Modal for Washroom -->
                                  <div class="modal fade" id="imageModalWindowcovering" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelWindowcovering" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                          <img class="img-fluid" src="assets/img/hero/597853586.jpg" alt="Windowcovering">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
