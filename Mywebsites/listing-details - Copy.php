                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/638029227.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    ...
                                    <div class="listing__hero--slider__content">
                                        <div class="listing__hero--slider__content--top d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="listing__hero--slider__price">Kes 18,000-24000</span>
                                        </div>
                                       ...
                                       Wood Avenue Apartment B11, Nairobi, Kenya</p>
                                    </div>
                                    <!-- Hero Content .\ -->
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/638024269.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                                        <div class="listing__hero--slider__content--top d-flex align-items-center justify-content-between">
                                            <h3 class="listing__hero--slider__title">Executive 1 BedRoom AirBnB </h3>
                                            <span class="listing__hero--slider__price">Kes 3000 per night</span>
                                        </div>
                                        <p class="listing__hero--slider__text"><svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.48287 0C2.45013 0 0 2.4501 0 5.48288C0 5.85982 0.0343013 6.21958 0.102785 6.57945C0.514031 9.69783 4.42055 11.9767 5.51712 16.4144C6.5966 12.0452 11 8.824 11 5.48288H10.9657C10.9657 2.45013 8.51548 0 5.48282 0H5.48287ZM5.48287 2.17592C7.21338 2.17592 8.61839 3.58097 8.61839 5.31144C8.61839 7.04191 7.21335 8.44696 5.48287 8.44696C3.7524 8.44696 2.34736 7.04191 2.34736 5.31144C2.34736 3.58097 3.75228 2.17592 5.48287 2.17592Z" fill="#FA4B4A"/>
                                        </svg>
                                       Wood Avenue 2nd Floor Apartment #B11, Nairobi, Kenya</p>
                                    </div>
                                    <!-- Hero Content .\ -->
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/638024270.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                            ...
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="assets/img/hero/638029832.jpg" alt="img">
                                <div class="listing__hero--slider__container">
                                    <div class="container">
                                    <!-- Hero Content -->
                                    <div class="listing__hero--slider__content">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/638024575.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/638025050.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/638027167.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                                <!-- Hero swiper items -->
                                <div class="listing__small--hero__slider--items">
                                    <img src="assets/img/hero/638024267.jpg" alt="img">
                                </div>
                                <!-- Hero swiper items .\ -->
                            </div>
                            <div class="swiper-slide">
                              <!-- Hero swiper items -->
                              <div class="listing__small--hero__slider--items">
                                  <img src="assets/img/hero/638024615.jpg" alt="img">
                              </div>
                              <!-- Hero swiper items .\ -->
                          </div>
                        </div>
                        ...
                        <div class="listing__details--wrapper">
                            <div class="listing__details--content">
                                <div class="listing__details--content__top mb-25 d-flex align-items-center justify-content-between">
                                    <div class="listing__details--meta">
                                        <ul class="listing__details--meta__wrapper d-flex align-items-center">
                                            ...
                                            <li><span class="listing__details--badge two">Rental</span></li>
                                            <li>
                                            ...
                                            <li>
                                                <span class="listing__details--meta__icon">
                                                 ...
                                                 <span class="listing__details--meta__text">3 reviews</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="listing__details--content__step">
                                    <h2 class="listing__details--title mb-25">Executive 1 BedRoom AirBnB at Wood Avenue Kilimani</h2>
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">Kes 3000 per night</span>
                                            <span class="listing__details--price__old">2500</span>
                                        </div>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <p class="listing__details--content__desc">Executive 1 BedRoom AirBnB at Wood Avenue Kilimani is a city accommodation in Nairobi, a 13-minute walk from Shifteye Gallery and 2.4 km from Royal Nairobi Golf Club. The accommodation offers free private parking and is 5.5 km from Kenyatta International Conference Centre and 6.8 km from Nairobi National Museum.

                                        This apartment has 1 bedroom, a kitchen with a fridge and oven, a flat-screen TV, a seating area and 1 bathroom with a bidet. Towels and bed linen are provided in the apartment.
                                        
                                        Century Cinemax Junction is 3.4 km from the accommodation, and Nairobi Arboretum is 4 km away. The airport (Wilson Airport) is 5 km away.</p>
                                        ...
                                        <div class="apartment__info--wrapper d-flex">
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">Free Car Parking</span>
                                                </p>
                                            </div>
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--title">500-800 Sqft</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">Kes 3000 per night</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                        ...
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">600-750 SqFt</span>
                                        </li>
                                        <!--<li class="properties__details--info__list d-flex justify-content-between">
                                    ...
                                    <div class="properties__amenities--wrapper d-flex">
                                        <ul class="properties__amenities--step">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Flat screen TV</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                                ...
                                                <span class="properties__amenities--text">Views</span>
                                            </li>
                                        </ul>
                                        <ul class="properties__amenities--step">
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Ducha</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Kitchen</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <ul class="properties__amenities--step">
                                            ...
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                ...
                                                <span class="properties__amenities--text">Sofa</span>
                                            </li>
                                            <li class="properties__amenities--list d-flex align-items-center">
                                                <span class="properties__amenities--mark__icon"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.794 2.174C14.426 3.422 13.094 4.874 11.798 6.53C10.67 7.958 9.656 9.422 8.756 10.922C7.94 12.266 7.346 13.418 6.974 14.378C6.962 14.414 6.938 14.444 6.902 14.468C6.866 14.504 6.824 14.522 6.776 14.522C6.764 14.534 6.752 14.54 6.74 14.54C6.656 14.54 6.596 14.516 6.56 14.468L0.134 7.934C0.122 7.922 0.278 7.766 0.602 7.466C0.926 7.154 1.244 6.872 1.556 6.62C1.904 6.332 2.09 6.2 2.114 6.224L5.642 8.996C6.674 7.784 7.832 6.584 9.116 5.396C11.048 3.62 13.04 2.108 15.092 0.86C15.128 0.86 15.266 1.028 15.506 1.364L15.866 1.886C15.878 1.934 15.878 1.988 15.866 2.048C15.854 2.096 15.83 2.138 15.794 2.174Z" fill="currentColor"/>
                                        ...
                                        <div class="properties__floor--plans__content">
                                            ...
                                            <ul class="properties__floor--plans__info">
                                                <li>
                                                    ...
                                                    <span>One bathroom with a walk-in shower, separate toilet, and bath </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon2.png" alt="icon">-->
                                                    <span>One bedroom with a double bed </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon3.png" alt="icon">-->
                                                    <span>A seating area with a sofa </span>
                                                </li>
                                                <li>
                                                    <!--<img src="assets/img/icon/properties-icon4.png" alt="icon">-->
                                                    <span>A kitchen equipped with a refrigerator, oven, microwave, and kitchenware</span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="floor1">
                                                    <div class="properties__floor--plans__display">
                                                        <img src="assets/img/other/th.jpg" alt="img">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63820.98835635585!2d36.696152827969435!3d-1.2870264173694381!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x41fabd7e8f5457e1%3A0x1bb41fb36ae4e269!2sCozy%20stay%20homes%2C%20furnished%20one%20bedroom%20in%20kilimani%2C%20wood%20avenue!5e0!3m2!1sen!2ske!4v1738660701342!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </details>
                                        </div>
                                    </div>
                                    <div class="location__google--maps__info d-flex">
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Wood Avenue 2nd Floor Apartment #B11, Nairobi, Kenya</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                            ...
                                            <li class="location__google--maps__info--list d-flex">
                                                ...
                                                <span class="location__google--maps__info--subtitle">Nairobi</span>
                                            </li>
                                        </ul>
                                        <ul class="location__google--maps__info--step">
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Town:</span>
                                                <span class="location__google--maps__info--subtitle">Kilimani</span>
                                            </li>
                                            <li class="location__google--maps__info--list d-flex">
                                                <span class="location__google--maps__info--title">Neighborhood:  </span>
                                                <span class="location__google--maps__info--subtitle">Wood Avenue</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--video__thumbnail position-relative"> 
                                        <img src="assets/img/property/th (1).jpg" alt="Video Thumbnail" class="video-thumbnail">
                                        <div class="bideo__play">
                                            <a class="bideo__play--icon glightbox" href="https://www.bing.com/videos/riverview/relatedvideo?q=Executive+1+BedRoom+AirBnB+at+Wood+Avenue+Kilimani&&mid=3A5AE375C67B7AD668013A5AE375C67B7AD66801&&mmscn=stvo&FORM=VRDGAR" data-gallery="video">
                                ...
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="listing__details--review d-flex">
                                        <div class="details__review--box">
                                            <h3 class="details__review--box__point">0.0</h3>
                                    ...
                                    <div class="properties__reviews--comment mb-80">
                                       ...
                                       <div class="properties__reviews--comment__display mb-50 d-flex align-items-center justify-content-between">
                                            <div class="reviews__comment--display__left d-flex align-items-center">
                                                ...
                                                <span class="reviews__comment--display__text">(0 out of 0)</span>
                                            </div>
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            ...
                                                            <span class="reviews__comment--author__date">20th january 2023</span>
                                                        </div>
                                                    ...
                                                    <p class="reviews__comment--desc">"I had an amazing stay at this Airbnb! The apartment was spotless, well-furnished, and had everything I needed for a comfortable stay. The kitchen was fully equipped, and the bed was incredibly comfortable. The location in Kilimani was perfect—close to malls, restaurants, and just a short drive to the city center. The host was super responsive and made sure I had everything I needed. Highly recommend!"</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 2:</h3>
                                                            <span class="reviews__comment--author__date">16th August 2024</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"The apartment was exactly as advertised—clean, modern, and in a great location. The WiFi was strong, and the smart TV was a nice touch. I also loved the balcony view! My only minor issue was that the hot water took a bit of time to heat up, but overall, it was a fantastic experience. Would definitely stay here again!"</p>
                                                </div>
                                            </div>
                                            <div class="reviews__comment--step d-flex">
                                                <div class="reviews__comment--thumb">
                                                ...
                                                <div class="reviews__comment--content last__content">
                                                    <div class="reviews__comment--top d-flex ">
                                                        <div class="reviews__comment--author__title">
                                                            <h3 class="reviews__comment--author__name">
                                                                Review 3:</h3>
                                                            <span class="reviews__comment--author__date">28th june 2024</span>
                                                        </div>
                                                        <ul class="reviews__comment--rating d-flex">
                                                            <li>
                                                              <span><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p class="reviews__comment--desc">"This Airbnb exceeded my expectations! The neighborhood is safe and quiet, yet close to everything. I appreciated the free parking and 24/7 security. The interior was stylish and well-maintained, making it feel like a home away from home. I especially loved the spacious living area and the well-lit workspace. Perfect for both business and leisure travelers. Will definitely book again!"</p>
                                                </div>
                                            </div>
                                       </div>
                                    </div>
                        ...
                        <div class="listing__widget">
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="assets/img/property/526442722.jpg" alt="img" class="featured-image">
                                    ...
                                    <div class="widget__featured--properties__content">
                                        ...
                                        <h3 class="widget__featured--properties__title">Casa Misa Westlands one bedroom </h3>
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">Kes 25,000 - 30,000</span>
                                            <span class="old__price">Kes 23,000</span>
                                        </div>    
                                    </div>
                                </div>
                            </div>
                            <div class="widget__step">
                                ...
                                <div class="widget__featured">                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalWashroom">
                                                <img class="widget__featured--media" src="assets/img/hero/638029227.jpg" alt="Washroom">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Washroom</a></h3>
                                        </div>
                                    </div>
                                    <!-- Modal for Washroom -->
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/638029227.jpg" alt="Washroom">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalLivingRoom">
                                                <img class="widget__featured--media" src="assets/img/hero/638024269.jpg" alt="Living Room">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Living Room</a></h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="imageModalLivingRoom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelLivingRoom" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/638024269.jpg" alt="Living Room">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalFireplaceTv">
                                                <img class="widget__featured--media" src="assets/img/hero/638024270.jpg" alt="Fireplace & Tv">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Fireplace & Tv</a></h3>
                                        </div>
                                    </div>
                                    <!-- Modal for Fireplace & Tv -->
                                    <div class="modal fade" id="imageModalFireplaceTv" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelFireplaceTv" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/638024270.jpg" alt="Fireplace & Tv">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    ...
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="#" data-toggle="modal" data-target="#imageModalBedroom">
                                                <img class="widget__featured--media" src="assets/img/hero/638024615.jpg" alt="Bedroom">
                                            </a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <h3 class="widget__featured--title"><a href="#">Bedroom</a></h3>
                                        </div>
                                    </div>
                                    <!-- Modal for Bedroom -->
                                    <div class="modal fade" id="imageModalBedroom" tabindex="-1" role="dialog" aria-labelledby="imageModalLabelBedroom" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img class="img-fluid" src="assets/img/hero/638024615.jpg" alt="Bedroom">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Include jQuery and Bootstrap JS only once -->
