...
<head>
  <meta charset="utf-8">
  <title>Centralised Property Reservation Platform - About Page</title>
                            ...
                            <ul class="main__menu--wrapper d-flex">
                                <li class="main__menu--items">
                                    ...
                                    <!--<ul class="sub__menu">
                                        ...
                                        <li class="sub__menu--items"><a href="Home.php" class="sub__menu--link">Home - Four</a></li>
                ...
                <ul class="offcanvas__menu_ul">
                    <li class="offcanvas__menu_li">
                        ...
                        <!--<ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="Home.php" class="offcanvas__sub_menu_item">Home - Four</a></li>
    ...
    <main class="main__content_wrapper">
                ...
                <div class="about__inner d-flex">
                    <div class="about__thumbnail position-relative" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                        ...
                        <div class="about__thumbnail--list two">
                            <img src="assets/img/other/th (5).jpg" alt="about-thumb">
                            <div class="bideo__play">
                                <a class="bideo__play--icon glightbox" href="https://www.bing.com/videos/riverview/relatedvideo?q=real+estate+in+kenya+nairobi&&mid=F50C89D8BC409BC981EAF50C89D8BC409BC981EA&&mmscn=stvo&FORM=VRDGAR" data-gallery="video">
                    ...
                    <div class="about__content" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                        <div class="section__heading">
                            ...
                            <p class="section__heading--desc">At Kibisu Real Estates we connect you to live on remodeled properties that are first built for convenience and comfort. Luxury apartments, large family homes, or contemporary city residences-we have them all. In other words, here is your chance to find a house perfectly designed to match your needs.

                                Our platform makes sure that each new building displayed is characterized by high-quality construction, aesthetics, and functionality.</p>
                        </div>
                        ...
                        <div class="about__content--details d-flex align-items-center">
                            <div class="about__experince">
                                <span class="about__experince--number">2</span>
                            ...
                            <div class="living__details--content__wrapper">
                                ...
                                <p class="living__details--content__list"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Flexible financing and reservation options
                                </p>
                ...
                <div class="categories__inner row mb--n30">
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                        <div class="categories__box">
                            <div class="categories__thumbnail text-center">
                                <img src="assets/img/other/dba7079b-cb75-4497-9a1e-94af76b6be0f.webp" alt="categories-img">
                            </div>
                            <span class="categories__badge">1</span>
                            <div class="categories__content text-center">
                                <h3 class="categories__title"><a href="listing-list.php">Single-family home</a></h3>
                                <p class="categories__desc">🏡 Find Your Perfect Family Home
                                    Discover a variety of single-family homes designed for comfort, privacy, and modern living. Whether you're looking for a cozy starter home or a spacious property, we connect you with the best listings to suit your needs.</p>
                                <a class="categories__link" href="listing-details.php">See Properites <svg width="33" height="19" viewBox="0 0 33 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                        <div class="categories__box">
                            ...
                            <span class="categories__badge">2</span>
                            <div class="categories__content text-center">
                                <h3 class="categories__title"><a href="listing-list.php">Duplex - Houses</a></h3>
                                <p class="categories__desc">🏠 Stylish & Versatile Living
                                    Explore our collection of duplex homes, offering the perfect blend of privacy and shared living. Whether you need a home for an extended family or an investment property, duplex houses provide flexibility and great value.</p>
                                <a class="categories__link" href="listing-details.php">See Properites <svg width="33" height="19" viewBox="0 0 33 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M31.5123 9.14893C31.5123 13.9435 27.7735 17.7979 23.2005 17.7979C18.6275 17.7979 14.8887 13.9435 14.8887 9.14893C14.8887 4.3544 18.6275 0.5 23.2005 0.5C27.7735 0.5 31.5123 4.3544 31.5123 9.14893Z" stroke="#BDC2C6"/>
                                    <path d="M26.9592 9.53033C27.2521 9.23744 27.2521 8.76256 26.9592 8.46967L22.1862 3.6967C21.8933 3.40381 21.4184 3.40381 21.1255 3.6967C20.8326 3.98959 20.8326 4.46447 21.1255 4.75736L25.3682 9L21.1255 13.2426C20.8326 13.5355 20.8326 14.0104 21.1255 14.3033C21.4184 14.5962 21.8933 14.5962 22.1862 14.3033L26.9592 9.53033ZM0.245117 9.75L26.4288 9.75L26.4288 8.25L0.245117 8.25L0.245117 9.75Z" fill="#FA4A4A"/>
                                    </svg>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                        <div class="categories__box">
                            <div class="categories__thumbnail text-center">
                                <img src="assets/img/other/2b8bed42-d954-4ff9-b4a2-ca3edfbe378c.webp" alt="categories-img">
                            </div>
                            <span class="categories__badge">3</span>
                            <div class="categories__content text-center">
                                <h3 class="categories__title"><a href="listing-list.php">Airbnb</a></h3>
                                <p class="categories__desc">🛏️ Profitable Short-Term Rentals
                                    Looking for a great investment opportunity or a temporary stay? Our Airbnb-friendly properties offer fully furnished, high-demand homes for travelers, professionals, and vacationers.</p>
                                <a class="categories__link" href="listing-list.php">See Properites <svg width="33" height="19" viewBox="0 0 33 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M31.5123 9.14893C31.5123 13.9435 27.7735 17.7979 23.2005 17.7979C18.6275 17.7979 14.8887 13.9435 14.8887 9.14893C14.8887 4.3544 18.6275 0.5 23.2005 0.5C27.7735 0.5 31.5123 4.3544 31.5123 9.14893Z" stroke="#BDC2C6"/>
                                    <path d="M26.9592 9.53033C27.2521 9.23744 27.2521 8.76256 26.9592 8.46967L22.1862 3.6967C21.8933 3.40381 21.4184 3.40381 21.1255 3.6967C20.8326 3.98959 20.8326 4.46447 21.1255 4.75736L25.3682 9L21.1255 13.2426C20.8326 13.5355 20.8326 14.0104 21.1255 14.3033C21.4184 14.5962 21.8933 14.5962 22.1862 14.3033L26.9592 9.53033ZM0.245117 9.75L26.4288 9.75L26.4288 8.25L0.245117 8.25L0.245117 9.75Z" fill="#FA4A4A"/>
                                    </svg>
                                </a>
        ...
        <section class="popular__featured--section section--padding">
            <div class="container-fluid p-0">
                <div class="section__heading text-center mb-50" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    ...
                    <h2 class="section__heading--title color__white">Most <span>Popular</span> Towns</h2>
                </div>
                <div class="popular__featured--inner" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                    <div class="popular__featured--column5 swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/OIP (6).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">1</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Ongata rongai</h3>
                                            <h5 class="popular__featured--subtitle">10 properties 
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/download (8).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">2</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Ngong</h3>
                                            <h5 class="popular__featured--subtitle">6 
                                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.4219 1.67528L17.3926 13.422C17.3918 13.7573 17.2595 14.0725 17.0207 14.3101C16.7816 14.548 16.4657 14.6784 16.1306 14.6777L15.0639 14.6749C14.729 14.6742 14.4135 14.5421 14.1757 14.3031C13.938 14.0643 13.8 13.7405 13.801 13.4056L13.8106 6.54525L2.89752 17.4038C2.40548 17.8934 1.63343 17.895 1.14372 17.4028L0.391553 16.6469C-0.098156 16.1547 -0.131297 15.3438 0.360739 14.8543L11.3128 3.95695L4.39453 3.95165C4.05934 3.95068 3.74986 3.82469 3.51207 3.5857C3.27453 3.34697 3.14693 3.03368 3.14777 2.69863L3.15202 1.63372C3.15286 1.29841 3.28561 0.984048 3.52473 0.746117C3.76359 0.50845 4.07993 0.378344 4.41525 0.379184L16.1618 0.408607C16.4981 0.40958 16.8147 0.542466 17.0521 0.782382C17.2914 1.02191 17.423 1.33917 17.4219 1.67528Z" fill="currentColor"/>
                                                    </svg>
                                                </span>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/download (9).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">3</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Kiserian</h3>
                                            <h5 class="popular__featured--subtitle">7 properties 
                                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.4219 1.67528L17.3926 13.422C17.3918 13.7573 17.2595 14.0725 17.0207 14.3101C16.7816 14.548 16.4657 14.6784 16.1306 14.6777L15.0639 14.6749C14.729 14.6742 14.4135 14.5421 14.1757 14.3031C13.938 14.0643 13.8 13.7405 13.801 13.4056L13.8106 6.54525L2.89752 17.4038C2.40548 17.8934 1.63343 17.895 1.14372 17.4028L0.391553 16.6469C-0.098156 16.1547 -0.131297 15.3438 0.360739 14.8543L11.3128 3.95695L4.39453 3.95165C4.05934 3.95068 3.74986 3.82469 3.51207 3.5857C3.27453 3.34697 3.14693 3.03368 3.14777 2.69863L3.15202 1.63372C3.15286 1.29841 3.28561 0.984048 3.52473 0.746117C3.76359 0.50845 4.07993 0.378344 4.41525 0.379184L16.1618 0.408607C16.4981 0.40958 16.8147 0.542466 17.0521 0.782382C17.2914 1.02191 17.423 1.33917 17.4219 1.67528Z" fill="currentColor"/>
                                                    </svg>
                                                </span>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/download (10).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">4</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Langata</h3>
                                            <h5 class="popular__featured--subtitle">15 properties 
                                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.4219 1.67528L17.3926 13.422C17.3918 13.7573 17.2595 14.0725 17.0207 14.3101C16.7816 14.548 16.4657 14.6784 16.1306 14.6777L15.0639 14.6749C14.729 14.6742 14.4135 14.5421 14.1757 14.3031C13.938 14.0643 13.8 13.7405 13.801 13.4056L13.8106 6.54525L2.89752 17.4038C2.40548 17.8934 1.63343 17.895 1.14372 17.4028L0.391553 16.6469C-0.098156 16.1547 -0.131297 15.3438 0.360739 14.8543L11.3128 3.95695L4.39453 3.95165C4.05934 3.95068 3.74986 3.82469 3.51207 3.5857C3.27453 3.34697 3.14693 3.03368 3.14777 2.69863L3.15202 1.63372C3.15286 1.29841 3.28561 0.984048 3.52473 0.746117C3.76359 0.50845 4.07993 0.378344 4.41525 0.379184L16.1618 0.408607C16.4981 0.40958 16.8147 0.542466 17.0521 0.782382C17.2914 1.02191 17.423 1.33917 17.4219 1.67528Z" fill="currentColor"/>
                                                    </svg>
                                                </span>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/OIP (7).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">5</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">South c</h3>
                                            <h5 class="popular__featured--subtitle">5 properties 
                                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.4219 1.67528L17.3926 13.422C17.3918 13.7573 17.2595 14.0725 17.0207 14.3101C16.7816 14.548 16.4657 14.6784 16.1306 14.6777L15.0639 14.6749C14.729 14.6742 14.4135 14.5421 14.1757 14.3031C13.938 14.0643 13.8 13.7405 13.801 13.4056L13.8106 6.54525L2.89752 17.4038C2.40548 17.8934 1.63343 17.895 1.14372 17.4028L0.391553 16.6469C-0.098156 16.1547 -0.131297 15.3438 0.360739 14.8543L11.3128 3.95695L4.39453 3.95165C4.05934 3.95068 3.74986 3.82469 3.51207 3.5857C3.27453 3.34697 3.14693 3.03368 3.14777 2.69863L3.15202 1.63372C3.15286 1.29841 3.28561 0.984048 3.52473 0.746117C3.76359 0.50845 4.07993 0.378344 4.41525 0.379184L16.1618 0.408607C16.4981 0.40958 16.8147 0.542466 17.0521 0.782382C17.2914 1.02191 17.423 1.33917 17.4219 1.67528Z" fill="currentColor"/>
                                                    </svg>
                                                </span>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/download (11).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">6</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Mombasa Road</h3>
                                            <h5 class="popular__featured--subtitle">18 properties 
                                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.4219 1.67528L17.3926 13.422C17.3918 13.7573 17.2595 14.0725 17.0207 14.3101C16.7816 14.548 16.4657 14.6784 16.1306 14.6777L15.0639 14.6749C14.729 14.6742 14.4135 14.5421 14.1757 14.3031C13.938 14.0643 13.8 13.7405 13.801 13.4056L13.8106 6.54525L2.89752 17.4038C2.40548 17.8934 1.63343 17.895 1.14372 17.4028L0.391553 16.6469C-0.098156 16.1547 -0.131297 15.3438 0.360739 14.8543L11.3128 3.95695L4.39453 3.95165C4.05934 3.95068 3.74986 3.82469 3.51207 3.5857C3.27453 3.34697 3.14693 3.03368 3.14777 2.69863L3.15202 1.63372C3.15286 1.29841 3.28561 0.984048 3.52473 0.746117C3.76359 0.50845 4.07993 0.378344 4.41525 0.379184L16.1618 0.408607C16.4981 0.40958 16.8147 0.542466 17.0521 0.782382C17.2914 1.02191 17.423 1.33917 17.4219 1.67528Z" fill="currentColor"/>
                                                    </svg>
                                                </span>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/download (12).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">7</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Westlands</h3>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-list.php"><img class="popular__featured--img" src="assets/img/property/download (13).jpg" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">8</span>
                                        <div class="popular__featured--content">
                                            <h3 class="popular__featured--title">Karen</h3>
                                            <h5 class="popular__featured--subtitle">13 properties 
                                                <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.4219 1.67528L17.3926 13.422C17.3918 13.7573 17.2595 14.0725 17.0207 14.3101C16.7816 14.548 16.4657 14.6784 16.1306 14.6777L15.0639 14.6749C14.729 14.6742 14.4135 14.5421 14.1757 14.3031C13.938 14.0643 13.8 13.7405 13.801 13.4056L13.8106 6.54525L2.89752 17.4038C2.40548 17.8934 1.63343 17.895 1.14372 17.4028L0.391553 16.6469C-0.098156 16.1547 -0.131297 15.3438 0.360739 14.8543L11.3128 3.95695L4.39453 3.95165C4.05934 3.95068 3.74986 3.82469 3.51207 3.5857C3.27453 3.34697 3.14693 3.03368 3.14777 2.69863L3.15202 1.63372C3.15286 1.29841 3.28561 0.984048 3.52473 0.746117C3.76359 0.50845 4.07993 0.378344 4.41525 0.379184L16.1618 0.408607C16.4981 0.40958 16.8147 0.542466 17.0521 0.782382C17.2914 1.02191 17.423 1.33917 17.4219 1.67528Z" fill="currentColor"/>
                                                    </svg>
                    ...
                    <p class="featured__support--desc text-center">Find your dream home with exclusive listings, <a href="javascript:void(0)">virtual tours,</a> and expert real estate support available 24/7. </p>
                </div>
            </div>  
        </section>
        <!-- Popular featured section .\  -->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial__card">
                                    ...
                                    <p class="testimonial__desc">Listing my rentals and managing them as a property owner is so simple on this platform. It literally connects me to serious customers.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial__card">
                                    ...
                                    <p class="testimonial__desc">This feature is a revolution in terms of real-time availability-for I can just book properties outright without having to think of double bookings or waiting.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial__card">
                                    ...
                                    <p class="testimonial__desc">The whole booking process is easy, plus I love how the whole payment system is really secure. I highly recommend it to anyone out there looking for a hassle-free experience.</p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial__card">
                                    ...
                                    <p class="testimonial__desc">Working with your team has been a game-changer for our real estate business. The attention to detail, prompt communication, and innovative solutions provided have helped us streamline our property listings and enhance client engagement. Your professionalism and commitment to excellence are evident in every interaction. We look forward to continuing this partnership and achieving even greater success together.</p>
                                </div>
                            </div>
                            <!--<div class="swiper-slide">
                                <div class="testimonial__card">
                ...
                <div class="building__amenities--inner d-flex" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                    <div class="amenities__box">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">Secure and spacious parking areas designed for convenience and safety, offering designated spots for residents and guests.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">Enjoy a refreshing dip in our well-maintained swimming pool, perfect for relaxation, exercise, and leisure.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">24/7 professional security services ensuring a safe and secure living environment for all residents.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">On-site medical facilities providing quick access to healthcare services for residents' convenience and well-being.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">Our Library Area offers a quiet and serene space for residents to unwind, read, or work. Equipped with comfortable seating, ample natural light, and a curated collection of books, it’s the perfect spot for book lovers and those seeking a peaceful retreat. Whether you're diving into a novel, studying, or simply relaxing, the Library Area provides a welcoming environment for all.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc"> is the epitome of luxury and comfort, offering ample space for a restful night's sleep. Measuring approximately 76 inches wide and 80 inches long, it provides plenty of room for couples or individuals who enjoy extra space to stretch out. Perfect for master bedrooms, the king-size bed ensures a premium sleeping experience, complemented by high-quality mattresses and stylish bed frames to enhance your bedroom's aesthetic.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">Experience the future of living with our Smart Homes, designed to offer convenience, security, and energy efficiency. Equipped with cutting-edge technology, these homes feature automated systems for lighting, temperature control, security cameras, and voice-activated assistants. Control your home remotely via smartphone apps, ensuring comfort and peace of mind whether you're at home or away.<b> Smart Homes</b> redefine modern living by integrating technology seamlessly into everyday life, making your home safer, smarter, and more sustainable.</p>
                        </div>
                    </div>
                    <div class="amenities__box">
                        <div class="amenities__icone text-right">
                        ...
                        <div class="amenities__content">
                            ...
                            <p class="amenities__desc">Enjoy a safe and fun-filled environment for your little ones with our vibrant Kids' Playland. Designed with engaging activities and modern play equipment, it's the perfect spot for children to explore, socialize, and have endless fun!</p>
                        </div>
                    </div>
                </div>
            </div>
       ...
       <div class="social__media--area bg__style" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
            <ul class="social__media--wrapper d-flex">
                ...
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.pinterest.com/erickkibisu/"> <svg width="14" height="16" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="footer__widget">
                                ...
                                <ul class="footer__widget--menu footer__widget--inner">
                                    ...
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Team member</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Offices to buy</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Terms of use</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Offices to rent</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            ...
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget--inner newsletter">
                                    ...
                                    <ul class=" footer__social d-flex align-items-center">
                                        ...
                                        <li class="footer__social--list">
                                            <a class="footer__social--icon" target="_blank" href="https://www.pinterest.com/erickkibisu/">
                                                <svg width="14" height="16" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M14.6713 6.71093C14.6764 7.71873 14.5406 8.65694 14.2638 9.52555C14.0104 10.394 13.6393 11.146 13.1503 11.7813C12.6612 12.3932 12.0778 12.8883 11.4001 13.2668C10.7222 13.6218 9.97304 13.7897 9.15262 13.7705C8.87149 13.7954 8.59012 13.7734 8.30852 13.7045C8.05023 13.6121 7.80366 13.5196 7.56881 13.427C7.35727 13.3109 7.16906 13.1713 7.00416 13.008C6.83926 12.8448 6.70957 12.6931 6.61511 12.553C6.47736 13.1162 6.36257 13.5856 6.27074 13.961C6.17891 14.3365 6.09838 14.6299 6.02915 14.8412C5.98323 15.0289 5.94879 15.1697 5.92584 15.2636C5.9262 15.3339 5.92632 15.3573 5.9262 15.3339C5.85696 15.5452 5.78767 15.7448 5.71832 15.9326C5.64897 16.1205 5.56796 16.3201 5.47529 16.5315C5.3825 16.7195 5.27793 16.8958 5.16158 17.0605C5.06867 17.225 4.97576 17.3896 4.88285 17.5541C4.60256 17.743 4.38033 17.8262 4.21615 17.8036C4.07553 17.8043 3.95804 17.7463 3.86369 17.6296C3.79278 17.5128 3.74531 17.3959 3.72127 17.2788C3.69736 17.1852 3.68534 17.1266 3.68522 17.1032C3.66094 16.9393 3.64832 16.7635 3.64736 16.576C3.64629 16.3651 3.64527 16.1659 3.64431 15.9784C3.66667 15.7673 3.68902 15.5563 3.71138 15.3452C3.75718 15.1341 3.80309 14.9463 3.84913 14.782C3.84901 14.7586 3.86037 14.6882 3.8832 14.5709C3.92936 14.43 3.99829 14.1602 4.09 13.7612C4.18159 13.3389 4.30756 12.764 4.46791 12.0366C4.62825 11.3092 4.84599 10.3472 5.12112 9.15044C5.05009 9.01017 4.9906 8.8347 4.94264 8.624C4.89469 8.41331 4.85863 8.23771 4.83448 8.0972C4.8102 7.93326 4.79776 7.7927 4.79716 7.67551C4.79657 7.55833 4.79633 7.51145 4.79645 7.53489C4.79441 7.13646 4.83948 6.78466 4.93167 6.4795C5.04718 6.15078 5.18637 5.86881 5.34923 5.6336C5.53541 5.37483 5.74538 5.18626 5.97915 5.06787C6.23624 4.92593 6.49363 4.84258 6.75132 4.81782C6.98581 4.84006 7.18527 4.88592 7.34969 4.95539C7.53755 5.02474 7.69049 5.14115 7.80851 5.30461C7.92654 5.46807 8.00947 5.64343 8.0573 5.83069C8.12845 5.99439 8.16463 6.19342 8.16583 6.4278C8.16691 6.63873 8.13307 6.89672 8.06432 7.20176C7.99544 7.48337 7.91491 7.77675 7.82272 8.08192C7.73053 8.38708 7.62674 8.71574 7.51135 9.0679C7.41928 9.3965 7.33887 9.71332 7.27012 10.0184C7.20137 10.3234 7.19103 10.593 7.2391 10.8271C7.31049 11.0377 7.41704 11.2481 7.55874 11.4583C7.72376 11.645 7.92369 11.7846 8.15854 11.8771C8.3934 11.9697 8.63979 12.027 8.89771 12.0491C9.38978 12.0232 9.8343 11.8686 10.2313 11.5853C10.6283 11.302 10.9661 10.9018 11.2447 10.3848C11.5467 9.86758 11.7665 9.29223 11.9038 8.65871C12.0646 8.00163 12.1429 7.28637 12.139 6.51294C12.1362 5.97389 12.0398 5.45875 11.8498 4.96753C11.6598 4.47631 11.3765 4.06759 10.9998 3.74139C10.6464 3.39163 10.1997 3.11266 9.65954 2.90449C9.14285 2.69619 8.533 2.60556 7.83 2.63259C7.05646 2.61311 6.354 2.74561 5.72263 3.03009C5.11471 3.31446 4.58923 3.68043 4.1462 4.12802C3.70317 4.5756 3.36603 5.10467 3.13477 5.71524C2.9034 6.30237 2.78933 6.91234 2.79257 7.54514C2.79388 7.80295 2.80674 8.02554 2.83114 8.21292C2.87885 8.37674 2.92662 8.55228 2.97446 8.73954C3.04561 8.90324 3.1167 9.05522 3.18773 9.19548C3.28208 9.31219 3.38827 9.45227 3.50629 9.61574C3.55329 9.63893 3.58868 9.68563 3.61248 9.75582C3.63615 9.80257 3.64805 9.83767 3.64817 9.86111C3.67173 9.88442 3.68369 9.93124 3.68405 10.0015C3.68429 10.0484 3.67281 10.0954 3.64961 10.1424C3.62653 10.2128 3.60346 10.2832 3.58038 10.3536C3.58062 10.4005 3.56926 10.4709 3.5463 10.5648C3.52334 10.6586 3.50033 10.7408 3.47725 10.8112C3.45405 10.8582 3.44263 10.9169 3.44299 10.9872C3.4198 11.0342 3.38494 11.0929 3.33842 11.1635C3.31523 11.2105 3.28025 11.2458 3.2335 11.2695C3.18662 11.2697 3.13981 11.2817 3.09305 11.3054C3.04618 11.3056 2.98747 11.2825 2.91691 11.236C2.56464 11.0971 2.24722 10.8995 1.96465 10.6432C1.7054 10.3632 1.49291 10.0596 1.32717 9.73235C1.16143 9.40507 1.03061 9.03073 0.934703 8.60934C0.838796 8.18795 0.789764 7.76633 0.787606 7.34446C0.78377 6.59447 0.932275 5.8437 1.23312 5.09215C1.55741 4.34048 2.02261 3.64668 2.62874 3.01076C3.23487 2.37484 3.99401 1.86705 4.90614 1.48737C5.81815 1.08427 6.88346 0.867877 8.10208 0.838206C9.08656 0.856608 9.97807 1.02783 10.7766 1.35188C11.5985 1.65236 12.2921 2.08241 12.8575 2.64203C13.4228 3.20165 13.8597 3.83223 14.1679 4.53379C14.4995 5.21179 14.6673 5.9375 14.6713 6.71093Z" fill="currentColor"/>
                                                    </svg>
                                                <span class="visually-hidden">Pinterest</span>
            ...
            <div class="footer__bottom color-offwhite">
                <div class="container">
                    <div class="footer__bottom--inner d-flex justify-content-between align-items-center">
                        <p class="copyright__content mb-0"><span class="text__secondary">Copyright © 2025 powered by <span>Kibisuerick</span> .  All Rights Reserved.</p>Kibisuerick</a> .  All Rights Reserved.</p>
...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:49 GMT -->
</html>