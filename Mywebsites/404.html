...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 21:56:53 GMT -->
<head>
  <meta charset="utf-8">
  <title>NewVilla - Error Page</title>
...
<body>
    ...
    <main class="main__content_wrapper">
        ...
        <section class="breadcrumb__section section--padding">
            <div class="container">
                <div class="breadcrumb__content text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    <h1 class="breadcrumb__title h2"><span>Error </span> Page</h1>
                    <ul class="breadcrumb__menu d-flex justify-content-center">
                        ...
                        <li><span class="breadcrumb__menu--text">Error Page </span></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="error__section section--padding">
            <div class="container">
                <div class="error__inner text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    <img class="error__img" src="assets/img/other/404.png" alt="img">
                    <h2 class="error__subtitle">Oops... It looks like you ‘re <span>lost !</span></h2>
                    <p class="error__desc">Oops! The page you are looking for does not exist. It might have been moved or deleted.</p>
                    <a class="error__btn solid__btn" href="Home.php">Back To Home</a>
                </div>
            </div>
        </section>
        <!-- Error Page section .\ -->
