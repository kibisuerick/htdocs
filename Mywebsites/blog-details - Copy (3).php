...
<body>
            ...
            <div class="container-fluid">
                <div class="main__header d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <a class="main__logo--link" href="Home.php">
                    ...
                    <div class="main__menu d-none d-lg-block">
                        <nav class="main__menu--navigation">
                            <ul class="main__menu--wrapper d-flex">
                                ...
                                <li class="main__menu--items">
                                    <a class="main__menu--link" href="listing-list.php"> Listing </a>  
                                    <!--<svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 12 7.41">
                                        <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                    </svg>-->
                                <!--<ul class="sub__menu">
                                ...
                                <li class="main__menu--items">
                                    <a class="main__menu--link" href="admin/dashboard.php"> Dashboard </a>  
                                    <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 12 7.41">
                                        <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                    </svg>
                                    <ul class="sub__menu">
                    ...
                    <div class="main__header--right d-flex align-items-center">
                        ...
                        <a class="add__listing--btn solid__btn" href="admin/Create-listing.php"><span>Add Listing</span> <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="offcanvas__header">
        <div class="offcanvas__inner">
            ...
            <a class="add__listing--btn offcanvas__listing--btn solid__btn" href="admin/Create-listing.php"><span>Add Listing</span> <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 15.9992C12.4111 15.9992 16 12.4105 16 7.99962C16 3.58875 12.411 0 8 0C3.58901 0 0 3.58875 0 7.99962C0 12.4105 3.58901 15.9992 8 15.9992ZM4.19508 7.57155H7.57197V4.19439C7.57197 3.95805 7.76381 3.76636 8 3.76636C8.23634 3.76636 8.42804 3.95821 8.42804 4.19439V7.57155H11.8049C12.0413 7.57155 12.233 7.7634 12.233 7.99958C12.233 8.23592 12.0411 8.42762 11.8049 8.42762H8.42804V11.8046C8.42804 12.041 8.23619 12.2327 8 12.2327C7.76366 12.2327 7.57197 12.0408 7.57197 11.8046V8.42762H4.19508C3.95874 8.42762 3.76704 8.23577 3.76704 7.99958C3.76704 7.76324 3.9586 7.57155 4.19508 7.57155Z" fill="white"/>
                </svg>
            </a>
            <div class="side__menu--footer mobile__menu--footer">
                <div class="side__menu--info">
                    <div class="side__menu--info__list">
                        ...
                        <p><a class="side__menu--info__text" href="tel:+254759506718">: (+254) 759506718</a></p>
                    </div>
                    <div class="side__menu--info__list">
    ...
    <main class="main__content_wrapper">
        ...
        <section class="breadcrumb__section section--padding">
            <div class="container">
                <div class="breadcrumb__content text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                    <h1 class="breadcrumb__title h2"><span>Blog </span> Details</h1>
                    <ul class="breadcrumb__menu d-flex justify-content-center">
                        <li class="breadcrumb__menu--items"><a class="breadcrumb__menu--link" href="Home.php">Home</a></li>
                        ...
                        <li><span class="breadcrumb__menu--text">Blog Details </span></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-8">
                        <div class="blog__details--wrapper">
                            <div class="blog__details--thumbnail mb-30">
                                <img class="blog__details--thumbnail--media" src="assets/img/blog/are-holiday-homes-a-good-investment-1.jpeg" alt="img">
                            </div>
                            <div class="blog__details--content">
                                <div class="blog__details--content__top mb-40">
                                    <ul class="blog__meta d-flex">
                                        <li class="blog__meta--list d-flex align-items-center">
                                          ...
                                          <span class="blog__meta--text">Gillian Palmer</span>
                                        </li>
                                        <li class="blog__meta--list d-flex align-items-center">
                                          ...
                                          <span class="blog__meta--text">Comments (0)</span>
                                        </li>
                                        <li class="blog__meta--list d-flex align-items-center">
                                          ...
                                          <span class="blog__meta--text">15 mins read </span>
                                        </li>
                                    </ul>
                                    <h3 class="blog__content--title ">A look back on 2024, and what to expect in 2025 </h3>
                                    <p class="blog__details--content__desc">By <a href="https://www.ukrealestateinsights.com/author/gpalmer/" target="_blank" style="color: #FF5722 ;"> Gillian Palmer</a> on December 20, 2024 Posted in <a href="https://www.ukrealestateinsights.com/category/property/" target="_blank" style="color: #FF5722 ;"> Property</a></p>                                
                                    <p class="blog__details--content__desc">In this article we take a look back at what has been crossing our desks in 2024 from a real estate perspective and do a bit of crystal-balling on what opportunities and challenges 2025 might bring. <b>Building Safety Act 2022 (“BSA”)</b></p> 
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/Office-window-and-green-trees-reflection_iStock-977687380-275x183.jpg" alt="img">
                                    </div>                                   
                                    <p class="blog__details--content__desc">The standout case for us was <b>Triathlon Homes LLP v Stratford Village Development Partnership</b> which is the first major case to address the new rights of action under Part 5 of the BSA. </p>                                    
                                    <p class="blog__details--content__desc"><a href="https://www.ukrealestateinsights.com/2024/12/a-look-back-on-2024-and-what-to-expect-in-2025/#more-2650" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Continue reading</a></p>
                                    <ul class="side__menu--share">
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="mailto:?subject=Will%20High%20Street%20Auctions%20bring%20about%20a%20renaissance%20of%20the%20High%20Street%3F%20-%20Real%20Estate%20Insights&amp;body=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                                <svg width="16" height="14" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.333 0C0.6 0 0 0.6 0 1.333v9.334C0 11.4 0.6 12 1.333 12h13.334C15.4 12 16 11.4 16 10.667V1.333C16 0.6 15.4 0 14.667 0H1.333zm13.334 1.333L8 5.833 1.333 1.333h13.334zM1.333 10.667V2.8l6.667 4.333 6.667-4.333v7.867H1.333z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">Gmail</span>
                                            </a>
                                        </li>
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://twitter.com/share/?text=A+look+back+on+2024%2C+and+what+to+expect+in+2025&url=https://www.ukrealestateinsights.com/2024/12/a-look-back-on-2024-and-what-to-expect-in-2025/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.57 2H21L14.43 10.39L22.5 22H16.43L11.43 14.92L5.24 22H2L9.14 13.02L1.5 2H7.76L12.29 8.46L17.57 2ZM16.5 20H18.32L7.07 4H5.18L16.5 20Z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">X</span>
                                            </a>
                                        </li> 
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.facebook.com/sharer.php/?u=https://www.ukrealestateinsights.com/2024/12/a-look-back-on-2024-and-what-to-expect-in-2025/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 12C22 6.48 17.52 2 12 2S2 6.48 2 12c0 4.84 3.42 8.87 8 9.74V15h-2v-3h2v-2.2c0-2.04 1.24-3.15 3.06-3.15.87 0 1.78.16 1.78.16v2h-1c-.99 0-1.3.62-1.3 1.26V12h2.5l-.5 3h-2v6.74c4.58-.87 8-4.9 8-9.74z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                            </a>
                                        </li>
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.linkedin.com/shareArticle/?mini=true&url=https%3A%2F%2Fwww.ukrealestateinsights.com%2F2024%2F12%2Fa-look-back-on-2024-and-what-to-expect-in-2025%2F&title=A+look+back+on+2024%2C+and+what+to+expect+in+2025+-+Real+Estate+Insights&summary">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v14H0V8zm7 0h5v2h.07c.69-1.31 2.37-2.7 4.93-2.7C22.05 7.3 24 9.92 24 14.14V22h-5v-7.07c0-1.74-.03-3.99-2.43-3.99-2.43 0-2.81 1.9-2.81 3.86V22H7V8z" fill="currentColor"/>
                                                </svg>
                                    ...
                                    <br>
                                    <h4 class="blog__content--title ">Will High Street Auctions bring about a renaissance of the High Street?</h4>
                                    <p class="blog__details--content__desc">By <a href="https://www.ukrealestateinsights.com/author/gpalmer/" target="_blank" style="color: #FF5722 ;"> Gillian Palmer</a> on December 9, 2024 Posted in <a href="https://www.ukrealestateinsights.com/category/environment/" target="_blank" style="color: #FF5722 ;"> Environment, <a href="https://www.ukrealestateinsights.com/category/planning/" target="_blank" style="color: #FF5722 ;">Planning,</a><a href="https://www.ukrealestateinsights.com/category/united-kingdom/" target="_blank" style="color: #FF5722 ;"> United Kingdom</a></p>
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/Landlord-275x183.jpg" alt="img">
                                    </div>                                    
                                    <p class="blog__details--content__desc"><b>Introduction</b></p>                                    
                                    <p class="blog__details--content__desc"><a href="https://www.legislation.gov.uk/ukpga/2023/55" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Part X of the Levelling Up and Regeneration Act 2023</a> (the <b>“Act”</b>) introduced what the Conservative government hoped would provide a solution to all the boarded up shops, cafes and pubs on high streets across the country.  It gave a permissive power to the relevant local authority to require vacant properties to be let through an auction process and,  in effect, deprive the landlord of management of its own property.</p>
                                    <p class="blog__details--content__desc"><a href="https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/#more-2641" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Continue reading</a></p>
                                    <ul class="side__menu--share">
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="mailto:?subject=Will%20High%20Street%20Auctions%20bring%20about%20a%20renaissance%20of%20the%20High%20Street%3F%20-%20Real%20Estate%20Insights&amp;body=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                                <svg width="16" height="14" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://twitter.com/share/?text=Will+High+Street+Auctions+bring+about+a+renaissance+of+the+High+Street&url=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.57 2H21L14.43 10.39L22.5 22H16.43L11.43 14.92L5.24 22H2L9.14 13.02L1.5 2H7.76L12.29 8.46L17.57 2ZM16.5 20H18.32L7.07 4H5.18L16.5 20Z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">X</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.facebook.com/sharer.php/?u=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 12C22 6.48 17.52 2 12 2S2 6.48 2 12c0 4.84 3.42 8.87 8 9.74V15h-2v-3h2v-2.2c0-2.04 1.24-3.15 3.06-3.15.87 0 1.78.16 1.78.16v2h-1c-.99 0-1.3.62-1.3 1.26V12h2.5l-.5 3h-2v6.74c4.58-.87 8-4.9 8-9.74z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.linkedin.com/shareArticle/?mini=true&url=https%3A%2F%2Fwww.ukrealestateinsights.com%2F2024%2F12%2Fwill-high-street-auctions-bring-about-a-renaissance-of-the-high-street%2F&title=Will+High+Street+Auctions+bring+about+a+renaissance+of+the+High+Street%3F+-+Real+Estate+Insights&summary">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v14H0V8zm7 0h5v2h.07c.69-1.31 2.37-2.7 4.93-2.7C22.05 7.3 24 9.92 24 14.14V22h-5v-7.07c0-1.74-.03-3.99-2.43-3.99-2.43 0-2.81 1.9-2.81 3.86V22H7V8z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">LinkedIn</span>
                                    ...
                                    <br>
                                    <h4 class="blog__content--title ">Cineworld Restructuring Plans: no happy ever after for landlords</h4>
                                    <p class="blog__details--content__desc">By <a href="https://www.ukrealestateinsights.com/author/gpalmer/" target="_blank" style="color: #FF5722 ;"> Gillian Palmer</a> on October 22, 2024 Posted in <a href="https://www.ukrealestateinsights.com/category/covid-19/" target="_blank" style="color: #FF5722 ;"> COVID-19, <a href="https://www.ukrealestateinsights.com/category/property/" target="_blank" style="color: #FF5722 ;">Property,</a><a href="https://www.ukrealestateinsights.com/category/united-kingdom/" target="_blank" style="color: #FF5722 ;"> United Kingdom</a></p>
                                    <!--<div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/iStock-513934318.jpg" alt="img">
                                    </div>-->
                                    <p class="blog__details--content__desc">The recent High Court decision in the <a href="https://www.bailii.org/ew/cases/EWHC/Ch/2024/2475.pdf" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Cineworld restructuring plans case [2024] EWHC 2475 (Ch) </a>again illustrates how even the most pro-active landlords cannot insulate themselves from the effects of a statutory restructuring scheme under <a href="https://www.legislation.gov.uk/ukpga/2006/46/part/26A/data.pdf" target="_blank" style="color: #FF5722 ; text-decoration: underline;"> Part 26A of the Companies Act 2006 </a>, despite determined and novel tactics by the two landlords, the Crown Estate Commissioners and UK Commercial Property Finance Holdings Limited (the <b>“Landlords”</b>).  We understand that the judgment is already the subject of an appeal. </p>
                                    <p class="blog__details--content__desc"><a href="https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/#more-2641" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Continue reading</a></p>
                                    <ul class="side__menu--share">
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="mailto:?subject=Will%20High%20Street%20Auctions%20bring%20about%20a%20renaissance%20of%20the%20High%20Street%3F%20-%20Real%20Estate%20Insights&amp;body=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://twitter.com/share/?text=Cineworld+Restructuring+Plans%3A+no+happy+ever+after+for+landlords&url=https://www.ukrealestateinsights.com/2024/10/cineworld-restructuring-plans-no-happy-ever-after-for-landlords/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.57 2H21L14.43 10.39L22.5 22H16.43L11.43 14.92L5.24 22H2L9.14 13.02L1.5 2H7.76L12.29 8.46L17.57 2ZM16.5 20H18.32L7.07 4H5.18L16.5 20Z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">X</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.facebook.com/sharer.php/?u=https://www.ukrealestateinsights.com/2024/10/cineworld-restructuring-plans-no-happy-ever-after-for-landlords/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 12C22 6.48 17.52 2 12 2S2 6.48 2 12c0 4.84 3.42 8.87 8 9.74V15h-2v-3h2v-2.2c0-2.04 1.24-3.15 3.06-3.15.87 0 1.78.16 1.78.16v2h-1c-.99 0-1.3.62-1.3 1.26V12h2.5l-.5 3h-2v6.74c4.58-.87 8-4.9 8-9.74z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.linkedin.com/shareArticle/?mini=true&url=https%3A%2F%2Fwww.ukrealestateinsights.com%2F2024%2F10%2Fcineworld-restructuring-plans-no-happy-ever-after-for-landlords%2F&title=Cineworld+Restructuring+Plans%3A+no+happy+ever+after+for+landlords+-+Real+Estate+Insights&summary">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v14H0V8zm7 0h5v2h.07c.69-1.31 2.37-2.7 4.93-2.7C22.05 7.3 24 9.92 24 14.14V22h-5v-7.07c0-1.74-.03-3.99-2.43-3.99-2.43 0-2.81 1.9-2.81 3.86V22H7V8z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">LinkedIn</span>
                                    ...
                                    <br>                                    
                                    <h3 class="blog__content--title ">Lease and Desist: The Case of Dr. Bijlani’s Botox Blunder</h3>
                                    <p class="blog__details--content__desc">By <a href="https://www.ukrealestateinsights.com/author/gpalmer/" target="_blank" style="color: #FF5722 ;"> Gillian Palmer</a> on September 13, 2024<br>Posted in <a href="https://www.ukrealestateinsights.com/category/property/" target="_blank" style="color: #FF5722 ;">Property</a>, <a href="https://www.ukrealestateinsights.com/category/property/" target="_blank" style="color: #FF5722 ;">United Kingdom</a></p>
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/Lease-275x183.jpg" alt="img">
                                    </div>
                                    <p class="blog__details--content__desc">In the recent case of <a href="https://www.bailii.org/ew/cases/EWHC/KB/2024/2246.php" target="_blank" style="color: #FF5722 ; text-decoration: underline;"> Bijlani v Medical Express (London) Ltd </a>[2024] EWHC 2246 (KB), the High Court illustrated again that a landlord’s right to forfeit a lease is only a form of security for the tenant’s continuing performance of its obligations under its lease.  If the landlord is not prejudiced by breach of a covenant and the breach is unlikely to recur, then relief from forfeiture may be granted.  Forfeiture should not be used as a way of penalising a tenant for perceived bad behaviour. </p>
                                    <p class="blog__details--content__desc"><a href="https://www.ukrealestateinsights.com/2024/09/lease-and-desist-the-case-of-dr-bijlanis-botox-blunder/#more-2614" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Continue reading</a></p>
                                    <ul class="side__menu--share">
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="mailto:?subject=Will%20High%20Street%20Auctions%20bring%20about%20a%20renaissance%20of%20the%20High%20Street%3F%20-%20Real%20Estate%20Insights&amp;body=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                                <svg width="16" height="14" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://twitter.com/share/?text=The+Renters&url=https://www.ukrealestateinsights.com/2024/09/the-renters-rights-bill-bad-news-for-landlords/#039;%20Rights%20Bill:%20Bad%20News%20for%20Landlords">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.57 2H21L14.43 10.39L22.5 22H16.43L11.43 14.92L5.24 22H2L9.14 13.02L1.5 2H7.76L12.29 8.46L17.57 2ZM16.5 20H18.32L7.07 4H5.18L16.5 20Z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">X</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.facebook.com/sharer.php/?u=https://www.ukrealestateinsights.com/2024/09/the-renters-rights-bill-bad-news-for-landlords/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 12C22 6.48 17.52 2 12 2S2 6.48 2 12c0 4.84 3.42 8.87 8 9.74V15h-2v-3h2v-2.2c0-2.04 1.24-3.15 3.06-3.15.87 0 1.78.16 1.78.16v2h-1c-.99 0-1.3.62-1.3 1.26V12h2.5l-.5 3h-2v6.74c4.58-.87 8-4.9 8-9.74z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.linkedin.com/shareArticle/?mini=true&url=https%3A%2F%2Fwww.ukrealestateinsights.com%2F2024%2F09%2Fthe-renters-rights-bill-bad-news-for-landlords%2F&title=The+Renters&summary#039;%20Rights%20Bill:%20Bad%20News%20for%20Landlords%20-%20Real%20Estate%20Insights">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v14H0V8zm7 0h5v2h.07c.69-1.31 2.37-2.7 4.93-2.7C22.05 7.3 24 9.92 24 14.14V22h-5v-7.07c0-1.74-.03-3.99-2.43-3.99-2.43 0-2.81 1.9-2.81 3.86V22H7V8z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">LinkedIn</span>
                                    ...
                                    <br>
                                    <h3 class="blog__content--title ">2024 election manifestos – real estate policies of the UK major political parties</h3>
                                    <p class="blog__details--content__desc">By <a href="https://www.ukrealestateinsights.com/author/gpalmer/" target="_blank" style="color: #FF5722 ;">Gillian Palmer</a> on June 26, 2024</p>
                                    <p class="blog__details--content__desc">Posted in <a href="https://www.ukrealestateinsights.com/category/planning/" target="_blank" style="color: #FF5722 ;"> Planning, </a><a href="https://www.ukrealestateinsights.com/category/property/" target="_blank" style="color: #FF5722 ;"> Property, </a><a href="https://www.ukrealestateinsights.com/author/gpalmer/" target="_blank" style="color: #FF5722 ;">United Kingdom</a></p>
                                    <div class="blog__details--thumbnail mb-30">
                                        <img class="blog__details--thumbnail--media" src="assets/img/blog/Office-275x183.jpg" alt="img">
                                    </div>                                                                        
                                    <p class="blog__details--content__desc">The major political parties have all now launched their manifestos, with few surprises.  In the table below, we compare and contrast the policies set out in the Conservative, Labour, Liberal Democrats and Green Party manifestos insofar as they might impact on the real estate sector. </p>
                                    <p class="blog__details--content__desc"><a href="https://www.ukrealestateinsights.com/2024/06/2024-election-manifestos-real-estate-policies-of-the-uks-major-political-parties/#more-2572" target="_blank" style="color: #FF5722 ; text-decoration: underline;">Continue reading</a></p>
                                    <ul class="side__menu--share">
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="mailto:?subject=Will%20High%20Street%20Auctions%20bring%20about%20a%20renaissance%20of%20the%20High%20Street%3F%20-%20Real%20Estate%20Insights&amp;body=https://www.ukrealestateinsights.com/2024/12/will-high-street-auctions-bring-about-a-renaissance-of-the-high-street/">
                                                <svg width="16" height="14" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://twitter.com/share/?text=2024+election+manifestos+&url=https://www.ukrealestateinsights.com/2024/06/2024-election-manifestos-real-estate-policies-of-the-uks-major-political-parties/#8211;%20real%20estate%20policies%20of%20the%20UK%20major%20political%20parties">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17.57 2H21L14.43 10.39L22.5 22H16.43L11.43 14.92L5.24 22H2L9.14 13.02L1.5 2H7.76L12.29 8.46L17.57 2ZM16.5 20H18.32L7.07 4H5.18L16.5 20Z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">X</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.facebook.com/sharer.php/?u=https://www.ukrealestateinsights.com/2024/06/2024-election-manifestos-real-estate-policies-of-the-uks-major-political-parties/">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 12C22 6.48 17.52 2 12 2S2 6.48 2 12c0 4.84 3.42 8.87 8 9.74V15h-2v-3h2v-2.2c0-2.04 1.24-3.15 3.06-3.15.87 0 1.78.16 1.78.16v2h-1c-.99 0-1.3.62-1.3 1.26V12h2.5l-.5 3h-2v6.74c4.58-.87 8-4.9 8-9.74z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="side__menu--share__list">
                                            <a class="side__menu--share__icon" target="_blank" href="http://www.linkedin.com/shareArticle/?mini=true&url=https%3A%2F%2Fwww.ukrealestateinsights.com%2F2024%2F06%2F2024-election-manifestos-real-estate-policies-of-the-uks-major-political-parties%2F&title=2024+election+manifestos+&summary#8211;%20real%20estate%20policies%20of%20the%20UK%20major%20political%20parties%20-%20Real%20Estate%20Insights">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v14H0V8zm7 0h5v2h.07c.69-1.31 2.37-2.7 4.93-2.7C22.05 7.3 24 9.92 24 14.14V22h-5v-7.07c0-1.74-.03-3.99-2.43-3.99-2.43 0-2.81 1.9-2.81 3.86V22H7V8z" fill="currentColor"/>
                                                </svg>
                                                <span class="visually-hidden">LinkedIn</span>
                                ...
                                <div class="blockquote__content mb-40">
                                    <blockquote>
                                        <p class="blockquote__desc">“Home is the nicest word there is.”</p>
                                        <h5 class="blockquote__name">Laura Ingalls Wilder</h5>
                                    </blockquote>
                                </div>
                                <div class="blog__ui--content mb-50">
                                    <h3 class="blog__ui--content__title">Let our investment management team, Real estate agencies and Realtors...</h3>
                                    <div class="blog__ui--content__inner d-flex">
                                        <ul class="blog__ui--content__wrapper">
                                            <li class="blog__ui--content__list"><span class="blog__ui--content__mark--icon"><svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.9362 1.116C10.0242 1.948 9.13623 2.916 8.27223 4.02C7.52023 4.972 6.84423 5.948 6.24424 6.948C5.70023 7.844 5.30423 8.612 5.05623 9.252C5.04823 9.276 5.03223 9.296 5.00823 9.312C4.98423 9.336 4.95623 9.348 4.92423 9.348C4.91623 9.356 4.90823 9.36 4.90023 9.36C4.84423 9.36 4.80423 9.344 4.78023 9.312L0.496234 4.956C0.488234 4.948 0.592234 4.844 0.808234 4.644C1.02423 4.436 1.23623 4.248 1.44423 4.08C1.67623 3.888 1.80023 3.8 1.81623 3.816L4.16823 5.664C4.85623 4.856 5.62823 4.056 6.48423 3.264C7.77223 2.08 9.10023 1.072 10.4682 0.24C10.4922 0.24 10.5842 0.352 10.7442 0.576L10.9842 0.924C10.9922 0.956 10.9922 0.992 10.9842 1.032C10.9762 1.064 10.9602 1.092 10.9362 1.116Z" fill="currentColor"/>
                                                </svg>
                                                </span>  Maximize returns on your property listings.
                                            </li>
                                            <li class="blog__ui--content__list"><span class="blog__ui--content__mark--icon"><svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.9362 1.116C10.0242 1.948 9.13623 2.916 8.27223 4.02C7.52023 4.972 6.84423 5.948 6.24424 6.948C5.70023 7.844 5.30423 8.612 5.05623 9.252C5.04823 9.276 5.03223 9.296 5.00823 9.312C4.98423 9.336 4.95623 9.348 4.92423 9.348C4.91623 9.356 4.90823 9.36 4.90023 9.36C4.84423 9.36 4.80423 9.344 4.78023 9.312L0.496234 4.956C0.488234 4.948 0.592234 4.844 0.808234 4.644C1.02423 4.436 1.23623 4.248 1.44423 4.08C1.67623 3.888 1.80023 3.8 1.81623 3.816L4.16823 5.664C4.85623 4.856 5.62823 4.056 6.48423 3.264C7.77223 2.08 9.10023 1.072 10.4682 0.24C10.4922 0.24 10.5842 0.352 10.7442 0.576L10.9842 0.924C10.9922 0.956 10.9922 0.992 10.9842 1.032C10.9762 1.064 10.9602 1.092 10.9362 1.116Z" fill="currentColor"/>
                                                </svg>
                                                </span>   Provide Expert marketing strategies for your properties.
                                            </li>
                                            <li class="blog__ui--content__list"><span class="blog__ui--content__mark--icon"><svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.9362 1.116C10.0242 1.948 9.13623 2.916 8.27223 4.02C7.52023 4.972 6.84423 5.948 6.24424 6.948C5.70023 7.844 5.30423 8.612 5.05623 9.252C5.04823 9.276 5.03223 9.296 5.00823 9.312C4.98423 9.336 4.95623 9.348 4.92423 9.348C4.91623 9.356 4.90823 9.36 4.90023 9.36C4.84423 9.36 4.80423 9.344 4.78023 9.312L0.496234 4.956C0.488234 4.948 0.592234 4.844 0.808234 4.644C1.02423 4.436 1.23623 4.248 1.44423 4.08C1.67623 3.888 1.80023 3.8 1.81623 3.816L4.16823 5.664C4.85623 4.856 5.62823 4.056 6.48423 3.264C7.77223 2.08 9.10023 1.072 10.4682 0.24C10.4922 0.24 10.5842 0.352 10.7442 0.576L10.9842 0.924C10.9922 0.956 10.9922 0.992 10.9842 1.032C10.9762 1.064 10.9602 1.092 10.9362 1.116Z" fill="currentColor"/>
                                                </svg>
                                                </span>   Provide Streamlined reservation and booking processes.
                                            </li>
                                            <li class="blog__ui--content__list"><span class="blog__ui--content__mark--icon"><svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.9362 1.116C10.0242 1.948 9.13623 2.916 8.27223 4.02C7.52023 4.972 6.84423 5.948 6.24424 6.948C5.70023 7.844 5.30423 8.612 5.05623 9.252C5.04823 9.276 5.03223 9.296 5.00823 9.312C4.98423 9.336 4.95623 9.348 4.92423 9.348C4.91623 9.356 4.90823 9.36 4.90023 9.36C4.84423 9.36 4.80423 9.344 4.78023 9.312L0.496234 4.956C0.488234 4.948 0.592234 4.844 0.808234 4.644C1.02423 4.436 1.23623 4.248 1.44423 4.08C1.67623 3.888 1.80023 3.8 1.81623 3.816L4.16823 5.664C4.85623 4.856 5.62823 4.056 6.48423 3.264C7.77223 2.08 9.10023 1.072 10.4682 0.24C10.4922 0.24 10.5842 0.352 10.7442 0.576L10.9842 0.924C10.9922 0.956 10.9922 0.992 10.9842 1.032C10.9762 1.064 10.9602 1.092 10.9362 1.116Z" fill="currentColor"/>
                                                </svg>
                                                </span>    Provide Comprehensive market insights and analytics.
                                            </li>
                                            <li class="blog__ui--content__list"><span class="blog__ui--content__mark--icon"><svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M10.9362 1.116C10.0242 1.948 9.13623 2.916 8.27223 4.02C7.52023 4.972 6.84423 5.948 6.24424 6.948C5.70023 7.844 5.30423 8.612 5.05623 9.252C5.04823 9.276 5.03223 9.296 5.00823 9.312C4.98423 9.336 4.95623 9.348 4.92423 9.348C4.91623 9.356 4.90823 9.36 4.90023 9.36C4.84423 9.36 4.80423 9.344 4.78023 9.312L0.496234 4.956C0.488234 4.948 0.592234 4.844 0.808234 4.644C1.02423 4.436 1.23623 4.248 1.44423 4.08C1.67623 3.888 1.80023 3.8 1.81623 3.816L4.16823 5.664C4.85623 4.856 5.62823 4.056 6.48423 3.264C7.77223 2.08 9.10023 1.072 10.4682 0.24C10.4922 0.24 10.5842 0.352 10.7442 0.576L10.9842 0.924C10.9922 0.956 10.9922 0.992 10.9842 1.032C10.9762 1.064 10.9602 1.092 10.9362 1.116Z" fill="currentColor"/>
                                                </svg>
                                                </span>     Offer Dedicated support and guidance for property management.

                                            </li>
                                        </ul>
                                        <div class="blog__ui--content__thumbnail">
                                            <img src="assets/img/blog/blog-details-small.png" alt="img">
                                        </div>
                                    </div>
                                </div>
                                <div class="related__posts mb-50">
                                    <div class="related__posts--inner d-flex mb-30">
                                        <div class="related__posts--thumb">
                                    ...
                                    <!--<div class="related__posts--content">
                                        <h3 class="blog__content--title ">The Renters’ Rights Bill: Bad News for Landlords </h3>                                        
                                        <p class="blog__details--content__desc">Property owners can easily register, Create a profile, and upload their property details, including images, descriptions, and pricing.</p>
                                        <h3 class="blog__content--title ">Is there a fee to use the platform?... </h3>
                                        <p class="blog__details--content__desc">Our platform offers various pricing plans for property listings, and users can choose one that suits their needs. Basic browsing is free.</p>
                                        <h3 class="blog__content--title ">How are payments and bookings processed?... </h3>
                                        <p class="blog__details--content__desc">All transactions are securely processed through our integrated payment system, ensuring a seamless booking experience.</p>
                                        <h3 class="blog__content--title ">Can I contact the property owner or agent directly?... </h3> 
                                        <p class="blog__details--content__desc">Yes, our platform allows direct communication between property seekers and agents/owners for any inquiries.</p>                           
                                        <h3 class="blog__content--title ">What happens if a booking is canceled?... </h3>                                                                              
                                        <p class="blog__details--content__desc">Our platform provides a cancellation policy and refund guidelines to ensure transparency for both property owners and tenants.</p>
                                    </div>-->
                                </div>
                                <div class="blog__tag--share d-flex justify-content-between">
                                    <div class="blog__tag d-flex align-items-center">
                                        <h3 class="blog__tag--title">Tag:</h3>
                                        <ul class="blog__tag--wrapper d-flex">
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://www.ukrealestateinsights.com/feed">Business</a></li>
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://www.mayerbrown.com/en/legal-notices/legal-and-regulatory">Legal notices</a></li>
                                            <li class="blog__tag--list"><a class="blog__tag--link" href="https://www.mayerbrown.com/Legal-Notices/Privacy-Policy/">Privacy policy</a></li>
                                            <!--<span style="color: #fa4a4a; cursor: pointer;" class="ot-sdk-show-settings menu-item menu-item-type-custom menu-item-object-custom lxb_af-nav_walker-item ">Cookie Preferences</span>-->
                                        </ul>
                                    </div>
                                    <div class="blog__share d-flex align-items-center">
                                        <h3 class="blog__share--title">Share:</h3>
                                        <ul class=" blog__share--social d-flex align-items-center">
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12mayerbrown">
                                                    <svg width="10" height="17" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M7.62891 8.625L8.01172 6.10938H5.57812V4.46875C5.57812 3.75781 5.90625 3.10156 7 3.10156H8.12109V0.941406C8.12109 0.941406 7.10938 0.75 6.15234 0.75C4.15625 0.75 2.84375 1.98047 2.84375 4.16797V6.10938H0.601562V8.625H2.84375V14.75H5.57812V8.625H7.62891Z" fill="currentColor"></path>
                                                    </svg>
                                                    <span class="visually-hidden">Facebook</span>
                                            ...
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://x.com/ONYANGOERI47602Mayer_Brown_UK">
                                           ...
                                           <!-- <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://www.instagram.com/its_kay_jnr/">
                                                    <svg width="16" height="16" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M7.125 3.60547C5.375 3.60547 3.98047 5.02734 3.98047 6.75C3.98047 8.5 5.375 9.89453 7.125 9.89453C8.84766 9.89453 10.2695 8.5 10.2695 6.75C10.2695 5.02734 8.84766 3.60547 7.125 3.60547ZM7.125 8.80078C6.00391 8.80078 5.07422 7.89844 5.07422 6.75C5.07422 5.62891 5.97656 4.72656 7.125 4.72656C8.24609 4.72656 9.14844 5.62891 9.14844 6.75C9.14844 7.89844 8.24609 8.80078 7.125 8.80078ZM11.1172 3.49609C11.1172 3.08594 10.7891 2.75781 10.3789 2.75781C9.96875 2.75781 9.64062 3.08594 9.64062 3.49609C9.64062 3.90625 9.96875 4.23438 10.3789 4.23438C10.7891 4.23438 11.1172 3.90625 11.1172 3.49609ZM13.1953 4.23438C13.1406 3.25 12.9219 2.375 12.2109 1.66406C11.5 0.953125 10.625 0.734375 9.64062 0.679688C8.62891 0.625 5.59375 0.625 4.58203 0.679688C3.59766 0.734375 2.75 0.953125 2.01172 1.66406C1.30078 2.375 1.08203 3.25 1.02734 4.23438C0.972656 5.24609 0.972656 8.28125 1.02734 9.29297C1.08203 10.2773 1.30078 11.125 2.01172 11.8633C2.75 12.5742 3.59766 12.793 4.58203 12.8477C5.59375 12.9023 8.62891 12.9023 9.64062 12.8477C10.625 12.793 11.5 12.5742 12.2109 11.8633C12.9219 11.125 13.1406 10.2773 13.1953 9.29297C13.25 8.28125 13.25 5.24609 13.1953 4.23438ZM11.8828 10.3594C11.6914 10.9062 11.2539 11.3164 10.7344 11.5352C9.91406 11.8633 8 11.7812 7.125 11.7812C6.22266 11.7812 4.30859 11.8633 3.51562 11.5352C2.96875 11.3164 2.55859 10.9062 2.33984 10.3594C2.01172 9.56641 2.09375 7.65234 2.09375 6.75C2.09375 5.875 2.01172 3.96094 2.33984 3.14062C2.55859 2.62109 2.96875 2.21094 3.51562 1.99219C4.30859 1.66406 6.22266 1.74609 7.125 1.74609C8 1.74609 9.91406 1.66406 10.7344 1.99219C11.2539 2.18359 11.6641 2.62109 11.8828 3.14062C12.2109 3.96094 12.1289 5.875 12.1289 6.75C12.1289 7.65234 12.2109 9.56641 11.8828 10.3594Z" fill="currentColor"></path>
                                                    </svg>  
                                                    <span class="visually-hidden">Instagram</span>
                                            ...
                                            <li class="blog__share--social__list">
                                                <a class="blog__share--social__icon" target="_blank" href="https://www.linkedin.com/company/mayer-brown/">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                                                        <path fill="currentColor" d="M20 0H4C2.89 0 2 .9 2 2v20c0 1.1.89 2 2 2h16c1.1 0 2-.9 2-2V2c0-1.1-.89-2-2-2zM9 19H6v-7h3v7zm-1.5-8.2c-.88 0-1.5-.62-1.5-1.5s.62-1.5 1.5-1.5 1.5.62 1.5 1.5-.62 1.5-1.5 1.5zm12.5 8.2h-3v-4.5c0-1.5-.9-2.5-2.3-2.5-1.2 0-1.7.8-1.7 1.8v5.2h-3v-7h2.8v1h-.2c.4-.6.9-1.1 1.9-1.1 1.3 0 2.2 1 2.2 2.4v5.7z"></path>
                                                    </svg>
                                                    <span class="visually-hidden">LinkedIn</span>
                                                </a>
                                            </li>                                            
                                ...
                                <div class="blog__comment--area">
                                    <div class="blog__review--comment mb-50">
                                        <h3 class="blog__comment--title">(0) Comments</h3>
                                        <div class="blog__review--comment__inner">
                                            <!--<div class="blog__comment--list d-flex mb-30">
                                                ...
                                                <div class="blog__comment--content">
                                                    ...
                                                    <div class="blog__comment--content__top--left">
                                                            <h4 class="blog__comment--content__name">Rohan De Spond</h4>
                                                            <span class="blog__comment--date">25 january 2021</span>
                                                        </div>
                                                        <a class="blog__comment--content__reply" href="javascript:void(0)"><svg width="26" height="19" viewBox="0 0 26 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M6.54688 10.2031L12.7969 16.4531C13.9688 17.625 16 16.8047 16 15.125V12.3516C20.6094 12.5469 20.7266 13.5625 20.0625 15.8672C19.5547 17.5469 21.4688 18.9141 22.9141 17.9375C24.9062 16.5703 26 14.8516 26 12.3516C26 6.76562 21 5.67188 16 5.47656V2.66406C16 0.984375 13.9688 0.164062 12.7969 1.33594L6.54688 7.58594C5.80469 8.28906 5.80469 9.5 6.54688 10.2031ZM7.875 8.875L14.125 2.625V7.3125C18.8125 7.3125 24.125 7.58594 24.125 12.3516C24.125 14.5391 22.9922 15.6328 21.8594 16.375C23.4609 11.0625 19.4766 10.4375 14.125 10.4375V15.125L7.875 8.875ZM1.54688 7.58594C0.804688 8.28906 0.804688 9.5 1.54688 10.2031L7.79688 16.4531C8.57812 17.2734 9.75 17.1562 10.4531 16.4531L2.875 8.875L10.4531 1.33594C9.75 0.632812 8.57812 0.515625 7.79688 1.33594L1.54688 7.58594Z" fill="currentColor"/>
                                                            </svg>
                                                        </a>
                                                    </div>
                                                    <p class="blog__comment--content__desc">There are many variations of passages of Lorem Ipsum available, but the leap into electronic
                                            ...
                                            <div class="blog__comment--list two d-flex mb-30">
                                                ...
                                                <div class="blog__comment--content">
                                                    ...
                                                    <div class="blog__comment--content__top--left">
                                                            <h4 class="blog__comment--content__name">Johan Ritaxon</h4>
                                                            <span class="blog__comment--date">25 january 2021</span>
                                                        </div>
                                                    </div>
                                                    <p class="blog__comment--content__desc">There are many variations of passages of Lorem Ipsum available, but the
                                                        majority have. There are many variations of passages</p>
                                                </div>
                                            </div>
                                            <div class="blog__comment--list d-flex">
                                                <div class="blog__comment--thumbnail">
                                                    <img src="assets/img/blog/blog-comment1.png" alt="img">
                                                </div>
                                                <div class="blog__comment--content">
                                                ...
                                                <div class="row mb--n30">
                                                    <div class="col-lg-6 col-md-6 mb-30">
                                                        <div class="blog__comment--input">
                                                            <input class="blog__comment--input__field" placeholder="Enter your name*" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 mb-30">
                                                        <div class="blog__comment--input">
                                                            <input class="blog__comment--input__field" placeholder="Enter your mail*" type="email">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 mb-30">
                                                        <div class="blog__comment--input">
                                                            <input class="blog__comment--input__field" placeholder="Enter your  number*" type="email">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 mb-30">
                                                        <div class="blog__comment--input">
                                                            <input class="blog__comment--input__field" placeholder="Website*" type="email">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-30">
                                                        <div class="blog__comment--textarea">
                                                            <textarea class="blog__comment--textarea__field" placeholder="Enter your Massage*"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <p class="browser__comment--text position-relative">
                                                    <label for="comment">Save my name, email, and website in this browser for the next time I comment.</label>
                                                    <input class="widget__Categories--input" id="comment" type="checkbox">
                                                    <span class="widget__Categories--checkmark"></span>
                                                </p>
                                                <button class="blog__comment--btn solid__btn">Send Message</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="listing__widget">
                            <div class="widget__admin--profile blog__admin text-center mb-30">
                                <div class="admin__profile--thumbnail">
                                    <img src="assets/img/other/1037-1706647703.thumbnail.jpg" alt="img">
                                </div>
                                <div class="admin__profile--content">
                                    <h3 class="admin__profile--name">Gillian Palmer</h3>
                                    <h5 class="admin__profile--subtitle">Professional Support Lawyer</h5>
                                    ...
                                    <p class="admin__profile--desc">Gillian Palmer is the professional support lawyer in the London office of Mayer Brown’s Real Estate practice.  She focuses on providing innovative solutions to lawyers within the practice in respect of training and innovation.</p>
                                    <!--<a class="admin__profile--email" href="mailto:kibisuerick20@gmail.com">kibisuerick20@gmail.com</a>-->
                                    <ul class=" profile__social d-flex align-items-center justify-content-center">
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.facebook.com/erick.kibisu.12sharer/sharer.php?u=https://www.mayerbrown.com/en/people/p/palmer-gillian">
                                                <svg width="10" height="17" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.62891 8.625L8.01172 6.10938H5.57812V4.46875C5.57812 3.75781 5.90625 3.10156 7 3.10156H8.12109V0.941406C8.12109 0.941406 7.10938 0.75 6.15234 0.75C4.15625 0.75 2.84375 1.98047 2.84375 4.16797V6.10938H0.601562V8.625H2.84375V14.75H5.57812V8.625H7.62891Z" fill="currentColor"></path>
                                                </svg>
                                                <span class="visually-hidden">Facebook</span>
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://x.com/ONYANGOERI47602intent/tweet?url=https://www.mayerbrown.com/en/people/p/palmer-gillian">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"></path>
                                                  </svg>
                                                <span class="visually-hidden">Twitter</span>
                                        ...
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.mayerbrown.com/en/people/p/palmer-gillian">
                                                <svg width="10" height="17" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.5 0.5C0.671573 0.5 0 1.17157 0 2C0 2.82843 0.671573 3.5 1.5 3.5C2.32843 3.5 3 2.82843 3 2C3 1.17157 2.32843 0.5 1.5 0.5ZM0.25 5.5V15.5H2.75V5.5H0.25ZM6 5.5V15.5H8.5V10.25C8.5 9.2835 9.2835 8.5 10.25 8.5C11.2165 8.5 12 9.2835 12 10.25V15.5H14.5V9.75C14.5 7.54087 12.7091 5.75 10.5 5.75C9.54087 5.75 8.6835 6.21562 8.12109 6.92188V5.5H6Z" fill="currentColor"></path>
                                                </svg>
                                                <span class="visually-hidden">LinkedIn</span>
                                            </a>
                                        </li>
                                        <li class="profile__social--list">
                                            <a class="profile__social--icon" target="_blank" href="mailto:?subject=Check%20this%20out&body=https://www.mayerbrown.com/en/people/p/palmer-gillian">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                                                    <path fill="currentColor" d="M12 13.5l-8-5v10l8-5 8 5V8l-8 5zm0-2.5l6-4-6-3-6 3 6 4zm0 10c-5.52 0-10-4.48-10-10s4.48-10 10-10 10 4.48 10 10-4.48 10-10 10z"></path>
                                                </svg>
                                ...
                                <br>
                                <p class="contact__information--email__text"><a href="https://www.mayerbrown.com/en/people/p/palmer-gillian" target="_blank" style="color: #FF5722 ;">Read Full Bio</a></p>                               
                            </div>
                            <div class="blog__widget--step widget__search mb-30">
                                <h2 class="widget__step--title">Send Message</h2>
                                ...
                                <div class="widget__featured">
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="blog-details.php"><img class="widget__featured--media" src="assets/img/property/featured1.jpg" alt="img"></a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <span class="widget__featured--date"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                Jan 07, 2025</span>
                                            <h3 class="widget__featured--title m-0"><a href="blog-details.php">Transform Your Space: Tips for Modern Home Design</a></h3>
                                            
                                        </div>
                                    </div>
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="listing-details.php"><img class="widget__featured--media" src="assets/img/property/featured2.jpg" alt="img"></a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <span class="widget__featured--date"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.5332 13H3.7832V10.75H1.5332V13ZM4.2832 13H6.7832V10.75H4.2832V13ZM1.5332 10.25H3.7832V7.75H1.5332V10.25ZM4.2832 10.25H6.7832V7.75H4.2832V10.25ZM1.5332 7.25H3.7832V5H1.5332V7.25ZM7.2832 13H9.7832V10.75H7.2832V13ZM4.2832 7.25H6.7832V5H4.2832V7.25ZM10.2832 13H12.5332V10.75H10.2832V13ZM7.2832 10.25H9.7832V7.75H7.2832V10.25ZM4.5332 3.5V1.25C4.5332 1.18229 4.50716 1.125 4.45508 1.07812C4.4082 1.02604 4.35091 0.999999 4.2832 0.999999H3.7832C3.71549 0.999999 3.6556 1.02604 3.60352 1.07812C3.55664 1.125 3.5332 1.18229 3.5332 1.25V3.5C3.5332 3.56771 3.55664 3.6276 3.60352 3.67969C3.6556 3.72656 3.71549 3.75 3.7832 3.75H4.2832C4.35091 3.75 4.4082 3.72656 4.45508 3.67969C4.50716 3.6276 4.5332 3.56771 4.5332 3.5ZM10.2832 10.25H12.5332V7.75H10.2832V10.25ZM7.2832 7.25H9.7832V5H7.2832V7.25ZM10.2832 7.25H12.5332V5H10.2832V7.25ZM10.5332 3.5V1.25C10.5332 1.18229 10.5072 1.125 10.4551 1.07812C10.4082 1.02604 10.3509 0.999999 10.2832 0.999999H9.7832C9.7155 0.999999 9.6556 1.02604 9.60352 1.07812C9.55664 1.125 9.5332 1.18229 9.5332 1.25V3.5C9.5332 3.56771 9.55664 3.6276 9.60352 3.67969C9.6556 3.72656 9.7155 3.75 9.7832 3.75H10.2832C10.3509 3.75 10.4082 3.72656 10.4551 3.67969C10.5072 3.6276 10.5332 3.56771 10.5332 3.5ZM13.5332 3V13C13.5332 13.2708 13.4342 13.5052 13.2363 13.7031C13.0384 13.901 12.804 14 12.5332 14H1.5332C1.26237 14 1.02799 13.901 0.830078 13.7031C0.632161 13.5052 0.533203 13.2708 0.533203 13V3C0.533203 2.72917 0.632161 2.49479 0.830078 2.29687C1.02799 2.09896 1.26237 2 1.5332 2H2.5332V1.25C2.5332 0.906249 2.6556 0.611978 2.90039 0.367187C3.14518 0.122395 3.43945 -9.53674e-07 3.7832 -9.53674e-07H4.2832C4.62695 -9.53674e-07 4.92122 0.122395 5.16602 0.367187C5.41081 0.611978 5.5332 0.906249 5.5332 1.25V2H8.5332V1.25C8.5332 0.906249 8.6556 0.611978 8.90039 0.367187C9.14518 0.122395 9.43945 -9.53674e-07 9.7832 -9.53674e-07H10.2832C10.627 -9.53674e-07 10.9212 0.122395 11.166 0.367187C11.4108 0.611978 11.5332 0.906249 11.5332 1.25V2H12.5332C12.804 2 13.0384 2.09896 13.2363 2.29687C13.4342 2.49479 13.5332 2.72917 13.5332 3Z" fill="#FA4A4A"/>
                                                ...
                                                Jan 07, 2025</span>
                                            <h3 class="widget__featured--title m-0"><a href="listing-details.php">Top 5 Vacation Rentals for Your Next Getaway</a></h3>
                                        </div>
                                    </div>
                                    <div class="widget__featured--items d-flex">
                                        <div class="widget__featured--thumb">
                                            <a class="widget__featured--thumb__link" href="listing-details.php"><img class="widget__featured--media" src="assets/img/property/featured3.jpg" alt="img"></a>
                                        </div>
                                        <div class="widget__featured--content">
                                            <span class="widget__featured--date"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.5332 13H3.7832V10.75H1.5332V13ZM4.2832 13H6.7832V10.75H4.2832V13ZM1.5332 10.25H3.7832V7.75H1.5332V10.25ZM4.2832 10.25H6.7832V7.75H4.2832V10.25ZM1.5332 7.25H3.7832V5H1.5332V7.25ZM7.2832 13H9.7832V10.75H7.2832V13ZM4.2832 7.25H6.7832V5H4.2832V7.25ZM10.2832 13H12.5332V10.75H10.2832V13ZM7.2832 10.25H9.7832V7.75H7.2832V10.25ZM4.5332 3.5V1.25C4.5332 1.18229 4.50716 1.125 4.45508 1.07812C4.4082 1.02604 4.35091 0.999999 4.2832 0.999999H3.7832C3.71549 0.999999 3.6556 1.02604 3.60352 1.07812C3.55664 1.125 3.5332 1.18229 3.5332 1.25V3.5C3.5332 3.56771 3.55664 3.6276 3.60352 3.67969C3.6556 3.72656 3.71549 3.75 3.7832 3.75H4.2832C4.35091 3.75 4.4082 3.72656 4.45508 3.67969C4.50716 3.6276 4.5332 3.56771 4.5332 3.5ZM10.2832 10.25H12.5332V7.75H10.2832V10.25ZM7.2832 7.25H9.7832V5H7.2832V7.25ZM10.2832 7.25H12.5332V5H10.2832V7.25ZM10.5332 3.5V1.25C10.5332 1.18229 10.5072 1.125 10.4551 1.07812C10.4082 1.02604 10.3509 0.999999 10.2832 0.999999H9.7832C9.7155 0.999999 9.6556 1.02604 9.60352 1.07812C9.55664 1.125 9.5332 1.18229 9.5332 1.25V3.5C9.5332 3.56771 9.55664 3.6276 9.60352 3.67969C9.6556 3.72656 9.7155 3.75 9.7832 3.75H10.2832C10.3509 3.75 10.4082 3.72656 10.4551 3.67969C10.5072 3.6276 10.5332 3.56771 10.5332 3.5ZM13.5332 3V13C13.5332 13.2708 13.4342 13.5052 13.2363 13.7031C13.0384 13.901 12.804 14 12.5332 14H1.5332C1.26237 14 1.02799 13.901 0.830078 13.7031C0.632161 13.5052 0.533203 13.2708 0.533203 13V3C0.533203 2.72917 0.632161 2.49479 0.830078 2.29687C1.02799 2.09896 1.26237 2 1.5332 2H2.5332V1.25C2.5332 0.906249 2.6556 0.611978 2.90039 0.367187C3.14518 0.122395 3.43945 -9.53674e-07 3.7832 -9.53674e-07H4.2832C4.62695 -9.53674e-07 4.92122 0.122395 5.16602 0.367187C5.41081 0.611978 5.5332 0.906249 5.5332 1.25V2H8.5332V1.25C8.5332 0.906249 8.6556 0.611978 8.90039 0.367187C9.14518 0.122395 9.43945 -9.53674e-07 9.7832 -9.53674e-07H10.2832C10.627 -9.53674e-07 10.9212 0.122395 11.166 0.367187C11.4108 0.611978 11.5332 0.906249 11.5332 1.25V2H12.5332C12.804 2 13.0384 2.09896 13.2363 2.29687C13.4342 2.49479 13.5332 2.72917 13.5332 3Z" fill="#FA4A4A"/>
                                                 ...
                                                 Jan 07,2025</span>
                                            <h3 class="widget__featured--title m-0"><a href="listing-details.php"> How to Maximize ROI on Real Estate Investments</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="blog__widget--step mb-30">
                                <h2 class="widget__step--title">Categories</h2>
                                <ul class="widget__Categories--menu">
                                    <li class="widget__Categories--items">
                                        <a class="widget__Categories--link d-flex align-items-center justify-content-between" href="#">
                                            <span class="widget__Categories--menu__text">Residential Properties</span>
                                            <span class="widget__Categories--menu__text">4</span>
                                        </a>
                                    </li>
                                    <li class="widget__Categories--items">
                                        <a class="widget__Categories--link d-flex align-items-center justify-content-between" href="#">
                                            <span class="widget__Categories--menu__text">Commercial Properties</span>
                                            <span class="widget__Categories--menu__text">5</span>
                                        </a>
                                    </li>
                                    <li class="widget__Categories--items">
                                        <a class="widget__Categories--link d-flex align-items-center justify-content-between" href="#">
                                            <span class="widget__Categories--menu__text">Vacation Rentals</span>
                                            <span class="widget__Categories--menu__text">4</span>
                                        </a>
                                    </li>
                                    <li class="widget__Categories--items">
                                        <a class="widget__Categories--link d-flex align-items-center justify-content-between" href="#">
                                            <span class="widget__Categories--menu__text">Land Listings</span>
                                            <span class="widget__Categories--menu__text">6</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="blog__widget--step">
                                ...
                                <ul class="widget__tag d-flex">
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Affordable Homes</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Luxury Villas</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Vacation Rentals</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Fully Furnished Homes</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Modern Apartments</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Family-Friendly Neighborhoods</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Move-In Ready</a>
                                    </li>
                                    <li class="widget__tag--list">
                                        <a class="widget__tag--link" href="blog-details.php">Newly Renovated</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
       ...
       <!--<div class="social__media--area bg__style">
            <ul class="social__media--wrapper d-flex">
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.facebook.com/erick.kibisu.12"> <svg width="9" height="18" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.instagram.com/its_kay_jnr/"> <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list"><a class="social__media--link" target="_blank" href="https://www.pinterest.com/erickkibisu/search/pins/?rs=ac&len=2&q=real%20estate&eq=real%20es&etslf=71651"> <svg width="14" height="16" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="contact__information--aera d-flex">
                    ...
                    <div class="contact__information--phone d-flex align-items-center justify-content-center">
                        ...
                        <div class="contact__information--phone__text">
                            ...
                            <a class="contact__information--phone__number" href="tel:+254 759506718"> +254 759506718</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="footer__widget--inner">
                                    ...
                                    <ul class="footer__widget--info">
                                        <li class="footer__widget--info_list">
                                            ...
                                            <p class="footer__widget--info__text">Umoja road, ongata rongai, Kajiado North</p>
                                        </li>
                                        <li class="footer__widget--info_list">                                     
                                        ...
                                        <li class="footer__widget--info_list">
                                            ...
                                            <a class="footer__widget--info__text" href="tel:+254 759506718">: (+254) 759506718</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="footer__widget">
                                ...
                                <ul class="footer__widget--menu footer__widget--inner">
                                    ...
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-details.php">Team membar</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Offices for Buy</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-details.php">Terms of use</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Offices for Rent</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="footer__widget">
                                ...
                                <ul class="footer__widget--menu footer__widget--inner">
                                    ...
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-list.php">Propert owners</a></li>
                                    ...
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing-details.php">Partners</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            ...
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget--inner newsletter">
                                    ...
                                    <ul class=" footer__social d-flex align-items-center">
                                        ...
                                        <li class="footer__social--list">
                                            <a class="footer__social--icon" target="_blank" href="https://www.instagram.com/its_kay_jnr/">
                                                <svg width="16" height="16" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.125 3.60547C5.375 3.60547 3.98047 5.02734 3.98047 6.75C3.98047 8.5 5.375 9.89453 7.125 9.89453C8.84766 9.89453 10.2695 8.5 10.2695 6.75C10.2695 5.02734 8.84766 3.60547 7.125 3.60547ZM7.125 8.80078C6.00391 8.80078 5.07422 7.89844 5.07422 6.75C5.07422 5.62891 5.97656 4.72656 7.125 4.72656C8.24609 4.72656 9.14844 5.62891 9.14844 6.75C9.14844 7.89844 8.24609 8.80078 7.125 8.80078ZM11.1172 3.49609C11.1172 3.08594 10.7891 2.75781 10.3789 2.75781C9.96875 2.75781 9.64062 3.08594 9.64062 3.49609C9.64062 3.90625 9.96875 4.23438 10.3789 4.23438C10.7891 4.23438 11.1172 3.90625 11.1172 3.49609ZM13.1953 4.23438C13.1406 3.25 12.9219 2.375 12.2109 1.66406C11.5 0.953125 10.625 0.734375 9.64062 0.679688C8.62891 0.625 5.59375 0.625 4.58203 0.679688C3.59766 0.734375 2.75 0.953125 2.01172 1.66406C1.30078 2.375 1.08203 3.25 1.02734 4.23438C0.972656 5.24609 0.972656 8.28125 1.02734 9.29297C1.08203 10.2773 1.30078 11.125 2.01172 11.8633C2.75 12.5742 3.59766 12.793 4.58203 12.8477C5.59375 12.9023 8.62891 12.9023 9.64062 12.8477C10.625 12.793 11.5 12.5742 12.2109 11.8633C12.9219 11.125 13.1406 10.2773 13.1953 9.29297C13.25 8.28125 13.25 5.24609 13.1953 4.23438ZM11.8828 10.3594C11.6914 10.9062 11.2539 11.3164 10.7344 11.5352C9.91406 11.8633 8 11.7812 7.125 11.7812C6.22266 11.7812 4.30859 11.8633 3.51562 11.5352C2.96875 11.3164 2.55859 10.9062 2.33984 10.3594C2.01172 9.56641 2.09375 7.65234 2.09375 6.75C2.09375 5.875 2.01172 3.96094 2.33984 3.14062C2.55859 2.62109 2.96875 2.21094 3.51562 1.99219C4.30859 1.66406 6.22266 1.74609 7.125 1.74609C8 1.74609 9.91406 1.66406 10.7344 1.99219C11.2539 2.18359 11.6641 2.62109 11.8828 3.14062C12.2109 3.96094 12.1289 5.875 12.1289 6.75C12.1289 7.65234 12.2109 9.56641 11.8828 10.3594Z" fill="currentColor"></path>
                                                </svg>  
                                                <span class="visually-hidden">Instagram</span>
                                        ...
                                        <li class="footer__social--list">
                                            <a class="footer__social--icon" target="_blank" href="https://www.pinterest.com/erickkibisu/search/pins/?rs=ac&len=2&q=real%20estate&eq=real%20es&etslf=71651">
                                                <svg width="14" height="16" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M14.6713 6.71093C14.6764 7.71873 14.5406 8.65694 14.2638 9.52555C14.0104 10.394 13.6393 11.146 13.1503 11.7813C12.6612 12.3932 12.0778 12.8883 11.4001 13.2668C10.7222 13.6218 9.97304 13.7897 9.15262 13.7705C8.87149 13.7954 8.59012 13.7734 8.30852 13.7045C8.05023 13.6121 7.80366 13.5196 7.56881 13.427C7.35727 13.3109 7.16906 13.1713 7.00416 13.008C6.83926 12.8448 6.70957 12.6931 6.61511 12.553C6.47736 13.1162 6.36257 13.5856 6.27074 13.961C6.17891 14.3365 6.09838 14.6299 6.02915 14.8412C5.98323 15.0289 5.94879 15.1697 5.92584 15.2636C5.9262 15.3339 5.92632 15.3573 5.9262 15.3339C5.85696 15.5452 5.78767 15.7448 5.71832 15.9326C5.64897 16.1205 5.56796 16.3201 5.47529 16.5315C5.3825 16.7195 5.27793 16.8958 5.16158 17.0605C5.06867 17.225 4.97576 17.3896 4.88285 17.5541C4.60256 17.743 4.38033 17.8262 4.21615 17.8036C4.07553 17.8043 3.95804 17.7463 3.86369 17.6296C3.79278 17.5128 3.74531 17.3959 3.72127 17.2788C3.69736 17.1852 3.68534 17.1266 3.68522 17.1032C3.66094 16.9393 3.64832 16.7635 3.64736 16.576C3.64629 16.3651 3.64527 16.1659 3.64431 15.9784C3.66667 15.7673 3.68902 15.5563 3.71138 15.3452C3.75718 15.1341 3.80309 14.9463 3.84913 14.782C3.84901 14.7586 3.86037 14.6882 3.8832 14.5709C3.92936 14.43 3.99829 14.1602 4.09 13.7612C4.18159 13.3389 4.30756 12.764 4.46791 12.0366C4.62825 11.3092 4.84599 10.3472 5.12112 9.15044C5.05009 9.01017 4.9906 8.8347 4.94264 8.624C4.89469 8.41331 4.85863 8.23771 4.83448 8.0972C4.8102 7.93326 4.79776 7.7927 4.79716 7.67551C4.79657 7.55833 4.79633 7.51145 4.79645 7.53489C4.79441 7.13646 4.83948 6.78466 4.93167 6.4795C5.04718 6.15078 5.18637 5.86881 5.34923 5.6336C5.53541 5.37483 5.74538 5.18626 5.97915 5.06787C6.23624 4.92593 6.49363 4.84258 6.75132 4.81782C6.98581 4.84006 7.18527 4.88592 7.34969 4.95539C7.53755 5.02474 7.69049 5.14115 7.80851 5.30461C7.92654 5.46807 8.00947 5.64343 8.0573 5.83069C8.12845 5.99439 8.16463 6.19342 8.16583 6.4278C8.16691 6.63873 8.13307 6.89672 8.06432 7.20176C7.99544 7.48337 7.91491 7.77675 7.82272 8.08192C7.73053 8.38708 7.62674 8.71574 7.51135 9.0679C7.41928 9.3965 7.33887 9.71332 7.27012 10.0184C7.20137 10.3234 7.19103 10.593 7.2391 10.8271C7.31049 11.0377 7.41704 11.2481 7.55874 11.4583C7.72376 11.645 7.92369 11.7846 8.15854 11.8771C8.3934 11.9697 8.63979 12.027 8.89771 12.0491C9.38978 12.0232 9.8343 11.8686 10.2313 11.5853C10.6283 11.302 10.9661 10.9018 11.2447 10.3848C11.5467 9.86758 11.7665 9.29223 11.9038 8.65871C12.0646 8.00163 12.1429 7.28637 12.139 6.51294C12.1362 5.97389 12.0398 5.45875 11.8498 4.96753C11.6598 4.47631 11.3765 4.06759 10.9998 3.74139C10.6464 3.39163 10.1997 3.11266 9.65954 2.90449C9.14285 2.69619 8.533 2.60556 7.83 2.63259C7.05646 2.61311 6.354 2.74561 5.72263 3.03009C5.11471 3.31446 4.58923 3.68043 4.1462 4.12802C3.70317 4.5756 3.36603 5.10467 3.13477 5.71524C2.9034 6.30237 2.78933 6.91234 2.79257 7.54514C2.79388 7.80295 2.80674 8.02554 2.83114 8.21292C2.87885 8.37674 2.92662 8.55228 2.97446 8.73954C3.04561 8.90324 3.1167 9.05522 3.18773 9.19548C3.28208 9.31219 3.38827 9.45227 3.50629 9.61574C3.55329 9.63893 3.58868 9.68563 3.61248 9.75582C3.63615 9.80257 3.64805 9.83767 3.64817 9.86111C3.67173 9.88442 3.68369 9.93124 3.68405 10.0015C3.68429 10.0484 3.67281 10.0954 3.64961 10.1424C3.62653 10.2128 3.60346 10.2832 3.58038 10.3536C3.58062 10.4005 3.56926 10.4709 3.5463 10.5648C3.52334 10.6586 3.50033 10.7408 3.47725 10.8112C3.45405 10.8582 3.44263 10.9169 3.44299 10.9872C3.4198 11.0342 3.38494 11.0929 3.33842 11.1635C3.31523 11.2105 3.28025 11.2458 3.2335 11.2695C3.18662 11.2697 3.13981 11.2817 3.09305 11.3054C3.04618 11.3056 2.98747 11.2825 2.91691 11.236C2.56464 11.0971 2.24722 10.8995 1.96465 10.6432C1.7054 10.3632 1.49291 10.0596 1.32717 9.73235C1.16143 9.40507 1.03061 9.03073 0.934703 8.60934C0.838796 8.18795 0.789764 7.76633 0.787606 7.34446C0.78377 6.59447 0.932275 5.8437 1.23312 5.09215C1.55741 4.34048 2.02261 3.64668 2.62874 3.01076C3.23487 2.37484 3.99401 1.86705 4.90614 1.48737C5.81815 1.08427 6.88346 0.867877 8.10208 0.838206C9.08656 0.856608 9.97807 1.02783 10.7766 1.35188C11.5985 1.65236 12.2921 2.08241 12.8575 2.64203C13.4228 3.20165 13.8597 3.83223 14.1679 4.53379C14.4995 5.21179 14.6673 5.9375 14.6713 6.71093Z" fill="currentColor"/>
                                                    </svg>
                                                <span class="visually-hidden">Pinterest</span>
